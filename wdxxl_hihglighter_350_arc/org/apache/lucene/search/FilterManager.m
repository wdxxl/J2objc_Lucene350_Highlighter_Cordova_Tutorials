...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/FilterManager.java
//
...
- (OrgApacheLuceneSearchFilter *)getFilterWithOrgApacheLuceneSearchFilter:(OrgApacheLuceneSearchFilter *)filter {
  @synchronized(cache_) {
    ...
    if (fi != nil) {
      fi->timestamp_ = [new_JavaUtilDate_init() getTime];
      return fi->filter_;
    }
    (void) [((id<JavaUtilMap>) nil_chk(cache_)) putWithId:JavaLangInteger_valueOfWithInt_(((jint) [filter hash])) withId:new_OrgApacheLuceneSearchFilterManager_FilterItem_initWithOrgApacheLuceneSearchFilterManager_withOrgApacheLuceneSearchFilter_(self, filter)];
    return filter;
  }
}
...
OrgApacheLuceneSearchFilterManager *OrgApacheLuceneSearchFilterManager_getInstance() {
  ...
  @synchronized(OrgApacheLuceneSearchFilterManager_class_()) {
    if (OrgApacheLuceneSearchFilterManager_manager == nil) {
      OrgApacheLuceneSearchFilterManager_manager = new_OrgApacheLuceneSearchFilterManager_init();
    }
...
void OrgApacheLuceneSearchFilterManager_init(OrgApacheLuceneSearchFilterManager *self) {
  ...
  self->filterCleaner_ = new_OrgApacheLuceneSearchFilterManager_FilterCleaner_initWithOrgApacheLuceneSearchFilterManager_(self);
  JavaLangThread *fcThread = new_JavaLangThread_initWithJavaLangRunnable_(self->filterCleaner_);
...
void OrgApacheLuceneSearchFilterManager_FilterItem_initWithOrgApacheLuceneSearchFilterManager_withOrgApacheLuceneSearchFilter_(OrgApacheLuceneSearchFilterManager_FilterItem *self, OrgApacheLuceneSearchFilterManager *outer$, OrgApacheLuceneSearchFilter *filter) {
  NSObject_init(self);
  self->filter_ = filter;
  self->timestamp_ = [new_JavaUtilDate_init() getTime];
}
    ...
    if ([((id<JavaUtilMap>) nil_chk(this$0_->cache_)) size] > this$0_->cacheCleanSize_) {
      ...
      @synchronized(this$0_->cache_) {
        ...
        while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext] && counter++ < numToDelete) {
          ...
          (void) [((id<JavaUtilMap>) nil_chk(this$0_->cache_)) removeWithId:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey]];
        }
      }
      [((JavaUtilTreeSet *) nil_chk(sortedFilterItems_)) clear];
    }
...
void OrgApacheLuceneSearchFilterManager_FilterCleaner_initWithOrgApacheLuceneSearchFilterManager_(OrgApacheLuceneSearchFilterManager_FilterCleaner *self, OrgApacheLuceneSearchFilterManager *outer$) {
  ...
  NSObject_init(self);
  self->running_ = true;
  self->sortedFilterItems_ = new_JavaUtilTreeSet_initWithJavaUtilComparator_(new_OrgApacheLuceneSearchFilterManager_FilterCleaner_1_init());
}
