...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/MultiPhraseQuery.java
//
...
- (void)addWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  [self addWithOrgApacheLuceneIndexTermArray:[IOSObjectArray newArrayWithObjects:(id[]){ term } count:1 type:OrgApacheLuceneIndexTerm_class_()]];
}
...
- (void)addWithOrgApacheLuceneIndexTermArray:(IOSObjectArray *)terms
  ...
  if ([((JavaUtilArrayList *) nil_chk(termArrays_)) size] == 0) field_ = [((OrgApacheLuceneIndexTerm *) nil_chk(IOSObjectArray_Get(nil_chk(terms), 0))) field];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(terms))->size_; i++) {
    if ([((OrgApacheLuceneIndexTerm *) nil_chk(IOSObjectArray_Get(terms, i))) field] != field_) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$@", @"All phrase terms must be in the same field (", field_, @"): ", IOSObjectArray_Get(terms, i)));
    }
  }
...
- (OrgApacheLuceneSearchQuery *)rewriteWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  if ([((JavaUtilArrayList *) nil_chk(termArrays_)) size] == 1) {
    ...
    OrgApacheLuceneSearchBooleanQuery *boq = new_OrgApacheLuceneSearchBooleanQuery_initWithBoolean_(true);
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(terms))->size_; i++) {
      [boq addWithOrgApacheLuceneSearchQuery:new_OrgApacheLuceneSearchTermQuery_initWithOrgApacheLuceneIndexTerm_(IOSObjectArray_Get(terms, i)) withOrgApacheLuceneSearchBooleanClause_Occur:JreLoadEnum(OrgApacheLuceneSearchBooleanClause_Occur, SHOULD)];
    }
...
- (OrgApacheLuceneSearchWeight *)createWeightWithOrgApacheLuceneSearchSearcher:(OrgApacheLuceneSearchSearcher *)searcher {
  return new_OrgApacheLuceneSearchMultiPhraseQuery_MultiPhraseWeight_initWithOrgApacheLuceneSearchMultiPhraseQuery_withOrgApacheLuceneSearchSearcher_(self, searcher);
}
  ...
  while ([((id<JavaUtilIterator>) nil_chk(i)) hasNext]) {
    ...
    if (((IOSObjectArray *) nil_chk(terms))->size_ > 1) {
      ...
      for (jint j = 0; j < terms->size_; j++) {
        (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(IOSObjectArray_Get(terms, j))) text]];
        if (j < terms->size_ - 1) (void) [buffer appendWithNSString:@" "];
      }
      (void) [buffer appendWithNSString:@")"];
    }
    else {
      (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(IOSObjectArray_Get(terms, 0))) text]];
    }
    if ([i hasNext]) (void) [buffer appendWithNSString:@" "];
  }
  (void) [buffer appendWithNSString:@"\""];
  if (slop_ != 0) {
    (void) [buffer appendWithNSString:@"~"];
...
void OrgApacheLuceneSearchMultiPhraseQuery_init(OrgApacheLuceneSearchMultiPhraseQuery *self) {
  ...
  self->termArrays_ = new_JavaUtilArrayList_init();
...
- (OrgApacheLuceneSearchScorer *)scorerWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  IOSObjectArray *postingsFreqs = [IOSObjectArray newArrayWithLength:[((JavaUtilArrayList *) nil_chk(this$0_->termArrays_)) size] type:OrgApacheLuceneSearchPhraseQuery_PostingsAndFreq_class_()];
  for (jint pos = 0; pos < postingsFreqs->size_; pos++) {
    ...
    jint docFreq;
    if (((IOSObjectArray *) nil_chk(terms))->size_ > 1) {
      p = new_OrgApacheLuceneIndexMultipleTermPositions_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexTermArray_(reader, terms);
      docFreq = 0;
    ...
    (void) IOSObjectArray_SetAndConsume(postingsFreqs, pos, new_OrgApacheLuceneSearchPhraseQuery_PostingsAndFreq_initWithOrgApacheLuceneIndexTermPositions_withInt_withInt_withOrgApacheLuceneIndexTerm_(p, docFreq, [((JavaLangInteger *) nil_chk([((JavaUtilArrayList *) nil_chk(this$0_->positions_)) getWithInt:pos])) intValue], IOSObjectArray_Get(terms, 0)));
  }
  if (this$0_->slop_ == 0) {
...
- (OrgApacheLuceneSearchExplanation *)explainWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  OrgApacheLuceneSearchExplanation *idfExpl = new_OrgApacheLuceneSearchExplanation_initWithFloat_withNSString_(idf_, JreStrcat("$$C$C", @"idf(", this$0_->field_, ':', [((OrgApacheLuceneSearchExplanation_IDFExplanation *) nil_chk(idfExp_)) explain], ')'));
...
void OrgApacheLuceneSearchMultiPhraseQuery_MultiPhraseWeight_initWithOrgApacheLuceneSearchMultiPhraseQuery_withOrgApacheLuceneSearchSearcher_(OrgApacheLuceneSearchMultiPhraseQuery_MultiPhraseWeight *self, OrgApacheLuceneSearchMultiPhraseQuery *outer$, OrgApacheLuceneSearchSearcher *searcher) {
  ...
  JavaUtilArrayList *allTerms = new_JavaUtilArrayList_init();
  ...
  self->idfExp_ = [((OrgApacheLuceneSearchSimilarity *) nil_chk(self->similarity_)) idfExplainWithJavaUtilCollection:allTerms withOrgApacheLuceneSearchSearcher:searcher];
