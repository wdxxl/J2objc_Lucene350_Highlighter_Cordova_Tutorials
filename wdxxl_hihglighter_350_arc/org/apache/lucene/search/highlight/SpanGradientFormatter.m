...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/highlight/SpanGradientFormatter.java
//
...
withOrgApacheLuceneSearchHighlightTokenGroup:(OrgApacheLuceneSearchHighlightTokenGroup *)tokenGroup {
  ...
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithInt_([((NSString *) nil_chk(originalText)) java_length] + OrgApacheLuceneSearchHighlightSpanGradientFormatter_EXTRA);
  (void) [sb appendWithNSString:@"<span style=\""];
