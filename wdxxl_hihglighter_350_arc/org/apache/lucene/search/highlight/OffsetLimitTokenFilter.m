...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/highlight/OffsetLimitTokenFilter.java
//
...
void OrgApacheLuceneSearchHighlightOffsetLimitTokenFilter_initWithOrgApacheLuceneAnalysisTokenStream_withInt_(OrgApacheLuceneSearchHighlightOffsetLimitTokenFilter *self, OrgApacheLuceneAnalysisTokenStream *input, jint offsetLimit) {
  ...
  self->offsetAttrib_ = ((id<OrgApacheLuceneAnalysisTokenattributesOffsetAttribute>) [self getAttributeWithIOSClass:OrgApacheLuceneAnalysisTokenattributesOffsetAttribute_class_()]);
