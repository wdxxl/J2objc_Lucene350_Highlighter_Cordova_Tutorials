...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/Similarity.java
//
...
- (jfloat)lengthNormWithNSString:(NSString *)fieldName
  ...
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"please use computeNorm instead");
}
...
- (OrgApacheLuceneSearchExplanation_IDFExplanation *)idfExplainWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term
  ...
  return new_OrgApacheLuceneSearchSimilarity_1_initWithInt_withInt_withFloat_(df, max, idf);
}
...
- (OrgApacheLuceneSearchExplanation_IDFExplanation *)idfExplainWithJavaUtilCollection:(id<JavaUtilCollection>)terms
  ...
  jint max = [((OrgApacheLuceneSearchSearcher *) nil_chk(searcher)) maxDoc];
  jfloat idf = 0.0f;
  JavaLangStringBuilder *exp = new_JavaLangStringBuilder_init();
  for (OrgApacheLuceneIndexTerm * __strong term in nil_chk(terms)) {
    ...
    (void) [exp appendWithNSString:@" "];
    (void) [exp appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(term)) text]];
    (void) [exp appendWithNSString:@"="];
    (void) [exp appendWithInt:df];
  }
  jfloat fIdf = idf;
  return new_OrgApacheLuceneSearchSimilarity_2_initWithFloat_withJavaLangStringBuilder_(fIdf, exp);
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneSearchSimilarity class]) {
    OrgApacheLuceneSearchSimilarity_withoutDocFreqMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneSearchSimilarity_class_(), @"idfExplain", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexTerm_class_(), OrgApacheLuceneSearchSearcher_class_() } count:2 type:IOSClass_class_()]);
    OrgApacheLuceneSearchSimilarity_withDocFreqMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneSearchSimilarity_class_(), @"idfExplain", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexTerm_class_(), OrgApacheLuceneSearchSearcher_class_(), [IOSClass intClass] } count:3 type:IOSClass_class_()]);
    OrgApacheLuceneSearchSimilarity_defaultImpl = new_OrgApacheLuceneSearchDefaultSimilarity_init();
    OrgApacheLuceneSearchSimilarity_NORM_TABLE = [IOSFloatArray newArrayWithLength:256];
    {
...
void OrgApacheLuceneSearchSimilarity_setDefaultWithOrgApacheLuceneSearchSimilarity_(OrgApacheLuceneSearchSimilarity *similarity) {
  ...
  OrgApacheLuceneSearchSimilarity_defaultImpl = similarity;
}
