...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/payloads/PayloadNearQuery.java
//
...
- (OrgApacheLuceneSearchWeight *)createWeightWithOrgApacheLuceneSearchSearcher:(OrgApacheLuceneSearchSearcher *)searcher {
  return new_OrgApacheLuceneSearchPayloadsPayloadNearQuery_PayloadNearSpanWeight_initWithOrgApacheLuceneSearchPayloadsPayloadNearQuery_withOrgApacheLuceneSearchSpansSpanQuery_withOrgApacheLuceneSearchSearcher_(self, self, searcher);
}
...
- (id)java_clone {
  ...
  OrgApacheLuceneSearchPayloadsPayloadNearQuery *boostingNearQuery = new_OrgApacheLuceneSearchPayloadsPayloadNearQuery_initWithOrgApacheLuceneSearchSpansSpanQueryArray_withInt_withBoolean_withOrgApacheLuceneSearchPayloadsPayloadFunction_(newClauses, slop_, inOrder_, function_);
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  (void) [buffer appendWithNSString:@"payloadNear(["];
...
void OrgApacheLuceneSearchPayloadsPayloadNearQuery_initWithOrgApacheLuceneSearchSpansSpanQueryArray_withInt_withBoolean_(OrgApacheLuceneSearchPayloadsPayloadNearQuery *self, IOSObjectArray *clauses, jint slop, jboolean inOrder) {
  OrgApacheLuceneSearchPayloadsPayloadNearQuery_initWithOrgApacheLuceneSearchSpansSpanQueryArray_withInt_withBoolean_withOrgApacheLuceneSearchPayloadsPayloadFunction_(self, clauses, slop, inOrder, new_OrgApacheLuceneSearchPayloadsAveragePayloadFunction_init());
}
...
void OrgApacheLuceneSearchPayloadsPayloadNearQuery_initWithOrgApacheLuceneSearchSpansSpanQueryArray_withInt_withBoolean_withOrgApacheLuceneSearchPayloadsPayloadFunction_(OrgApacheLuceneSearchPayloadsPayloadNearQuery *self, IOSObjectArray *clauses, jint slop, jboolean inOrder, OrgApacheLuceneSearchPayloadsPayloadFunction *function) {
  ...
  self->fieldName_ = [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(IOSObjectArray_Get(nil_chk(clauses), 0))) getField];
...
- (OrgApacheLuceneSearchScorer *)scorerWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  return new_OrgApacheLuceneSearchPayloadsPayloadNearQuery_PayloadNearSpanScorer_initWithOrgApacheLuceneSearchPayloadsPayloadNearQuery_withOrgApacheLuceneSearchSpansSpans_withOrgApacheLuceneSearchWeight_withOrgApacheLuceneSearchSimilarity_withByteArray_(this$0_, [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(query_)) getSpansWithOrgApacheLuceneIndexIndexReader:reader], self, similarity_, [((OrgApacheLuceneIndexIndexReader *) nil_chk(reader)) normsWithNSString:[((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(query_)) getField]]);
}
...
- (jboolean)setFreqCurrentDoc {
  ...
  do {
    ...
    IOSObjectArray *spansArr = [IOSObjectArray newArrayWithLength:1 type:OrgApacheLuceneSearchSpansSpans_class_()];
    (void) IOSObjectArray_Set(spansArr, 0, spans_PayloadNearSpanScorer_);
...
- (OrgApacheLuceneSearchExplanation *)explainWithInt:(jint)doc {
  OrgApacheLuceneSearchExplanation *result = new_OrgApacheLuceneSearchExplanation_init();
...
void OrgApacheLuceneSearchPayloadsPayloadNearQuery_PayloadNearSpanScorer_initWithOrgApacheLuceneSearchPayloadsPayloadNearQuery_withOrgApacheLuceneSearchSpansSpans_withOrgApacheLuceneSearchWeight_withOrgApacheLuceneSearchSimilarity_withByteArray_(OrgApacheLuceneSearchPayloadsPayloadNearQuery_PayloadNearSpanScorer *self, OrgApacheLuceneSearchPayloadsPayloadNearQuery *outer$, OrgApacheLuceneSearchSpansSpans *spans, OrgApacheLuceneSearchWeight *weight, OrgApacheLuceneSearchSimilarity *similarity, IOSByteArray *norms) {
  ...
  self->similarity_PayloadNearSpanScorer_ = [self getSimilarity];
  self->spans_PayloadNearSpanScorer_ = spans;
}
