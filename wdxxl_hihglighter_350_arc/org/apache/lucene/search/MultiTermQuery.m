...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/MultiTermQuery.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneSearchMultiTermQuery class]) {
    OrgApacheLuceneSearchMultiTermQuery_CONSTANT_SCORE_FILTER_REWRITE = new_OrgApacheLuceneSearchMultiTermQuery_1_init();
    OrgApacheLuceneSearchMultiTermQuery_SCORING_BOOLEAN_QUERY_REWRITE = JreLoadStatic(OrgApacheLuceneSearchScoringRewrite, SCORING_BOOLEAN_QUERY_REWRITE);
    OrgApacheLuceneSearchMultiTermQuery_CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE = JreLoadStatic(OrgApacheLuceneSearchScoringRewrite, CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE);
    OrgApacheLuceneSearchMultiTermQuery_CONSTANT_SCORE_AUTO_REWRITE_DEFAULT = new_OrgApacheLuceneSearchMultiTermQuery_2_init();
...
void OrgApacheLuceneSearchMultiTermQuery_init(OrgApacheLuceneSearchMultiTermQuery *self) {
  ...
  self->rewriteMethod_ = OrgApacheLuceneSearchMultiTermQuery_CONSTANT_SCORE_AUTO_REWRITE_DEFAULT;
...
- (OrgApacheLuceneSearchQuery *)rewriteWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
                                   withOrgApacheLuceneSearchMultiTermQuery:(OrgApacheLuceneSearchMultiTermQuery *)query {
  OrgApacheLuceneSearchQuery *result = new_OrgApacheLuceneSearchConstantScoreQuery_initWithOrgApacheLuceneSearchFilter_(new_OrgApacheLuceneSearchMultiTermQueryWrapperFilter_initWithOrgApacheLuceneSearchMultiTermQuery_(query));
...
- (void)addClauseWithOrgApacheLuceneSearchQuery:(OrgApacheLuceneSearchBooleanQuery *)topLevel
                   withOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term
                                      withFloat:(jfloat)boost {
  OrgApacheLuceneSearchQuery *q = new_OrgApacheLuceneSearchConstantScoreQuery_initWithOrgApacheLuceneSearchQuery_(new_OrgApacheLuceneSearchTermQuery_initWithOrgApacheLuceneIndexTerm_(term));
...
- (void)setTermCountCutoffWithInt:(jint)count {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Please create a private instance");
}
