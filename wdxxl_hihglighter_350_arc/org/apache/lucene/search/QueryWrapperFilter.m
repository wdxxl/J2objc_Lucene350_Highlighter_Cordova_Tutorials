...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/QueryWrapperFilter.java
//
...
- (OrgApacheLuceneSearchDocIdSet *)getDocIdSetWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  OrgApacheLuceneSearchWeight *weight = [new_OrgApacheLuceneSearchIndexSearcher_initWithOrgApacheLuceneIndexIndexReader_(reader) createNormalizedWeightWithOrgApacheLuceneSearchQuery:query_];
  return new_OrgApacheLuceneSearchQueryWrapperFilter_1_initWithOrgApacheLuceneSearchWeight_withOrgApacheLuceneIndexIndexReader_(weight, reader);
}
