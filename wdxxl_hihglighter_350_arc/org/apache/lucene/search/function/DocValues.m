...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/function/DocValues.java
//
...
- (OrgApacheLuceneSearchExplanation *)explainWithInt:(jint)doc {
  return new_OrgApacheLuceneSearchExplanation_initWithFloat_withNSString_([self floatValWithInt:doc], [self toStringWithInt:doc]);
}

- (id)getInnerArray {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"this optional method is for test purposes only");
}
