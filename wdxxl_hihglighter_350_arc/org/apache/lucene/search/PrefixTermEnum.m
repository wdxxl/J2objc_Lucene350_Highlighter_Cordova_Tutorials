...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/PrefixTermEnum.java
//
...
void OrgApacheLuceneSearchPrefixTermEnum_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexTerm_(OrgApacheLuceneSearchPrefixTermEnum *self, OrgApacheLuceneIndexIndexReader *reader, OrgApacheLuceneIndexTerm *prefix) {
  ...
  self->endEnum_ = false;
  self->prefix_ = prefix;
  [self setEnumWithOrgApacheLuceneIndexTermEnum:[((OrgApacheLuceneIndexIndexReader *) nil_chk(reader)) termsWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_([((OrgApacheLuceneIndexTerm *) nil_chk(prefix)) field], [prefix text])]];
}
