...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/HitQueue.java
//
...
- (OrgApacheLuceneSearchScoreDoc *)getSentinelObject {
  return !prePopulate_ ? nil : new_OrgApacheLuceneSearchScoreDoc_initWithInt_withFloat_(JavaLangInteger_MAX_VALUE, JavaLangFloat_NEGATIVE_INFINITY);
}
