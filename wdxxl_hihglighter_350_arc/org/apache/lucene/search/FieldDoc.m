...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/FieldDoc.java
//
...
- (NSString *)description {
  ...
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(fields_))->size_; i++) {
    (void) [((JavaLangStringBuilder *) nil_chk([sb appendWithId:IOSObjectArray_Get(fields_, i)])) appendWithNSString:@", "];
  }
