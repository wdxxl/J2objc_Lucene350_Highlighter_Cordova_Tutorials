...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/NearSpansUnordered.java
//
...
- (jboolean)next {
  if (firstTime_) {
    ...
    if ([((OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *) nil_chk(OrgApacheLuceneSearchSpansNearSpansUnordered_min(self))) next]) {
      (void) [((OrgApacheLuceneSearchSpansNearSpansUnordered_CellQueue *) nil_chk(queue_)) updateTop];
    }
    else {
      more_ = false;
    }
...
- (id<JavaUtilCollection>)getPayload {
  id<JavaUtilSet> matchPayload = new_JavaUtilHashSet_init();
...
void OrgApacheLuceneSearchSpansNearSpansUnordered_initWithOrgApacheLuceneSearchSpansSpanNearQuery_withOrgApacheLuceneIndexIndexReader_(OrgApacheLuceneSearchSpansNearSpansUnordered *self, OrgApacheLuceneSearchSpansSpanNearQuery *query, OrgApacheLuceneIndexIndexReader *reader) {
  ...
  self->ordered_ = new_JavaUtilArrayList_init();
  self->more_ = true;
  ...
  self->queue_ = new_OrgApacheLuceneSearchSpansNearSpansUnordered_CellQueue_initWithOrgApacheLuceneSearchSpansNearSpansUnordered_withInt_(self, ((IOSObjectArray *) nil_chk(clauses))->size_);
  self->subSpans_ = [IOSObjectArray newArrayWithLength:clauses->size_ type:OrgApacheLuceneSearchSpansSpans_class_()];
  for (jint i = 0; i < clauses->size_; i++) {
    OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *cell = new_OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell_initWithOrgApacheLuceneSearchSpansNearSpansUnordered_withOrgApacheLuceneSearchSpansSpans_withInt_(self, [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(IOSObjectArray_Get(clauses, i))) getSpansWithOrgApacheLuceneIndexIndexReader:reader], i);
    [((id<JavaUtilList>) nil_chk(self->ordered_)) addWithId:cell];
    (void) IOSObjectArray_Set(nil_chk(self->subSpans_), i, cell->spans_);
  }
}
...
void OrgApacheLuceneSearchSpansNearSpansUnordered_addToListWithOrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell_(OrgApacheLuceneSearchSpansNearSpansUnordered *self, OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *cell) {
  if (self->last_ != nil) {
    self->last_->next_ = cell;
  }
  else self->first_ = cell;
  self->last_ = cell;
  ((OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *) nil_chk(cell))->next_ = nil;
}

void OrgApacheLuceneSearchSpansNearSpansUnordered_firstToLast(OrgApacheLuceneSearchSpansNearSpansUnordered *self) {
  ((OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *) nil_chk(self->last_))->next_ = self->first_;
  self->last_ = self->first_;
  self->first_ = ((OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *) nil_chk(self->first_))->next_;
  ((OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *) nil_chk(self->last_))->next_ = nil;
}

void OrgApacheLuceneSearchSpansNearSpansUnordered_queueToList(OrgApacheLuceneSearchSpansNearSpansUnordered *self) {
  self->last_ = self->first_ = nil;
...
void OrgApacheLuceneSearchSpansNearSpansUnordered_listToQueue(OrgApacheLuceneSearchSpansNearSpansUnordered *self) {
  ...
  for (OrgApacheLuceneSearchSpansNearSpansUnordered_SpansCell *cell = self->first_; cell != nil; cell = cell->next_) {
    (void) [((OrgApacheLuceneSearchSpansNearSpansUnordered_CellQueue *) nil_chk(self->queue_)) addWithId:cell];
  }
}
...
- (id<JavaUtilCollection>)getPayload {
  return new_JavaUtilArrayList_initWithJavaUtilCollection_([((OrgApacheLuceneSearchSpansSpans *) nil_chk(spans_)) getPayload]);
}
