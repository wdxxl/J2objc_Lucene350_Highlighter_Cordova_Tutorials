...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/FieldMaskingSpanQuery.java
//
...
- (OrgApacheLuceneSearchQuery *)rewriteWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  ...
  if (rewritten != maskedQuery_) {
    ...
    ((OrgApacheLuceneSearchSpansFieldMaskingSpanQuery *) nil_chk(clone))->maskedQuery_ = rewritten;
  }
  if (clone != nil) {
    return clone;
  }
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  (void) [buffer appendWithNSString:@"mask("];
  (void) [buffer appendWithNSString:[((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(maskedQuery_)) toStringWithNSString:field]];
  ...
  (void) [buffer appendWithNSString:@" as "];
  (void) [buffer appendWithNSString:self->field_];
...
void OrgApacheLuceneSearchSpansFieldMaskingSpanQuery_initWithOrgApacheLuceneSearchSpansSpanQuery_withNSString_(OrgApacheLuceneSearchSpansFieldMaskingSpanQuery *self, OrgApacheLuceneSearchSpansSpanQuery *maskedQuery, NSString *maskedField) {
  ...
  self->maskedQuery_ = maskedQuery;
  self->field_ = maskedField;
}
