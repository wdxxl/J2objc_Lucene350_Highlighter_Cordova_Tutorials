...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/TermRangeQuery.java
//
...
- (OrgApacheLuceneSearchFilteredTermEnum *)getEnumWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  return new_OrgApacheLuceneSearchTermRangeTermEnum_initWithOrgApacheLuceneIndexIndexReader_withNSString_withNSString_withNSString_withBoolean_withBoolean_withJavaTextCollator_(reader, field_, lowerTerm_, upperTerm_, includeLower_, includeUpper_, collator_);
}

- (NSString *)toStringWithNSString:(NSString *)field {
  JavaLangStringBuilder *buffer = new_JavaLangStringBuilder_init();
  if (![((NSString *) nil_chk([self getField])) isEqual:field]) {
    (void) [buffer appendWithNSString:[self getField]];
    (void) [buffer appendWithNSString:@":"];
  }
  (void) [buffer appendWithChar:includeLower_ ? '[' : '{'];
  (void) [buffer appendWithNSString:lowerTerm_ != nil ? lowerTerm_ : @"*"];
  (void) [buffer appendWithNSString:@" TO "];
  (void) [buffer appendWithNSString:upperTerm_ != nil ? upperTerm_ : @"*"];
  (void) [buffer appendWithChar:includeUpper_ ? ']' : '}'];
...
void OrgApacheLuceneSearchTermRangeQuery_initWithNSString_withNSString_withNSString_withBoolean_withBoolean_withJavaTextCollator_(OrgApacheLuceneSearchTermRangeQuery *self, NSString *field, NSString *lowerTerm, NSString *upperTerm, jboolean includeLower, jboolean includeUpper, JavaTextCollator *collator) {
  ...
  self->field_ = field;
  self->lowerTerm_ = lowerTerm;
  self->upperTerm_ = upperTerm;
