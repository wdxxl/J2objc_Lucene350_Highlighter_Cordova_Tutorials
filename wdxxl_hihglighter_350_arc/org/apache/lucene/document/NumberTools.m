...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/document/NumberTools.java
//
...
NSString *OrgApacheLuceneDocumentNumberTools_longToStringWithLong_(jlong l) {
  ...
  JavaLangStringBuilder *buf = new_JavaLangStringBuilder_initWithInt_(OrgApacheLuceneDocumentNumberTools_STR_SIZE);
  if (l < 0) {
    (void) [buf appendWithChar:OrgApacheLuceneDocumentNumberTools_NEGATIVE_PREFIX];
    l = JavaLangLong_MAX_VALUE + l + 1;
  }
  else {
    (void) [buf appendWithChar:OrgApacheLuceneDocumentNumberTools_POSITIVE_PREFIX];
  }
  ...
  (void) [buf appendWithNSString:num];
...
jlong OrgApacheLuceneDocumentNumberTools_stringToLongWithNSString_(NSString *str) {
  ...
  if ([str java_length] != OrgApacheLuceneDocumentNumberTools_STR_SIZE) {
    @throw new_JavaLangNumberFormatException_initWithNSString_(@"string is the wrong size");
  }
  ...
  if (prefix == OrgApacheLuceneDocumentNumberTools_POSITIVE_PREFIX) {
    ...
    @throw new_JavaLangNumberFormatException_initWithNSString_(@"string does not begin with the correct prefix");
  }
  return l;
}
