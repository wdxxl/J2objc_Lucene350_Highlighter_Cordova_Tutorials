...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/document/Field.java
//
...
__attribute__((unused)) static OrgApacheLuceneDocumentField_Store_2 *new_OrgApacheLuceneDocumentField_Store_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
__attribute__((unused)) static OrgApacheLuceneDocumentField_Index_5 *new_OrgApacheLuceneDocumentField_Index_5_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
__attribute__((unused)) static OrgApacheLuceneDocumentField_TermVector_5 *new_OrgApacheLuceneDocumentField_TermVector_5_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
- (void)setValueWithNSString:(NSString *)value {
  if (isBinary_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot set a String value on a binary field");
  }
  fieldsData_ = value;
}
...
- (void)setValueWithJavaIoReader:(JavaIoReader *)value {
  if (isBinary_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot set a Reader value on a binary field");
  }
  if (isStored_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot set a Reader value on a stored field");
  }
  fieldsData_ = value;
}
...
- (void)setValueWithByteArray:(IOSByteArray *)value {
  if (!isBinary_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot set a byte[] value on a non-binary field");
  }
  fieldsData_ = value;
...
void OrgApacheLuceneDocumentField_initWithNSString_withBoolean_withNSString_withOrgApacheLuceneDocumentField_Store_withOrgApacheLuceneDocumentField_Index_withOrgApacheLuceneDocumentField_TermVector_(OrgApacheLuceneDocumentField *self, NSString *name, jboolean internName, NSString *value, OrgApacheLuceneDocumentField_Store *store, OrgApacheLuceneDocumentField_Index *index, OrgApacheLuceneDocumentField_TermVector *termVector) {
  ...
  if (name == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"name cannot be null");
  if (value == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"value cannot be null");
  if (index == JreLoadEnum(OrgApacheLuceneDocumentField_Index, NO) && store == JreLoadEnum(OrgApacheLuceneDocumentField_Store, NO)) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"it doesn't make sense to have a field that is neither indexed nor stored");
  if (index == JreLoadEnum(OrgApacheLuceneDocumentField_Index, NO) && termVector != JreLoadEnum(OrgApacheLuceneDocumentField_TermVector, NO)) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot store term vector information for a field that is not indexed");
  if (internName) name = OrgApacheLuceneUtilStringHelper_internWithNSString_(name);
  self->name_ = name;
  self->fieldsData_ = value;
...
void OrgApacheLuceneDocumentField_initWithNSString_withJavaIoReader_withOrgApacheLuceneDocumentField_TermVector_(OrgApacheLuceneDocumentField *self, NSString *name, JavaIoReader *reader, OrgApacheLuceneDocumentField_TermVector *termVector) {
  OrgApacheLuceneDocumentAbstractField_init(self);
  if (name == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"name cannot be null");
  if (reader == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"reader cannot be null");
  self->name_ = OrgApacheLuceneUtilStringHelper_internWithNSString_(name);
  self->fieldsData_ = reader;
...
void OrgApacheLuceneDocumentField_initWithNSString_withOrgApacheLuceneAnalysisTokenStream_withOrgApacheLuceneDocumentField_TermVector_(OrgApacheLuceneDocumentField *self, NSString *name, OrgApacheLuceneAnalysisTokenStream *tokenStream, OrgApacheLuceneDocumentField_TermVector *termVector) {
  OrgApacheLuceneDocumentAbstractField_init(self);
  if (name == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"name cannot be null");
  if (tokenStream == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"tokenStream cannot be null");
  self->name_ = OrgApacheLuceneUtilStringHelper_internWithNSString_(name);
  self->fieldsData_ = nil;
  self->tokenStream_ = tokenStream;
  self->isStored_ = false;
  self->isIndexed_ = true;
  self->isTokenized_ = true;
...
void OrgApacheLuceneDocumentField_initWithNSString_withByteArray_withOrgApacheLuceneDocumentField_Store_(OrgApacheLuceneDocumentField *self, NSString *name, IOSByteArray *value, OrgApacheLuceneDocumentField_Store *store) {
  ...
  if (store == JreLoadEnum(OrgApacheLuceneDocumentField_Store, NO)) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"binary values can't be unstored");
  }
}
...
void OrgApacheLuceneDocumentField_initWithNSString_withByteArray_withInt_withInt_(OrgApacheLuceneDocumentField *self, NSString *name, IOSByteArray *value, jint offset, jint length) {
  OrgApacheLuceneDocumentAbstractField_init(self);
  if (name == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"name cannot be null");
  if (value == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"value cannot be null");
  self->name_ = OrgApacheLuceneUtilStringHelper_internWithNSString_(name);
  self->fieldsData_ = value;
  self->isStored_ = true;
...
OrgApacheLuceneDocumentField_Store *new_OrgApacheLuceneDocumentField_Store_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Store, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Store_1 *new_OrgApacheLuceneDocumentField_Store_1_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Store_1, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Store_2 *new_OrgApacheLuceneDocumentField_Store_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Store_2, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index *new_OrgApacheLuceneDocumentField_Index_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index_1 *new_OrgApacheLuceneDocumentField_Index_1_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index_1, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index_2 *new_OrgApacheLuceneDocumentField_Index_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index_2, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index_3 *new_OrgApacheLuceneDocumentField_Index_3_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index_3, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index_4 *new_OrgApacheLuceneDocumentField_Index_4_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index_4, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_Index_5 *new_OrgApacheLuceneDocumentField_Index_5_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_Index_5, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector *new_OrgApacheLuceneDocumentField_TermVector_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector_1 *new_OrgApacheLuceneDocumentField_TermVector_1_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector_1, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector_2 *new_OrgApacheLuceneDocumentField_TermVector_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector_2, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector_3 *new_OrgApacheLuceneDocumentField_TermVector_3_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector_3, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector_4 *new_OrgApacheLuceneDocumentField_TermVector_4_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector_4, initWithNSString_withInt_, __name, __ordinal)
}
...
OrgApacheLuceneDocumentField_TermVector_5 *new_OrgApacheLuceneDocumentField_TermVector_5_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentField_TermVector_5, initWithNSString_withInt_, __name, __ordinal)
}
