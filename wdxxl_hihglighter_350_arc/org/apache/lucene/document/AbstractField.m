...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/document/AbstractField.java
//
...
- (void)setOmitTermFreqAndPositionsWithBoolean:(jboolean)omitTermFreqAndPositions {
  if (omitTermFreqAndPositions) {
    indexOptions_ = JreLoadEnum(OrgApacheLuceneIndexFieldInfo_IndexOptions, DOCS_ONLY);
  }
  else {
    indexOptions_ = JreLoadEnum(OrgApacheLuceneIndexFieldInfo_IndexOptions, DOCS_AND_FREQS_AND_POSITIONS);
  }
}
...
- (NSString *)description {
  ...
  if (isStored_) {
    (void) [result appendWithNSString:@"stored"];
  }
  if (isIndexed_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"indexed"];
  }
  if (isTokenized_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"tokenized"];
  }
  if (storeTermVector_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"termVector"];
  }
  if (storeOffsetWithTermVector_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"termVectorOffsets"];
  }
  if (storePositionWithTermVector_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"termVectorPosition"];
  }
  if (isBinary_) {
    if ([result java_length] > 0) (void) [result appendWithNSString:@","];
    (void) [result appendWithNSString:@"binary"];
  }
  if (omitNorms_) {
    (void) [result appendWithNSString:@",omitNorms"];
  }
  if (indexOptions_ != JreLoadEnum(OrgApacheLuceneIndexFieldInfo_IndexOptions, DOCS_AND_FREQS_AND_POSITIONS)) {
    (void) [result appendWithNSString:@",indexOptions="];
    (void) [result appendWithId:indexOptions_];
  }
  if (lazy_) {
    (void) [result appendWithNSString:@",lazy"];
  }
  (void) [result appendWithChar:'<'];
  (void) [result appendWithNSString:name_];
  (void) [result appendWithChar:':'];
  if (fieldsData_ != nil && lazy_ == false) {
    (void) [result appendWithId:fieldsData_];
  }
  (void) [result appendWithChar:'>'];
