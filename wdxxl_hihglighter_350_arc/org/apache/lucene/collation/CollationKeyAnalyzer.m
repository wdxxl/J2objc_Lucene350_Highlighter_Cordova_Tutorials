...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/collation/CollationKeyAnalyzer.java
//
...
- (OrgApacheLuceneAnalysisTokenStream *)tokenStreamWithNSString:(NSString *)fieldName
  ...
  OrgApacheLuceneAnalysisTokenStream *result = new_OrgApacheLuceneAnalysisKeywordTokenizer_initWithJavaIoReader_(reader);
  result = new_OrgApacheLuceneCollationCollationKeyFilter_initWithOrgApacheLuceneAnalysisTokenStream_withJavaTextCollator_(result, collator_);
  return result;
}
...
- (OrgApacheLuceneAnalysisTokenStream *)reusableTokenStreamWithNSString:(NSString *)fieldName
  ...
  if (streams == nil) {
    streams = new_OrgApacheLuceneCollationCollationKeyAnalyzer_SavedStreams_initWithOrgApacheLuceneCollationCollationKeyAnalyzer_(self);
    streams->source_ = new_OrgApacheLuceneAnalysisKeywordTokenizer_initWithJavaIoReader_(reader);
    streams->result_ = new_OrgApacheLuceneCollationCollationKeyFilter_initWithOrgApacheLuceneAnalysisTokenStream_withJavaTextCollator_(streams->source_, collator_);
