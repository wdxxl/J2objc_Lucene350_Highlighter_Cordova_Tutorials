...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/FixedBitSet.java
//
...
- (OrgApacheLuceneSearchDocIdSetIterator *)iterator {
  return new_OrgApacheLuceneUtilOpenBitSetIterator_initWithLongArray_withInt_(bits_, ((IOSLongArray *) nil_chk(bits_))->size_);
}
...
- (id)java_clone {
  return new_OrgApacheLuceneUtilFixedBitSet_initWithOrgApacheLuceneUtilFixedBitSet_(self);
}
...
void OrgApacheLuceneUtilFixedBitSet_initWithInt_(OrgApacheLuceneUtilFixedBitSet *self, jint numBits) {
  ...
  self->bits_ = [IOSLongArray newArrayWithLength:OrgApacheLuceneUtilFixedBitSet_bits2wordsWithInt_(numBits)];
}
...
void OrgApacheLuceneUtilFixedBitSet_initWithOrgApacheLuceneUtilFixedBitSet_(OrgApacheLuceneUtilFixedBitSet *self, OrgApacheLuceneUtilFixedBitSet *other) {
  OrgApacheLuceneSearchDocIdSet_init(self);
  self->bits_ = [IOSLongArray newArrayWithLength:((IOSLongArray *) nil_chk(((OrgApacheLuceneUtilFixedBitSet *) nil_chk(other))->bits_))->size_];
