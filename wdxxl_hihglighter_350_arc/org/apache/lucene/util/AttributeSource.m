...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/AttributeSource.java
//
...
- (id<JavaUtilIterator>)getAttributeImplsIterator {
  ...
  if (initState != nil) {
    return new_OrgApacheLuceneUtilAttributeSource_1_initWithOrgApacheLuceneUtilAttributeSource_State_(initState);
  }
  else {
...
- (void)addAttributeImplWithOrgApacheLuceneUtilAttributeImpl:(OrgApacheLuceneUtilAttributeImpl *)att {
  ...
  for (JavaLangRefWeakReference * __strong curInterfaceRef in nil_chk(foundInterfaces)) {
    ...
    if (![((id<JavaUtilMap>) nil_chk(attributes_)) containsKeyWithId:curInterface]) {
      ...
      (void) [attributeImpls_ putWithId:clazz withId:att];
    }
  }
}
...
- (id<OrgApacheLuceneUtilAttribute>)addAttributeWithIOSClass:(IOSClass *)attClass {
  ...
  if (attImpl == nil) {
    if (!([((IOSClass *) nil_chk(attClass)) isInterface] && [OrgApacheLuceneUtilAttribute_class_() isAssignableFrom:attClass])) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$", @"addAttribute() only accepts an interface that extends Attribute, but ", [attClass getName], @" does not fulfil this contract."));
    }
...
- (id<OrgApacheLuceneUtilAttribute>)getAttributeWithIOSClass:(IOSClass *)attClass {
  OrgApacheLuceneUtilAttributeImpl *attImpl = [((id<JavaUtilMap>) nil_chk(attributes_)) getWithId:attClass];
  if (attImpl == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$", @"This AttributeSource does not have the attribute '", [((IOSClass *) nil_chk(attClass)) getName], @"'."));
  }
  return [((IOSClass *) nil_chk(attClass)) cast:attImpl];
}
...
- (void)restoreStateWithOrgApacheLuceneUtilAttributeSource_State:(OrgApacheLuceneUtilAttributeSource_State *)state {
  ...
  do {
    ...
    if (targetImpl == nil) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$", @"State contains AttributeImpl of type ", [[((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) java_getClass] getName], @" that is not in in this AttributeSource"));
    }
...
- (NSString *)description {
  ...
  if ([self hasAttributes]) {
    for (OrgApacheLuceneUtilAttributeSource_State *state = OrgApacheLuceneUtilAttributeSource_getCurrentState(self); state != nil; state = state->next_) {
      if ([((JavaLangStringBuilder *) nil_chk(sb)) java_length] > 1) (void) [sb appendWithChar:','];
      (void) [sb appendWithNSString:[((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) description]];
    }
  }
...
- (NSString *)reflectAsStringWithBoolean:(jboolean)prependAttClass {
  ...
  OrgApacheLuceneUtilAttributeSource_reflectWithWithOrgApacheLuceneUtilAttributeReflector_(self, new_OrgApacheLuceneUtilAttributeSource_2_initWithJavaLangStringBuilder_withBoolean_(buffer, prependAttClass));
...
- (OrgApacheLuceneUtilAttributeSource *)cloneAttributes {
  OrgApacheLuceneUtilAttributeSource *clone = new_OrgApacheLuceneUtilAttributeSource_initWithOrgApacheLuceneUtilAttributeSource_AttributeFactory_(self->factory_);
  if ([self hasAttributes]) {
    for (OrgApacheLuceneUtilAttributeSource_State *state = OrgApacheLuceneUtilAttributeSource_getCurrentState(self); state != nil; state = state->next_) {
      (void) [((id<JavaUtilMap>) nil_chk(clone->attributeImpls_)) putWithId:[((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) java_getClass] withId:(OrgApacheLuceneUtilAttributeImpl *) cast_chk([((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) java_clone], [OrgApacheLuceneUtilAttributeImpl class])];
    }
    for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(self->attributes_)) entrySet])) {
      (void) [clone->attributes_ putWithId:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey] withId:[((id<JavaUtilMap>) nil_chk(clone->attributeImpls_)) getWithId:[((OrgApacheLuceneUtilAttributeImpl *) nil_chk([entry_ getValue])) java_getClass]]];
    }
  }
  return clone;
}
...
- (void)copyToWithOrgApacheLuceneUtilAttributeSource:(OrgApacheLuceneUtilAttributeSource *)target {
  for (OrgApacheLuceneUtilAttributeSource_State *state = OrgApacheLuceneUtilAttributeSource_getCurrentState(self); state != nil; state = state->next_) {
    ...
    if (targetImpl == nil) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$$", @"This AttributeSource contains AttributeImpl of type ", [[((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) java_getClass] getName], @" that is not in the target"));
    }
    [((OrgApacheLuceneUtilAttributeImpl *) nil_chk(state->attribute_)) copyToWithOrgApacheLuceneUtilAttributeImpl:targetImpl];
  }
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilAttributeSource class]) {
    OrgApacheLuceneUtilAttributeSource_knownImplClasses = new_JavaUtilWeakHashMap_init();
...
void OrgApacheLuceneUtilAttributeSource_initWithOrgApacheLuceneUtilAttributeSource_(OrgApacheLuceneUtilAttributeSource *self, OrgApacheLuceneUtilAttributeSource *input) {
  NSObject_init(self);
  if (input == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"input AttributeSource must not be null");
  }
  self->attributes_ = input->attributes_;
  self->attributeImpls_ = input->attributeImpls_;
  self->currentState_ = input->currentState_;
  self->factory_ = input->factory_;
}
...
void OrgApacheLuceneUtilAttributeSource_initWithOrgApacheLuceneUtilAttributeSource_AttributeFactory_(OrgApacheLuceneUtilAttributeSource *self, OrgApacheLuceneUtilAttributeSource_AttributeFactory *factory) {
  ...
  self->attributeImpls_ = new_JavaUtilLinkedHashMap_init();
  self->currentState_ = [IOSObjectArray newArrayWithLength:1 type:OrgApacheLuceneUtilAttributeSource_State_class_()];
...
JavaUtilLinkedList *OrgApacheLuceneUtilAttributeSource_getAttributeInterfacesWithIOSClass_(IOSClass *clazz) {
  ...
  @synchronized(OrgApacheLuceneUtilAttributeSource_knownImplClasses) {
    ...
    if (foundInterfaces == nil) {
      (void) [OrgApacheLuceneUtilAttributeSource_knownImplClasses putWithId:clazz withId:foundInterfaces = new_JavaUtilLinkedList_init()];
      ...
      do {
        {
          ...
          while (b__ < e__) {
            ...
            if (curInterface != OrgApacheLuceneUtilAttribute_class_() && [OrgApacheLuceneUtilAttribute_class_() isAssignableFrom:curInterface]) {
              [foundInterfaces addWithId:new_JavaLangRefWeakReference_initWithId_([((IOSClass *) nil_chk(curInterface)) asSubclass:OrgApacheLuceneUtilAttribute_class_()])];
            }
          }
        }
...
OrgApacheLuceneUtilAttributeSource_State *OrgApacheLuceneUtilAttributeSource_getCurrentState(OrgApacheLuceneUtilAttributeSource *self) {
  ...
  c->attribute_ = [((id<JavaUtilIterator>) nil_chk(it)) next];
  while ([it hasNext]) {
    c->next_ = new_OrgApacheLuceneUtilAttributeSource_State_init();
    c = c->next_;
    c->attribute_ = [it next];
  }
  return s;
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilAttributeSource_AttributeFactory class]) {
    OrgApacheLuceneUtilAttributeSource_AttributeFactory_DEFAULT_ATTRIBUTE_FACTORY = new_OrgApacheLuceneUtilAttributeSource_AttributeFactory_DefaultAttributeFactory_init();
...
- (OrgApacheLuceneUtilAttributeImpl *)createAttributeInstanceWithIOSClass:(IOSClass *)attClass {
  ...
  @catch (JavaLangInstantiationException *e) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Could not instantiate implementing class for ", [((IOSClass *) nil_chk(attClass)) getName]));
  }
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilAttributeSource_AttributeFactory_DefaultAttributeFactory class]) {
    OrgApacheLuceneUtilAttributeSource_AttributeFactory_DefaultAttributeFactory_attClassImplMap = new_JavaUtilWeakHashMap_init();
  ...
  @synchronized(OrgApacheLuceneUtilAttributeSource_AttributeFactory_DefaultAttributeFactory_attClassImplMap) {
    ...
    if (clazz == nil) {
      @try {
        ...
        (void) [OrgApacheLuceneUtilAttributeSource_AttributeFactory_DefaultAttributeFactory_attClassImplMap putWithId:attClass withId:new_JavaLangRefWeakReference_initWithId_(clazz)];
      }
      @catch (JavaLangClassNotFoundException *e) {
        @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Could not find implementing class for ", [((IOSClass *) nil_chk(attClass)) getName]));
      }
    }
    return clazz;
  }
...
- (id)java_clone {
  OrgApacheLuceneUtilAttributeSource_State *clone = new_OrgApacheLuceneUtilAttributeSource_State_init();
  clone->attribute_ = (OrgApacheLuceneUtilAttributeImpl *) cast_chk([((OrgApacheLuceneUtilAttributeImpl *) nil_chk(attribute_)) java_clone], [OrgApacheLuceneUtilAttributeImpl class]);
  if (next_ != nil) {
    clone->next_ = (OrgApacheLuceneUtilAttributeSource_State *) cast_chk([next_ java_clone], [OrgApacheLuceneUtilAttributeSource_State class]);
  }
  return clone;
}
...
- (OrgApacheLuceneUtilAttributeImpl *)next {
  if (state_ == nil) @throw new_JavaUtilNoSuchElementException_init();
...
- (void)reflectWithIOSClass:(IOSClass *)attClass
  ...
  if ([((JavaLangStringBuilder *) nil_chk(val$buffer_)) java_length] > 0) {
    (void) [val$buffer_ appendWithChar:','];
  }
  if (val$prependAttClass_) {
    (void) [((JavaLangStringBuilder *) nil_chk([val$buffer_ appendWithNSString:[((IOSClass *) nil_chk(attClass)) getName]])) appendWithChar:'#'];
  }
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([val$buffer_ appendWithNSString:key])) appendWithChar:'='])) appendWithId:(value == nil) ? @"null" : value];
}
