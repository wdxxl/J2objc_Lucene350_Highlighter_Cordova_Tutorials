...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/FST.java
//
...
__attribute__((unused)) static OrgApacheLuceneUtilFstFST_INPUT_TYPE *new_OrgApacheLuceneUtilFstFST_INPUT_TYPE_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
- (void)finishWithInt:(jint)startNode {
  ...
  if (self->startNode_ != -1) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"already finished");
  }
  IOSByteArray *finalBytes = [IOSByteArray newArrayWithLength:((OrgApacheLuceneUtilFstFST_BytesWriter *) nil_chk(writer_))->posWrite_];
...
- (void)setEmptyOutputWithId:(id)v {
  if (emptyOutput_ != nil) {
    emptyOutput_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs_)) mergeWithId:emptyOutput_ withId:v];
  }
  else {
    emptyOutput_ = v;
  }
  ...
  emptyOutputBytes_ = [IOSByteArray newArrayWithLength:writer_->posWrite_ - posSave];
...
- (void)saveWithOrgApacheLuceneStoreDataOutput:(OrgApacheLuceneStoreDataOutput *)outArg {
  if (startNode_ == -1) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"call finish first");
  }
  (void) OrgApacheLuceneUtilCodecUtil_writeHeaderWithOrgApacheLuceneStoreDataOutput_withNSString_withInt_(outArg, OrgApacheLuceneUtilFstFST_FILE_FORMAT_NAME, OrgApacheLuceneUtilFstFST_VERSION_CURRENT);
  if (emptyOutput_ != nil) {
...
- (jint)addNodeWithOrgApacheLuceneUtilFstBuilder_UnCompiledNode:(OrgApacheLuceneUtilFstBuilder_UnCompiledNode *)node {
  ...
  if (doFixedArray) {
    if (((IOSIntArray *) nil_chk(bytesPerArc_))->size_ < node->numArcs_) {
      bytesPerArc_ = [IOSIntArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(node->numArcs_, 1)];
    }
  ...
  if (doFixedArray) {
    ...
    bytes_ = OrgApacheLuceneUtilArrayUtil_growWithByteArray_withInt_(bytes_, sizeNeeded);
...
- (OrgApacheLuceneUtilFstFST_Arc *)readLastTargetArcWithOrgApacheLuceneUtilFstFST_Arc:(OrgApacheLuceneUtilFstFST_Arc *)follow
  ...
  if (![self targetHasArcsWithOrgApacheLuceneUtilFstFST_Arc:follow]) {
    ...
    arc->output_ = follow->nextFinalOutput_;
    ...
    if ([arc flagWithInt:OrgApacheLuceneUtilFstFST_BIT_ARCS_AS_FIXED_ARRAY]) {
      ...
      while (![arc isLast]) {
        ...
        if ([arc flagWithInt:OrgApacheLuceneUtilFstFST_BIT_ARC_HAS_OUTPUT]) {
          (void) [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs_)) readWithOrgApacheLuceneStoreDataInput:in];
        }
    ...
    (void) [self readNextRealArcWithOrgApacheLuceneUtilFstFST_Arc:arc withOrgApacheLuceneUtilFstFST_BytesReader:in];
...
- (OrgApacheLuceneUtilFstFST_Arc *)readNextRealArcWithOrgApacheLuceneUtilFstFST_Arc:(OrgApacheLuceneUtilFstFST_Arc *)arc
  ...
  if ([arc flagWithInt:OrgApacheLuceneUtilFstFST_BIT_ARC_HAS_OUTPUT]) {
    arc->output_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs_)) readWithOrgApacheLuceneStoreDataInput:inArg];
  }
  else {
    arc->output_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs_)) getNoOutput];
  }
  if ([arc flagWithInt:OrgApacheLuceneUtilFstFST_BIT_ARC_HAS_FINAL_OUTPUT]) {
    arc->nextFinalOutput_ = [outputs_ readWithOrgApacheLuceneStoreDataInput:inArg];
  }
  else {
    arc->nextFinalOutput_ = [outputs_ getNoOutput];
  }
  if ([arc flagWithInt:OrgApacheLuceneUtilFstFST_BIT_STOP_NODE]) {
...
- (OrgApacheLuceneUtilFstFST_Arc *)findTargetArcWithInt:(jint)labelToMatch
  ...
  if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(follow))->target_ == startNode_ && labelToMatch != OrgApacheLuceneUtilFstFST_END_LABEL && labelToMatch < ((IOSObjectArray *) nil_chk(cachedRootArcs_))->size_) {
    ...
    if (result == nil) {
      ...
      (void) [((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc)) copyFromWithOrgApacheLuceneUtilFstFST_Arc:result];
      return arc;
    }
  }
  if (labelToMatch == OrgApacheLuceneUtilFstFST_END_LABEL) {
    if ([follow isFinal]) {
      ((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->output_ = follow->nextFinalOutput_;
  ...
  (void) [self readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:follow withOrgApacheLuceneUtilFstFST_Arc:arc];
  while (true) {
    if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->label_ == labelToMatch) {
      ...
      (void) [self readNextArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
    }
  }
}
...
void OrgApacheLuceneUtilFstFST_initWithOrgApacheLuceneUtilFstFST_INPUT_TYPE_withOrgApacheLuceneUtilFstOutputs_(OrgApacheLuceneUtilFstFST *self, OrgApacheLuceneUtilFstFST_INPUT_TYPE *inputType, OrgApacheLuceneUtilFstOutputs *outputs) {
  NSObject_init(self);
  self->bytesPerArc_ = [IOSIntArray newArrayWithLength:0];
  self->byteUpto_ = 0;
  self->startNode_ = -1;
  self->inputType_ = inputType;
  self->outputs_ = outputs;
  self->bytes_ = [IOSByteArray newArrayWithLength:128];
  self->NO_OUTPUT_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs)) getNoOutput];
  self->writer_ = new_OrgApacheLuceneUtilFstFST_BytesWriter_initWithOrgApacheLuceneUtilFstFST_(self);
  self->emptyOutput_ = nil;
}
...
void OrgApacheLuceneUtilFstFST_initWithOrgApacheLuceneStoreDataInput_withOrgApacheLuceneUtilFstOutputs_(OrgApacheLuceneUtilFstFST *self, OrgApacheLuceneStoreDataInput *inArg, OrgApacheLuceneUtilFstOutputs *outputs) {
  ...
  if ([((OrgApacheLuceneStoreDataInput *) nil_chk(inArg)) readByte] == 1) {
    ...
    self->bytes_ = [IOSByteArray newArrayWithLength:numBytes];
    [inArg readBytesWithByteArray:self->bytes_ withInt:0 withInt:numBytes];
    self->emptyOutput_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs)) readWithOrgApacheLuceneStoreDataInput:OrgApacheLuceneUtilFstFST_getBytesReaderWithInt_(self, numBytes - 1)];
  }
  else {
    self->emptyOutput_ = nil;
  }
  ...
  switch (t) {
    case 0:
    self->inputType_ = JreLoadEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE1);
    break;
    case 1:
    self->inputType_ = JreLoadEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE2);
    break;
    case 2:
    self->inputType_ = JreLoadEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE4);
    break;
    default:
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$B", @"invalid input type ", t));
  }
  ...
  self->bytes_ = [IOSByteArray newArrayWithLength:[inArg readVInt]];
...
void OrgApacheLuceneUtilFstFST_cacheRootArcs(OrgApacheLuceneUtilFstFST *self) {
  self->cachedRootArcs_ = [IOSObjectArray newArrayWithLength:(jint) 0x80 type:OrgApacheLuceneUtilFstFST_Arc_class_()];
  OrgApacheLuceneUtilFstFST_Arc *arc = new_OrgApacheLuceneUtilFstFST_Arc_init();
  (void) [self getFirstArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
  ...
  if ([self targetHasArcsWithOrgApacheLuceneUtilFstFST_Arc:arc]) {
    (void) [self readFirstRealArcWithInt:arc->target_ withOrgApacheLuceneUtilFstFST_Arc:arc];
    while (true) {
      ...
      if (arc->label_ < ((IOSObjectArray *) nil_chk(self->cachedRootArcs_))->size_) {
        (void) IOSObjectArray_Set(self->cachedRootArcs_, arc->label_, [new_OrgApacheLuceneUtilFstFST_Arc_init() copyFromWithOrgApacheLuceneUtilFstFST_Arc:arc]);
      }
      else {
        break;
      }
...
void OrgApacheLuceneUtilFstFST_seekToNextNodeWithOrgApacheLuceneUtilFstFST_BytesReader_(OrgApacheLuceneUtilFstFST *self, OrgApacheLuceneUtilFstFST_BytesReader *inArg) {
  while (true) {
    ...
    if (OrgApacheLuceneUtilFstFST_flagWithInt_withInt_(flags, OrgApacheLuceneUtilFstFST_BIT_ARC_HAS_OUTPUT)) {
      (void) [((OrgApacheLuceneUtilFstOutputs *) nil_chk(self->outputs_)) readWithOrgApacheLuceneStoreDataInput:inArg];
    }
...
OrgApacheLuceneUtilFstFST_BytesReader *OrgApacheLuceneUtilFstFST_getBytesReaderWithInt_(OrgApacheLuceneUtilFstFST *self, jint pos) {
  return new_OrgApacheLuceneUtilFstFST_BytesReader_initWithOrgApacheLuceneUtilFstFST_withInt_(self, pos);
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstFST_INPUT_TYPE class]) {
    JreEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE1) = new_OrgApacheLuceneUtilFstFST_INPUT_TYPE_initWithNSString_withInt_(@"BYTE1", 0);
    JreEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE2) = new_OrgApacheLuceneUtilFstFST_INPUT_TYPE_initWithNSString_withInt_(@"BYTE2", 1);
    JreEnum(OrgApacheLuceneUtilFstFST_INPUT_TYPE, BYTE4) = new_OrgApacheLuceneUtilFstFST_INPUT_TYPE_initWithNSString_withInt_(@"BYTE4", 2);
...
OrgApacheLuceneUtilFstFST_INPUT_TYPE *new_OrgApacheLuceneUtilFstFST_INPUT_TYPE_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneUtilFstFST_INPUT_TYPE, initWithNSString_withInt_, __name, __ordinal)
}
...
- (OrgApacheLuceneUtilFstFST_Arc *)copyFromWithOrgApacheLuceneUtilFstFST_Arc:(OrgApacheLuceneUtilFstFST_Arc *)other {
  ...
  nextFinalOutput_ = other->nextFinalOutput_;
...
- (void)writeByteWithByte:(jbyte)b {
  if (((IOSByteArray *) nil_chk(this$0_->bytes_))->size_ == posWrite_) {
    this$0_->bytes_ = OrgApacheLuceneUtilArrayUtil_growWithByteArray_(this$0_->bytes_);
  }
...
- (void)writeBytesWithByteArray:(IOSByteArray *)b
  ...
  this$0_->bytes_ = OrgApacheLuceneUtilArrayUtil_growWithByteArray_withInt_(this$0_->bytes_, size);
