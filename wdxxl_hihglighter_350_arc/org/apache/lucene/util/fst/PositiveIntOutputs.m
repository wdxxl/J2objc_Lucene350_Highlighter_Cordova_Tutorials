...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/PositiveIntOutputs.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstPositiveIntOutputs class]) {
    OrgApacheLuceneUtilFstPositiveIntOutputs_NO_OUTPUT = new_JavaLangLong_initWithLong_(0);
    OrgApacheLuceneUtilFstPositiveIntOutputs_singletonShare = new_OrgApacheLuceneUtilFstPositiveIntOutputs_initWithBoolean_(true);
    OrgApacheLuceneUtilFstPositiveIntOutputs_singletonNoShare = new_OrgApacheLuceneUtilFstPositiveIntOutputs_initWithBoolean_(false);
