...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/NoOutputs.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstNoOutputs class]) {
    OrgApacheLuceneUtilFstNoOutputs_NO_OUTPUT = new_OrgApacheLuceneUtilFstNoOutputs_1_init();
    OrgApacheLuceneUtilFstNoOutputs_singleton = new_OrgApacheLuceneUtilFstNoOutputs_init();
