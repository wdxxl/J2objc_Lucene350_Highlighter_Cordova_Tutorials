...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/BytesRefFSTEnum.java
//
...
void OrgApacheLuceneUtilFstBytesRefFSTEnum_initWithOrgApacheLuceneUtilFstFST_(OrgApacheLuceneUtilFstBytesRefFSTEnum *self, OrgApacheLuceneUtilFstFST *fst) {
  ...
  self->current_ = new_OrgApacheLuceneUtilBytesRef_initWithInt_(10);
  self->result_ = new_OrgApacheLuceneUtilFstBytesRefFSTEnum_InputOutput_init();
  self->result_->input_ = self->current_;
...
OrgApacheLuceneUtilFstBytesRefFSTEnum_InputOutput *OrgApacheLuceneUtilFstBytesRefFSTEnum_setResult(OrgApacheLuceneUtilFstBytesRefFSTEnum *self) {
  if (self->upto_ == 0) {
    ...
    ((OrgApacheLuceneUtilFstBytesRefFSTEnum_InputOutput *) nil_chk(self->result_))->output_ = IOSObjectArray_Get(nil_chk(self->output_), self->upto_);
    return self->result_;
  }
}
