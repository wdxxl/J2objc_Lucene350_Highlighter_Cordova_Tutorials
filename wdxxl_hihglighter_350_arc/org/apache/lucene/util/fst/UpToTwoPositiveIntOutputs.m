...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/UpToTwoPositiveIntOutputs.java
//
...
- (OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_TwoLongs *)getWithLong:(jlong)first
  ...
  return new_OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_TwoLongs_initWithLong_withLong_(first, second);
}
...
- (id)addWithId:(id)_prefix
  ...
  if ([_output isKindOfClass:[JavaLangLong class]]) {
    ...
    return new_OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_TwoLongs_initWithLong_withLong_(((OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_TwoLongs *) nil_chk(output))->first_ + v, output->second_ + v);
  }
}
...
- (id)mergeWithId:(id)first
  ...
  return new_OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_TwoLongs_initWithLong_withLong_([((JavaLangLong *) nil_chk((JavaLangLong *) cast_chk(first, [JavaLangLong class]))) longLongValue], [((JavaLangLong *) nil_chk((JavaLangLong *) cast_chk(second, [JavaLangLong class]))) longLongValue]);
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs class]) {
    OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_NO_OUTPUT = new_JavaLangLong_initWithLong_(0);
    OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_singletonShare = new_OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_initWithBoolean_(true);
    OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_singletonNoShare = new_OrgApacheLuceneUtilFstUpToTwoPositiveIntOutputs_initWithBoolean_(false);
