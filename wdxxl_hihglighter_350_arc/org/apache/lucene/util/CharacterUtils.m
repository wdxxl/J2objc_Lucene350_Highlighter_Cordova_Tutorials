...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/CharacterUtils.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilCharacterUtils class]) {
    OrgApacheLuceneUtilCharacterUtils_JAVA_4 = new_OrgApacheLuceneUtilCharacterUtils_Java4CharacterUtils_init();
    OrgApacheLuceneUtilCharacterUtils_JAVA_5 = new_OrgApacheLuceneUtilCharacterUtils_Java5CharacterUtils_init();
...
OrgApacheLuceneUtilCharacterUtils_CharacterBuffer *OrgApacheLuceneUtilCharacterUtils_newCharacterBufferWithInt_(jint bufferSize) {
  OrgApacheLuceneUtilCharacterUtils_initialize();
  if (bufferSize < 2) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"buffersize must be >= 2");
  return new_OrgApacheLuceneUtilCharacterUtils_CharacterBuffer_initWithCharArray_withInt_withInt_([IOSCharArray newArrayWithLength:bufferSize], 0, 0);
}
...
- (jint)codePointAtWithCharArray:(IOSCharArray *)chars
                         withInt:(jint)offset
                         withInt:(jint)limit {
  if (offset >= limit) @throw new_JavaLangIndexOutOfBoundsException_initWithNSString_(@"offset must be less than limit");
  return IOSCharArray_Get(nil_chk(chars), offset);
}
