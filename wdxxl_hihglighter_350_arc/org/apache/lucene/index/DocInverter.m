...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DocInverter.java
//
...
withOrgApacheLuceneIndexSegmentWriteState:(OrgApacheLuceneIndexSegmentWriteState *)state {
  ...
  id<JavaUtilMap> endChildThreadsAndFields = new_JavaUtilHashMap_init();
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(threadsAndFields)) entrySet])) {
    ...
    id<JavaUtilCollection> endChildFields = new_JavaUtilHashSet_init();
    ...
    (void) [childThreadsAndFields putWithId:((OrgApacheLuceneIndexDocInverterPerThread *) nil_chk(perThread))->consumer_ withId:childFields];
    (void) [endChildThreadsAndFields putWithId:perThread->endConsumer_ withId:endChildFields];
  }
...
- (OrgApacheLuceneIndexDocFieldConsumerPerThread *)addThreadWithOrgApacheLuceneIndexDocFieldProcessorPerThread:(OrgApacheLuceneIndexDocFieldProcessorPerThread *)docFieldProcessorPerThread {
  return new_OrgApacheLuceneIndexDocInverterPerThread_initWithOrgApacheLuceneIndexDocFieldProcessorPerThread_withOrgApacheLuceneIndexDocInverter_(docFieldProcessorPerThread, self);
}
