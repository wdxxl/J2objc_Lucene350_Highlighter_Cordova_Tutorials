...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermVectorOffsetInfo.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexTermVectorOffsetInfo class]) {
    OrgApacheLuceneIndexTermVectorOffsetInfo_EMPTY_OFFSET_INFO = [IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneIndexTermVectorOffsetInfo_class_()];
