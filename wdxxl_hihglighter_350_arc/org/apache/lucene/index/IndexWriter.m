...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/IndexWriter.java
//
...
- (OrgApacheLuceneIndexIndexReader *)getReaderWithInt:(jint)termInfosIndexDivisor
  ...
  @synchronized(self) {
    ...
    r = new_OrgApacheLuceneIndexReadOnlyDirectoryReader_initWithOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexSegmentInfos_withInt_withBoolean_(self, segmentInfos_, termInfosIndexDivisor, applyAllDeletes);
    if (infoStream_ != nil) {
...
- (void)messageWithNSString:(NSString *)message {
  if (infoStream_ != nil) [infoStream_ printlnWithNSString:JreStrcat("$I$@$$$$", @"IW ", messageID_, @" [", new_JavaUtilDate_init(), @"; ", [((JavaLangThread *) nil_chk(JavaLangThread_currentThread())) getName], @"]: ", message)];
}
...
- (void)setSimilarityWithOrgApacheLuceneSearchSimilarity:(OrgApacheLuceneSearchSimilarity *)similarity {
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setSimilarityWithOrgApacheLuceneSearchSimilarity:similarity];
}
...
- (void)setTermIndexIntervalWithInt:(jint)interval {
  OrgApacheLuceneIndexIndexWriter_ensureOpen(self);
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setTermIndexIntervalWithInt:interval];
}
...
- (void)setMergePolicyWithOrgApacheLuceneIndexMergePolicy:(OrgApacheLuceneIndexMergePolicy *)mp {
  OrgApacheLuceneIndexIndexWriter_ensureOpen(self);
  if (mp == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"MergePolicy must be non-null");
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setMergePolicyWithOrgApacheLuceneIndexMergePolicy:mp];
}
...
- (void)setMergeSchedulerWithOrgApacheLuceneIndexMergeScheduler:(OrgApacheLuceneIndexMergeScheduler *)mergeScheduler {
  @synchronized(self) {
    OrgApacheLuceneIndexIndexWriter_ensureOpen(self);
    if (mergeScheduler == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"MergeScheduler must be non-null");
    ...
    self->mergeScheduler_ = mergeScheduler;
    if (infoStream_ != nil) [self messageWithNSString:JreStrcat("$@", @"setMergeScheduler ", mergeScheduler)];
    (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setMergeSchedulerWithOrgApacheLuceneIndexMergeScheduler:mergeScheduler];
  }
}
...
- (void)setReaderTermsIndexDivisorWithInt:(jint)divisor {
  OrgApacheLuceneIndexIndexWriter_ensureOpen(self);
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setReaderTermsIndexDivisorWithInt:divisor];
  if (infoStream_ != nil) {
...
- (void)setMaxBufferedDocsWithInt:(jint)maxBufferedDocs {
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setMaxBufferedDocsWithInt:maxBufferedDocs];
}
...
- (void)setRAMBufferSizeMBWithDouble:(jdouble)mb {
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setRAMBufferSizeMBWithDouble:mb];
}
...
- (void)setMaxBufferedDeleteTermsWithInt:(jint)maxBufferedDeleteTerms {
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setMaxBufferedDeleteTermsWithInt:maxBufferedDeleteTerms];
}
...
- (void)setWriteLockTimeoutWithLong:(jlong)writeLockTimeout {
  ...
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setWriteLockTimeoutWithLong:writeLockTimeout];
}
...
- (void)forceMergeWithInt:(jint)maxNumSegments
              withBoolean:(jboolean)doWait {
  OrgApacheLuceneIndexIndexWriter_ensureOpen(self);
  if (maxNumSegments < 1) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"maxNumSegments must be >= 1; got ", maxNumSegments));
  if (infoStream_ != nil) {
  ...
  @synchronized(self) {
    ...
    for (OrgApacheLuceneIndexSegmentInfo * __strong info in nil_chk(segmentInfos_)) {
      (void) [((id<JavaUtilMap>) nil_chk(segmentsToMerge_)) putWithId:info withId:JreLoadStatic(JavaLangBoolean, TRUE)];
    }
    ...
    for (OrgApacheLuceneIndexMergePolicy_OneMerge * __strong merge in nil_chk(pendingMerges_)) {
      ...
      (void) [((id<JavaUtilMap>) nil_chk(segmentsToMerge_)) putWithId:merge->info_ withId:JreLoadStatic(JavaLangBoolean, TRUE)];
    }
    ...
    @synchronized(self) {
      while (true) {
        if (JreLoadVolatileBoolean(&hitOOM_)) {
          @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot complete forceMerge");
        }
        if ([((id<JavaUtilList>) nil_chk(mergeExceptions_)) size] > 0) {
          ...
          for (jint i = 0; i < size; i++) {
            ...
            if (((OrgApacheLuceneIndexMergePolicy_OneMerge *) nil_chk(merge))->maxNumSegments_ != -1) {
              JavaIoIOException *err = new_JavaIoIOException_initWithNSString_(JreStrcat("$$", @"background merge hit exception: ", [merge segStringWithOrgApacheLuceneStoreDirectory:directory_]));
              NSException *t = [merge getException];
              if (t != nil) (void) [err initCauseWithNSException:t];
              @throw err;
            }
          }
        }
...
- (void)forceMergeDeletesWithBoolean:(jboolean)doWait {
  ...
  if (spec != nil && doWait) {
    ...
    @synchronized(self) {
      ...
      while (running) {
        if (JreLoadVolatileBoolean(&hitOOM_)) {
          @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot complete forceMergeDeletes");
        }
        running = false;
        for (jint i = 0; i < numMerges; i++) {
          ...
          if (t != nil) {
            JavaIoIOException *ioe = new_JavaIoIOException_initWithNSString_(JreStrcat("$$", @"background merge hit exception: ", [merge segStringWithOrgApacheLuceneStoreDirectory:directory_]));
            (void) [ioe initCauseWithNSException:t];
            @throw ioe;
          }
        }
  ...
  @try {
    ...
    id<JavaUtilComparator> versionComparator = OrgApacheLuceneUtilStringHelper_getVersionComparator();
    {
      ...
      while (b__ < e__) {
        ...
        OrgApacheLuceneIndexSegmentInfos *sis = new_OrgApacheLuceneIndexSegmentInfos_init();
        [sis readWithOrgApacheLuceneStoreDirectory:dir];
        id<JavaUtilSet> dsFilesCopied = new_JavaUtilHashSet_init();
        id<JavaUtilMap> dsNames = new_JavaUtilHashMap_init();
...
- (void)addIndexesWithOrgApacheLuceneIndexIndexReaderArray:(IOSObjectArray *)readers {
  ...
  @try {
    ...
    if (useCompoundFile) {
      (void) [merger createCompoundFileWithNSString:JreStrcat("$$", mergedName, @".cfs") withOrgApacheLuceneIndexSegmentInfo:info];
      @synchronized(self) {
        [((OrgApacheLuceneIndexIndexFileDeleter *) nil_chk(deleter_)) deleteNewFilesWithJavaUtilCollection:[info files]];
      }
...
- (NSString *)segStringWithJavaLangIterable:(id<JavaLangIterable>)infos {
  @synchronized(self) {
    ...
    for (OrgApacheLuceneIndexSegmentInfo * __strong s in nil_chk(infos)) {
      ...
      (void) [buffer appendWithNSString:[self segStringWithOrgApacheLuceneIndexSegmentInfo:s]];
    }
...
- (NSString *)segStringWithOrgApacheLuceneIndexSegmentInfo:(OrgApacheLuceneIndexSegmentInfo *)info {
  @synchronized(self) {
    ...
    @try {
      if (reader != nil) {
        (void) [buffer appendWithNSString:[reader description]];
      }
      else {
        (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexSegmentInfo *) nil_chk(info)) toStringWithOrgApacheLuceneStoreDirectory:directory_ withInt:0]];
...
- (void)setMergedSegmentWarmerWithOrgApacheLuceneIndexIndexWriter_IndexReaderWarmer:(OrgApacheLuceneIndexIndexWriter_IndexReaderWarmer *)warmer {
  (void) [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config_)) setMergedSegmentWarmerWithOrgApacheLuceneIndexIndexWriter_IndexReaderWarmer:warmer];
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexIndexWriter class]) {
    ...
    OrgApacheLuceneIndexIndexWriter_MESSAGE_ID = new_JavaUtilConcurrentAtomicAtomicInteger_init();
...
void OrgApacheLuceneIndexIndexWriter_ensureOpenWithBoolean_(OrgApacheLuceneIndexIndexWriter *self, jboolean includePendingClose) {
  if (JreLoadVolatileBoolean(&self->closed_) || (includePendingClose && JreLoadVolatileBoolean(&self->closing_))) {
    @throw new_OrgApacheLuceneStoreAlreadyClosedException_initWithNSString_(@"this IndexWriter is closed");
  }
}
...
OrgApacheLuceneIndexLogMergePolicy *OrgApacheLuceneIndexIndexWriter_getLogMergePolicy(OrgApacheLuceneIndexIndexWriter *self) {
  ...
  else @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"this method can only be called when the merge policy is the default LogMergePolicy");
}
...
void OrgApacheLuceneIndexIndexWriter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneAnalysisAnalyzer_withOrgApacheLuceneIndexIndexWriter_MaxFieldLength_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneStoreDirectory *d, OrgApacheLuceneAnalysisAnalyzer *a, OrgApacheLuceneIndexIndexWriter_MaxFieldLength *mfl) {
  OrgApacheLuceneIndexIndexWriter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexWriterConfig_(self, d, new_OrgApacheLuceneIndexIndexWriterConfig_initWithOrgApacheLuceneUtilVersion_withOrgApacheLuceneAnalysisAnalyzer_(JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_31), a));
  [self setMaxFieldLengthWithInt:[((OrgApacheLuceneIndexIndexWriter_MaxFieldLength *) nil_chk(mfl)) getLimit]];
}
...
void OrgApacheLuceneIndexIndexWriter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneAnalysisAnalyzer_withOrgApacheLuceneIndexIndexDeletionPolicy_withOrgApacheLuceneIndexIndexWriter_MaxFieldLength_withOrgApacheLuceneIndexIndexCommit_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneStoreDirectory *d, OrgApacheLuceneAnalysisAnalyzer *a, id<OrgApacheLuceneIndexIndexDeletionPolicy> deletionPolicy, OrgApacheLuceneIndexIndexWriter_MaxFieldLength *mfl, OrgApacheLuceneIndexIndexCommit *commit) {
  OrgApacheLuceneIndexIndexWriter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexWriterConfig_(self, d, [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk([((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk([new_OrgApacheLuceneIndexIndexWriterConfig_initWithOrgApacheLuceneUtilVersion_withOrgApacheLuceneAnalysisAnalyzer_(JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_31), a) setOpenModeWithOrgApacheLuceneIndexIndexWriterConfig_OpenMode:JreLoadEnum(OrgApacheLuceneIndexIndexWriterConfig_OpenMode, APPEND)])) setIndexDeletionPolicyWithOrgApacheLuceneIndexIndexDeletionPolicy:deletionPolicy])) setIndexCommitWithOrgApacheLuceneIndexIndexCommit:commit]);
  [self setMaxFieldLengthWithInt:[((OrgApacheLuceneIndexIndexWriter_MaxFieldLength *) nil_chk(mfl)) getLimit]];
}
...
void OrgApacheLuceneIndexIndexWriter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexWriterConfig_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneStoreDirectory *d, OrgApacheLuceneIndexIndexWriterConfig *conf) {
  ...
  self->similarity_ = OrgApacheLuceneSearchSimilarity_getDefault();
  self->segmentInfos_ = new_OrgApacheLuceneIndexSegmentInfos_init();
  self->segmentsToMerge_ = new_JavaUtilHashMap_init();
  self->mergingSegments_ = new_JavaUtilHashSet_init();
  self->pendingMerges_ = new_JavaUtilLinkedList_init();
  self->runningMerges_ = new_JavaUtilHashSet_init();
  self->mergeExceptions_ = new_JavaUtilArrayList_init();
  self->flushCount_ = new_JavaUtilConcurrentAtomicAtomicInteger_init();
  self->flushDeletesCount_ = new_JavaUtilConcurrentAtomicAtomicInteger_init();
  self->readerPool_ = new_OrgApacheLuceneIndexIndexWriter_ReaderPool_initWithOrgApacheLuceneIndexIndexWriter_(self);
  self->readerFinishedListeners_ = new_OrgApacheLuceneUtilMapBackedSet_initWithJavaUtilMap_(new_JavaUtilConcurrentConcurrentHashMap_init());
  self->maxFieldLength_ = OrgApacheLuceneIndexIndexWriter_DEFAULT_MAX_FIELD_LENGTH;
  self->commitLock_ = new_NSObject_init();
  self->flushControl_ = new_OrgApacheLuceneIndexIndexWriter_FlushControl_initWithOrgApacheLuceneIndexIndexWriter_(self);
  self->config_ = (OrgApacheLuceneIndexIndexWriterConfig *) cast_chk([((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(conf)) java_clone], [OrgApacheLuceneIndexIndexWriterConfig class]);
  self->directory_ = d;
  self->analyzer_ = [conf getAnalyzer];
  self->infoStream_ = OrgApacheLuceneIndexIndexWriter_defaultInfoStream;
  self->writeLockTimeout_ = [conf getWriteLockTimeout];
  self->similarity_ = [conf getSimilarity];
  self->mergePolicy_ = [conf getMergePolicy];
  [((OrgApacheLuceneIndexMergePolicy *) nil_chk(self->mergePolicy_)) setIndexWriterWithOrgApacheLuceneIndexIndexWriter:self];
  self->mergeScheduler_ = [conf getMergeScheduler];
  self->bufferedDeletesStream_ = new_OrgApacheLuceneIndexBufferedDeletesStream_initWithInt_(self->messageID_);
  ...
  self->writeLock_ = [((OrgApacheLuceneStoreDirectory *) nil_chk(self->directory_)) makeLockWithNSString:OrgApacheLuceneIndexIndexWriter_WRITE_LOCK_NAME];
  if (![((OrgApacheLuceneStoreLock *) nil_chk(self->writeLock_)) obtainWithLong:self->writeLockTimeout_]) @throw new_OrgApacheLuceneStoreLockObtainFailedException_initWithNSString_(JreStrcat("$@", @"Index locked for write: ", self->writeLock_));
  ...
  @try {
    if (create) {
      ...
      if (commit != nil) {
        if ([commit getDirectory] != self->directory_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"IndexCommit's directory doesn't match my directory");
        OrgApacheLuceneIndexSegmentInfos *oldInfos = new_OrgApacheLuceneIndexSegmentInfos_init();
    ...
    self->rollbackSegments_ = [self->segmentInfos_ createBackupSegmentInfosWithBoolean:true];
    self->docWriter_ = new_OrgApacheLuceneIndexDocumentsWriter_initWithOrgApacheLuceneIndexIndexWriterConfig_withOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexFieldInfos_withOrgApacheLuceneIndexBufferedDeletesStream_(self->config_, self->directory_, self, OrgApacheLuceneIndexIndexWriter_getCurrentFieldInfos(self), self->bufferedDeletesStream_);
    ...
    @synchronized(self) {
      self->deleter_ = new_OrgApacheLuceneIndexIndexFileDeleter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexDeletionPolicy_withOrgApacheLuceneIndexSegmentInfos_withJavaIoPrintStream_withOrgApacheLuceneIndexIndexWriter_(self->directory_, [conf getIndexDeletionPolicy], self->segmentInfos_, self->infoStream_, self);
    }
...
OrgApacheLuceneIndexFieldInfos *OrgApacheLuceneIndexIndexWriter_getFieldInfosWithOrgApacheLuceneIndexSegmentInfo_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexSegmentInfo *info) {
  ...
  @try {
    if ([((OrgApacheLuceneIndexSegmentInfo *) nil_chk(info)) getUseCompoundFile]) {
      cfsDir = new_OrgApacheLuceneIndexCompoundFileReader_initWithOrgApacheLuceneStoreDirectory_withNSString_(self->directory_, OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_(info->name_, OrgApacheLuceneIndexIndexFileNames_COMPOUND_FILE_EXTENSION));
    }
    else {
      cfsDir = self->directory_;
    }
    return new_OrgApacheLuceneIndexFieldInfos_initWithOrgApacheLuceneStoreDirectory_withNSString_(cfsDir, OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_(info->name_, OrgApacheLuceneIndexIndexFileNames_FIELD_INFOS_EXTENSION));
  }
  @finally {
...
OrgApacheLuceneIndexFieldInfos *OrgApacheLuceneIndexIndexWriter_getCurrentFieldInfos(OrgApacheLuceneIndexIndexWriter *self) {
  ...
  if ([((OrgApacheLuceneIndexSegmentInfos *) nil_chk(self->segmentInfos_)) size] > 0) {
    if ([self->segmentInfos_ getFormat] > OrgApacheLuceneIndexSegmentInfos_FORMAT_DIAGNOSTICS) {
      fieldInfos = new_OrgApacheLuceneIndexFieldInfos_init();
      for (OrgApacheLuceneIndexSegmentInfo * __strong info in self->segmentInfos_) {
        ...
        for (jint fieldNumber = 0; fieldNumber < fieldCount; fieldNumber++) {
          (void) [fieldInfos addWithOrgApacheLuceneIndexFieldInfo:[segFieldInfos fieldInfoWithInt:fieldNumber]];
        }
      }
    }
    else {
...
void OrgApacheLuceneIndexIndexWriter_setDefaultInfoStreamWithJavaIoPrintStream_(JavaIoPrintStream *infoStream) {
  ...
  OrgApacheLuceneIndexIndexWriter_defaultInfoStream = infoStream;
}
  ...
  @try {
    ...
    @synchronized(self) {
      if (JreLoadVolatileId(&self->pendingCommit_) != nil) {
        ...
        (void) JreVolatileStrongAssign(&self->pendingCommit_, nil);
        [self java_notifyAll];
      }
...
void OrgApacheLuceneIndexIndexWriter_noDupDirsWithOrgApacheLuceneStoreDirectoryArray_(OrgApacheLuceneIndexIndexWriter *self, IOSObjectArray *dirs) {
  JavaUtilHashSet *dups = new_JavaUtilHashSet_init();
  {
    IOSObjectArray *a__ = dirs;
    OrgApacheLuceneStoreDirectory * const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
    OrgApacheLuceneStoreDirectory * const *e__ = b__ + a__->size_;
    while (b__ < e__) {
      OrgApacheLuceneStoreDirectory *dir = *b__++;
      if ([dups containsWithId:dir]) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$", @"Directory ", dir, @" appears more than once"));
      if (dir == self->directory_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Cannot add directory to itself");
      [dups addWithId:dir];
    }
  }
}
...
void OrgApacheLuceneIndexIndexWriter_copySegmentIntoCFSWithOrgApacheLuceneIndexSegmentInfo_withNSString_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexSegmentInfo *info, NSString *segName) {
  ...
  OrgApacheLuceneIndexCompoundFileWriter *cfsWriter = new_OrgApacheLuceneIndexCompoundFileWriter_initWithOrgApacheLuceneStoreDirectory_withNSString_(self->directory_, segFileName);
...
void OrgApacheLuceneIndexIndexWriter_copySegmentAsIsWithOrgApacheLuceneIndexSegmentInfo_withNSString_withJavaUtilMap_withJavaUtilSet_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexSegmentInfo *info, NSString *segName, id<JavaUtilMap> dsNames, id<JavaUtilSet> dsFilesCopied) {
  ...
  if (dsName != nil) {
    if ([((id<JavaUtilMap>) nil_chk(dsNames)) containsKeyWithId:dsName]) {
      ...
      (void) [dsNames putWithId:dsName withId:segName];
      newDsName = segName;
    }
  }
  else {
...
void OrgApacheLuceneIndexIndexWriter_prepareCommitWithJavaUtilMap_(OrgApacheLuceneIndexIndexWriter *self, id<JavaUtilMap> commitUserData) {
  OrgApacheLuceneIndexIndexWriter_ensureOpenWithBoolean_(self, false);
  if (JreLoadVolatileBoolean(&self->hitOOM_)) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot commit");
  }
  if (JreLoadVolatileId(&self->pendingCommit_) != nil) @throw new_JavaLangIllegalStateException_initWithNSString_(@"prepareCommit was already called with no corresponding call to commit");
  ...
  @synchronized(self) {
    if (JreLoadVolatileId(&self->pendingCommit_) != nil) {
      @try {
        ...
        self->rollbackSegments_ = [((OrgApacheLuceneIndexSegmentInfos *) nil_chk(JreLoadVolatileId(&self->pendingCommit_))) createBackupSegmentInfosWithBoolean:true];
...
jboolean OrgApacheLuceneIndexIndexWriter_doFlushWithBoolean_(OrgApacheLuceneIndexIndexWriter *self, jboolean applyAllDeletes) {
  @synchronized(self) {
    if (JreLoadVolatileBoolean(&self->hitOOM_)) {
      @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot flush");
    }
    [self doBeforeFlush];
...
void OrgApacheLuceneIndexIndexWriter_ensureValidMergeWithOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexMergePolicy_OneMerge *merge) {
  for (OrgApacheLuceneIndexSegmentInfo * __strong info in nil_chk(((OrgApacheLuceneIndexMergePolicy_OneMerge *) nil_chk(merge))->segments_)) {
    if (![((OrgApacheLuceneIndexSegmentInfos *) nil_chk(self->segmentInfos_)) containsWithOrgApacheLuceneIndexSegmentInfo:info]) {
      @throw new_OrgApacheLuceneIndexMergePolicy_MergeException_initWithNSString_withOrgApacheLuceneStoreDirectory_(JreStrcat("$$$$", @"MergePolicy selected a segment (", ((OrgApacheLuceneIndexSegmentInfo *) nil_chk(info))->name_, @") that is not in the current index ", [self segString]), self->directory_);
    }
  }
}
...
jboolean OrgApacheLuceneIndexIndexWriter_commitMergeWithOrgApacheLuceneIndexMergePolicy_OneMerge_withOrgApacheLuceneIndexSegmentReader_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexMergePolicy_OneMerge *merge, OrgApacheLuceneIndexSegmentReader *mergedReader) {
  @synchronized(self) {
    ...
    if (JreLoadVolatileBoolean(&self->hitOOM_)) {
      @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot complete merge");
    }
    ...
    if (merge->maxNumSegments_ != -1) {
      if (![((id<JavaUtilMap>) nil_chk(self->segmentsToMerge_)) containsKeyWithId:merge->info_]) {
        (void) [((id<JavaUtilMap>) nil_chk(self->segmentsToMerge_)) putWithId:merge->info_ withId:JreLoadStatic(JavaLangBoolean, FALSE)];
      }
    }
    return true;
  }
...
void OrgApacheLuceneIndexIndexWriter_handleMergeExceptionWithNSException_withOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexIndexWriter *self, NSException *t, OrgApacheLuceneIndexMergePolicy_OneMerge *merge) {
  ...
  else @throw new_JavaLangRuntimeException_initWithNSException_(t);
}
...
jboolean OrgApacheLuceneIndexIndexWriter_registerMergeWithOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexMergePolicy_OneMerge *merge) {
  @synchronized(self) {
    ...
    if (self->stopMerges_) {
      [merge abort];
      @throw new_OrgApacheLuceneIndexMergePolicy_MergeAbortedException_initWithNSString_(JreStrcat("$$", @"merge is aborted: ", [merge segStringWithOrgApacheLuceneStoreDirectory:self->directory_]));
    }
...
void OrgApacheLuceneIndexIndexWriter__mergeInitWithOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexMergePolicy_OneMerge *merge) {
  @synchronized(self) {
    ...
    if (JreLoadVolatileBoolean(&self->hitOOM_)) {
      @throw new_JavaLangIllegalStateException_initWithNSString_(@"this writer hit an OutOfMemoryError; cannot merge");
    }
    ...
    merge->info_ = new_OrgApacheLuceneIndexSegmentInfo_initWithNSString_withInt_withOrgApacheLuceneStoreDirectory_withBoolean_withBoolean_withBoolean_withBoolean_(OrgApacheLuceneIndexIndexWriter_newSegmentName(self), 0, self->directory_, false, true, false, hasVectors);
    ...
    [self->bufferedDeletesStream_ pruneWithOrgApacheLuceneIndexSegmentInfos:self->segmentInfos_];
    id<JavaUtilMap> details = new_JavaUtilHashMap_init();
    (void) [details putWithId:@"mergeMaxNumSegments" withId:JreStrcat("I", merge->maxNumSegments_)];
    (void) [details putWithId:@"mergeFactor" withId:JavaLangInteger_toStringWithInt_([merge->segments_ size])];
...
void OrgApacheLuceneIndexIndexWriter_setDiagnosticsWithOrgApacheLuceneIndexSegmentInfo_withNSString_withJavaUtilMap_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexSegmentInfo *info, NSString *source, id<JavaUtilMap> details) {
  id<JavaUtilMap> diagnostics = new_JavaUtilHashMap_init();
  (void) [diagnostics putWithId:@"source" withId:source];
  (void) [diagnostics putWithId:@"lucene.version" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, LUCENE_VERSION)];
  (void) [diagnostics putWithId:@"os" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, OS_NAME)];
  (void) [diagnostics putWithId:@"os.arch" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, OS_ARCH)];
  (void) [diagnostics putWithId:@"os.version" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, OS_VERSION)];
  (void) [diagnostics putWithId:@"java.version" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, JAVA_VERSION)];
  (void) [diagnostics putWithId:@"java.vendor" withId:JreLoadStatic(OrgApacheLuceneUtilConstants, JAVA_VENDOR)];
  if (details != nil) {
  ...
  @synchronized(self) {
    ...
    for (jint i = 0; i < numSegments; i++) {
      if ([((id<JavaUtilList>) nil_chk(merge->readers_)) getWithInt:i] != nil) {
        ...
        (void) [((id<JavaUtilList>) nil_chk(merge->readers_)) setWithInt:i withId:nil];
      }
      if (i < [((id<JavaUtilList>) nil_chk(merge->readerClones_)) size] && [((id<JavaUtilList>) nil_chk(merge->readerClones_)) getWithInt:i] != nil) {
        ...
        (void) [((id<JavaUtilList>) nil_chk(merge->readerClones_)) setWithInt:i withId:nil];
      }
    }
...
jint OrgApacheLuceneIndexIndexWriter_mergeMiddleWithOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexIndexWriter *self, OrgApacheLuceneIndexMergePolicy_OneMerge *merge) {
  ...
  merge->readers_ = new_JavaUtilArrayList_init();
  merge->readerClones_ = new_JavaUtilArrayList_init();
  jboolean success = false;
  @try {
    jint totDocCount = 0;
    jint segUpto = 0;
    ...
    if (useCompoundFile) {
      ...
      @try {
        ...
        (void) [merger createCompoundFileWithNSString:compoundFileName withOrgApacheLuceneIndexSegmentInfo:merge->info_];
        success = true;
      }
    ...
    if (self->infoStream_ != nil) {
      [self messageWithNSString:NSString_java_formatWithNSString_withNSObjectArray_(@"merged segment size=%.3f MB vs estimate=%.3f MB", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_([((OrgApacheLuceneIndexSegmentInfo *) nil_chk(merge->info_)) sizeInBytesWithBoolean:true] / 1024. / 1024.), JavaLangDouble_valueOfWithDouble_(merge->estimatedMergeBytes_ / 1024 / 1024.) } count:2 type:NSObject_class_()])];
    }
  ...
  @try {
    ...
    @try {
      ...
      @synchronized(self) {
        ...
        (void) JreVolatileStrongAssign(&self->pendingCommit_, toSync);
      }
      if (self->infoStream_ != nil) {
...
- (jboolean)release__WithOrgApacheLuceneIndexSegmentReader:(OrgApacheLuceneIndexSegmentReader *)sr
  ...
  @synchronized(self) {
    ...
    if (pooled && (drop || (!JreLoadVolatileBoolean(&this$0_->poolReaders_) && [sr getRefCount] == 1))) {
      ...
      [sr close];
      (void) [readerMap_ removeWithId:[sr getSegmentInfo]];
      return hasChanges;
    }
    return false;
  }
...
- (void)dropWithOrgApacheLuceneIndexSegmentInfo:(OrgApacheLuceneIndexSegmentInfo *)info {
  @synchronized(self) {
    ...
    if (sr != nil) {
      ...
      (void) [readerMap_ removeWithId:info];
      [sr close];
    }
  }
}
...
- (OrgApacheLuceneIndexSegmentReader *)getWithOrgApacheLuceneIndexSegmentInfo:(OrgApacheLuceneIndexSegmentInfo *)info
  ...
  @synchronized(self) {
    ...
    if (sr == nil) {
      ...
      (void) JreVolatileStrongAssign(&((OrgApacheLuceneIndexSegmentReader *) nil_chk(sr))->readerFinishedListeners_, this$0_->readerFinishedListeners_);
      if (info->dir_ == this$0_->directory_) {
        (void) [readerMap_ putWithId:info withId:sr];
      }
    }
    else {
      if (doOpenStores) {
...
void OrgApacheLuceneIndexIndexWriter_ReaderPool_initWithOrgApacheLuceneIndexIndexWriter_(OrgApacheLuceneIndexIndexWriter_ReaderPool *self, OrgApacheLuceneIndexIndexWriter *outer$) {
  self->this$0_ = outer$;
  NSObject_init(self);
  self->readerMap_ = new_JavaUtilHashMap_init();
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexIndexWriter_MaxFieldLength class]) {
    OrgApacheLuceneIndexIndexWriter_MaxFieldLength_UNLIMITED = new_OrgApacheLuceneIndexIndexWriter_MaxFieldLength_initWithNSString_withInt_(@"UNLIMITED", JavaLangInteger_MAX_VALUE);
    OrgApacheLuceneIndexIndexWriter_MaxFieldLength_LIMITED = new_OrgApacheLuceneIndexIndexWriter_MaxFieldLength_initWithNSString_withInt_(@"LIMITED", 10000);
