...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/CheckIndex.java
//
...
- (OrgApacheLuceneIndexCheckIndex_Status *)checkIndexWithJavaUtilList:(id<JavaUtilList>)onlySegments {
  ...
  OrgApacheLuceneIndexCheckIndex_Status *result = new_OrgApacheLuceneIndexCheckIndex_Status_init();
  result->dir_ = dir_;
  @try {
  ...
  if (format == OrgApacheLuceneIndexSegmentInfos_FORMAT_LOCKLESS) sFormat = @"FORMAT_LOCKLESS [Lucene 2.1]";
    ...
    else if (format == OrgApacheLuceneIndexSegmentInfos_CURRENT_FORMAT) @throw new_JavaLangRuntimeException_initWithNSString_(@"BUG: You should update this tool!");
  ...
  result->segmentsFileName_ = segmentsFileName;
  result->numSegments_ = numSegments;
  result->segmentFormat_ = sFormat;
  result->userData_ = [sis getUserData];
  ...
  result->newSegments_ = (OrgApacheLuceneIndexSegmentInfos *) cast_chk([sis java_clone], [OrgApacheLuceneIndexSegmentInfos class]);
  ...
  for (jint i = 0; i < numSegments; i++) {
    ...
    OrgApacheLuceneIndexCheckIndex_Status_SegmentInfoStatus *segInfoStat = new_OrgApacheLuceneIndexCheckIndex_Status_SegmentInfoStatus_init();
    ...
    @try {
      ...
      segInfoStat->diagnostics_ = diagnostics;
      ...
      if (docStoreOffset != -1) {
        ...
        segInfoStat->docStoreSegment_ = [info getDocStoreSegment];
      ...
      if (delFileName == nil) {
        ...
        segInfoStat->deletionsFileName_ = delFileName;
      }
      ...
      if ([reader hasDeletions]) {
        if ([((OrgApacheLuceneUtilBitVector *) nil_chk(reader->deletedDocs_)) count] != [info getDelCount]) {
          @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I", @"delete count mismatch: info=", [info getDelCount], @" vs deletedDocs.count()=", [((OrgApacheLuceneUtilBitVector *) nil_chk(reader->deletedDocs_)) count]));
        }
        if ([((OrgApacheLuceneUtilBitVector *) nil_chk(reader->deletedDocs_)) count] > [reader maxDoc]) {
          @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I", @"too many deleted docs: maxDoc()=", [reader maxDoc], @" vs deletedDocs.count()=", [((OrgApacheLuceneUtilBitVector *) nil_chk(reader->deletedDocs_)) count]));
        }
        if (info->docCount_ - numDocs != [info getDelCount]) {
          @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I", @"delete count mismatch: info=", [info getDelCount], @" vs reader=", (info->docCount_ - numDocs)));
        }
      ...
      if ([reader maxDoc] != info->docCount_) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I", @"SegmentReader.maxDoc() ", [reader maxDoc], @" != SegmentInfos.docCount ", info->docCount_));
      if (infoStream_ != nil) {
      ...
      segInfoStat->fieldNormStatus_ = OrgApacheLuceneIndexCheckIndex_testFieldNormsWithJavaUtilCollection_withOrgApacheLuceneIndexSegmentReader_(self, fieldNames, reader);
      segInfoStat->termIndexStatus_ = OrgApacheLuceneIndexCheckIndex_testTermIndexWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_(self, info, reader);
      segInfoStat->storedFieldStatus_ = OrgApacheLuceneIndexCheckIndex_testStoredFieldsWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_withJavaTextNumberFormat_(self, info, reader, nf);
      segInfoStat->termVectorStatus_ = OrgApacheLuceneIndexCheckIndex_testTermVectorsWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_withJavaTextNumberFormat_(self, info, reader, nf);
      if (((OrgApacheLuceneIndexCheckIndex_Status_FieldNormStatus *) nil_chk(segInfoStat->fieldNormStatus_))->error_ != nil) {
        @throw new_JavaLangRuntimeException_initWithNSString_(@"Field Norm test failed");
      }
      else if (((OrgApacheLuceneIndexCheckIndex_Status_TermIndexStatus *) nil_chk(segInfoStat->termIndexStatus_))->error_ != nil) {
        @throw new_JavaLangRuntimeException_initWithNSString_(@"Term Index test failed");
      }
      else if (((OrgApacheLuceneIndexCheckIndex_Status_StoredFieldStatus *) nil_chk(segInfoStat->storedFieldStatus_))->error_ != nil) {
        @throw new_JavaLangRuntimeException_initWithNSString_(@"Stored Field test failed");
      }
      else if (((OrgApacheLuceneIndexCheckIndex_Status_TermVectorStatus *) nil_chk(segInfoStat->termVectorStatus_))->error_ != nil) {
        @throw new_JavaLangRuntimeException_initWithNSString_(@"Term Vector test failed");
      }
      OrgApacheLuceneIndexCheckIndex_msgWithNSString_(self, @"");
    }
    @catch (NSException *t) {
...
- (void)fixIndexWithOrgApacheLuceneIndexCheckIndex_Status:(OrgApacheLuceneIndexCheckIndex_Status *)result {
  if (((OrgApacheLuceneIndexCheckIndex_Status *) nil_chk(result))->partial_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"can only fix an index that was fully checked (this status checked a subset of segments)");
...
OrgApacheLuceneIndexCheckIndex_Status_FieldNormStatus *OrgApacheLuceneIndexCheckIndex_testFieldNormsWithJavaUtilCollection_withOrgApacheLuceneIndexSegmentReader_(OrgApacheLuceneIndexCheckIndex *self, id<JavaUtilCollection> fieldNames, OrgApacheLuceneIndexSegmentReader *reader) {
  OrgApacheLuceneIndexCheckIndex_Status_FieldNormStatus *status = new_OrgApacheLuceneIndexCheckIndex_Status_FieldNormStatus_init();
  @try {
    if (self->infoStream_ != nil) {
      [self->infoStream_ printWithNSString:@"    test: field norms........."];
    }
    IOSByteArray *b = [IOSByteArray newArrayWithLength:[((OrgApacheLuceneIndexSegmentReader *) nil_chk(reader)) maxDoc]];
...
OrgApacheLuceneIndexCheckIndex_Status_TermIndexStatus *OrgApacheLuceneIndexCheckIndex_testTermIndexWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_(OrgApacheLuceneIndexCheckIndex *self, OrgApacheLuceneIndexSegmentInfo *info, OrgApacheLuceneIndexSegmentReader *reader) {
  OrgApacheLuceneIndexCheckIndex_Status_TermIndexStatus *status = new_OrgApacheLuceneIndexCheckIndex_Status_TermIndexStatus_init();
  OrgApacheLuceneSearchIndexSearcher *is = new_OrgApacheLuceneSearchIndexSearcher_initWithOrgApacheLuceneIndexIndexReader_(reader);
  @try {
    if (self->infoStream_ != nil) {
    ...
    OrgApacheLuceneIndexCheckIndex_MySegmentTermDocs *myTermDocs = new_OrgApacheLuceneIndexCheckIndex_MySegmentTermDocs_initWithOrgApacheLuceneIndexSegmentReader_(reader);
    ...
    while ([((OrgApacheLuceneIndexTermEnum *) nil_chk(termEnum)) next]) {
      ...
      if (docFreq <= 0) {
        @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$", @"docfreq: ", docFreq, @" is out of bounds"));
      }
      ...
      while ([termPositions next]) {
        ...
        if (doc <= lastDoc) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I", @"term ", term, @": doc ", doc, @" <= lastDoc ", lastDoc));
        if (doc >= maxDoc) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I", @"term ", term, @": doc ", doc, @" >= maxDoc ", maxDoc));
        lastDoc = doc;
        if (freq <= 0) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I$", @"term ", term, @": doc ", doc, @": freq ", freq, @" is out of bounds"));
        jint lastPos = -1;
        status->totPos_ += freq;
        for (jint j = 0; j < freq; j++) {
          jint pos = [termPositions nextPosition];
          if (pos < -1) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I$", @"term ", term, @": doc ", doc, @": pos ", pos, @" is out of bounds"));
          if (pos < lastPos) @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I$I", @"term ", term, @": doc ", doc, @": pos ", pos, @" < lastPos ", lastPos));
          lastPos = pos;
        }
      }
      for (jint idx = 0; idx < 7; idx++) {
        ...
        if (![termPositions skipToWithInt:skipDocID]) {
          ...
          if (docID < skipDocID) {
            @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I", @"term ", term, @": skipTo(docID=", skipDocID, @") returned docID=", docID));
          }
          jint freq = [termPositions freq];
          if (freq <= 0) {
            @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$", @"termFreq ", freq, @" is out of bounds"));
          }
          jint lastPosition = -1;
          for (jint posUpto = 0; posUpto < freq; posUpto++) {
            jint pos = [termPositions nextPosition];
            if (pos < 0) {
              @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$", @"position ", pos, @" is out of bounds"));
            }
            if (pos < lastPosition) {
              @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I", @"position ", pos, @" is < lastPosition ", lastPosition));
            }
            lastPosition = pos;
          }
          ...
          if (nextDocID <= docID) {
            @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I$I", @"term ", term, @": skipTo(docID=", skipDocID, @"), then .next() returned docID=", nextDocID, @" vs prev docID=", docID));
          }
        }
      }
      jint delCount;
      ...
      if (freq0 + delCount != docFreq) {
        @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$@$I$I$I", @"term ", term, @" docFreq=", docFreq, @" != num docs seen ", freq0, @" + num docs deleted ", delCount));
      }
    }
    if (lastTerm != nil) {
      (void) [is searchWithOrgApacheLuceneSearchQuery:new_OrgApacheLuceneSearchTermQuery_initWithOrgApacheLuceneIndexTerm_(lastTerm) withInt:1];
    }
    @try {
      jlong uniqueTermCountAllFields = [reader getUniqueTermCount];
      if (status->termCount_ != uniqueTermCountAllFields) {
        @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$J$J", @"termCount mismatch ", uniqueTermCountAllFields, @" vs ", (status->termCount_)));
      }
    }
...
OrgApacheLuceneIndexCheckIndex_Status_StoredFieldStatus *OrgApacheLuceneIndexCheckIndex_testStoredFieldsWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_withJavaTextNumberFormat_(OrgApacheLuceneIndexCheckIndex *self, OrgApacheLuceneIndexSegmentInfo *info, OrgApacheLuceneIndexSegmentReader *reader, JavaTextNumberFormat *format) {
  OrgApacheLuceneIndexCheckIndex_Status_StoredFieldStatus *status = new_OrgApacheLuceneIndexCheckIndex_Status_StoredFieldStatus_init();
  @try {
    if (self->infoStream_ != nil) {
    ...
    if (status->docCount_ != [((OrgApacheLuceneIndexSegmentReader *) nil_chk(reader)) numDocs]) {
      @throw new_JavaLangRuntimeException_initWithNSString_(JreStrcat("$I$I$", @"docCount=", status->docCount_, @" but saw ", status->docCount_, @" undeleted docs"));
    }
...
OrgApacheLuceneIndexCheckIndex_Status_TermVectorStatus *OrgApacheLuceneIndexCheckIndex_testTermVectorsWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentReader_withJavaTextNumberFormat_(OrgApacheLuceneIndexCheckIndex *self, OrgApacheLuceneIndexSegmentInfo *info, OrgApacheLuceneIndexSegmentReader *reader, JavaTextNumberFormat *format) {
  OrgApacheLuceneIndexCheckIndex_Status_TermVectorStatus *status = new_OrgApacheLuceneIndexCheckIndex_Status_TermVectorStatus_init();
  @try {
    if (self->infoStream_ != nil) {
...
void OrgApacheLuceneIndexCheckIndex_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  id<JavaUtilList> onlySegments = new_JavaUtilArrayList_init();
  ...
  OrgApacheLuceneIndexCheckIndex *checker = new_OrgApacheLuceneIndexCheckIndex_initWithOrgApacheLuceneStoreDirectory_(dir);
...
void OrgApacheLuceneIndexCheckIndex_Status_init(OrgApacheLuceneIndexCheckIndex_Status *self) {
  NSObject_init(self);
  self->segmentsChecked_ = new_JavaUtilArrayList_init();
  self->segmentInfos_ = new_JavaUtilArrayList_init();
}
