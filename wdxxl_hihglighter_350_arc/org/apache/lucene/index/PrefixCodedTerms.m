...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/PrefixCodedTerms.java
//
...
- (id<JavaUtilIterator>)iterator {
  return new_OrgApacheLuceneIndexPrefixCodedTerms_PrefixCodedTermsIterator_initWithOrgApacheLuceneIndexPrefixCodedTerms_(self);
}
...
- (OrgApacheLuceneIndexTerm *)next {
  ...
  @try {
    ...
    if ((code & 1) != 0) {
      field_ = OrgApacheLuceneUtilStringHelper_internWithNSString_([input_ readString]);
    }
...
void OrgApacheLuceneIndexPrefixCodedTerms_PrefixCodedTermsIterator_initWithOrgApacheLuceneIndexPrefixCodedTerms_(OrgApacheLuceneIndexPrefixCodedTerms_PrefixCodedTermsIterator *self, OrgApacheLuceneIndexPrefixCodedTerms *outer$) {
  NSObject_init(self);
  self->field_ = @"";
  self->bytes_ = new_OrgApacheLuceneUtilBytesRef_init();
  self->term_ = new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(self->field_, @"");
  @try {
...
- (void)addWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  ...
  @try {
    ...
    ((OrgApacheLuceneIndexTerm *) nil_chk(lastTerm_))->text_ = term->text_;
...
void OrgApacheLuceneIndexPrefixCodedTerms_Builder_init(OrgApacheLuceneIndexPrefixCodedTerms_Builder *self) {
  NSObject_init(self);
  self->buffer_ = new_OrgApacheLuceneStoreRAMFile_init();
  self->output_ = new_OrgApacheLuceneStoreRAMOutputStream_initWithOrgApacheLuceneStoreRAMFile_(self->buffer_);
  self->lastTerm_ = new_OrgApacheLuceneIndexTerm_initWithNSString_(@"");
  self->lastBytes_ = new_OrgApacheLuceneUtilBytesRef_init();
  self->scratch_ = new_OrgApacheLuceneUtilBytesRef_init();
}
