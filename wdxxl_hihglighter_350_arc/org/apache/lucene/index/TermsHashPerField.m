...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermsHashPerField.java
//
...
- (void)shrinkHashWithInt:(jint)targetSize {
  ...
  if (newSize != ((IOSIntArray *) nil_chk(postingsHash_))->size_) {
    ...
    postingsHash_ = [IOSIntArray newArrayWithLength:newSize];
...
- (IOSIntArray *)sortPostings {
  ...
  [new_OrgApacheLuceneIndexTermsHashPerField_1_initWithOrgApacheLuceneIndexTermsHashPerField_withIntArray_(self, postingsHash) quickSortWithInt:0 withInt:numPostings_ - 1];
  return postingsHash;
}
...
- (void)startWithOrgApacheLuceneDocumentFieldable:(id<OrgApacheLuceneDocumentFieldable>)f {
  termAtt_ = ((id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute>) [((OrgApacheLuceneUtilAttributeSource *) nil_chk(((OrgApacheLuceneIndexFieldInvertState *) nil_chk(fieldState_))->attributeSource_)) addAttributeWithIOSClass:OrgApacheLuceneAnalysisTokenattributesCharTermAttribute_class_()]);
...
- (void)addWithInt:(jint)textStart {
  ...
  if (termID == -1) {
    ...
    *IOSIntArray_GetRef(nil_chk(((OrgApacheLuceneIndexParallelPostingsArray *) nil_chk(postingsArray_))->byteStarts_), termID) = IOSIntArray_Get(nil_chk(intUptos_), intUptoStart_);
    ...
    jint intStart = IOSIntArray_Get(nil_chk(((OrgApacheLuceneIndexParallelPostingsArray *) nil_chk(postingsArray_))->intStarts_), termID);
    intUptos_ = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexIntBlockPool *) nil_chk(intPool_))->buffers_), JreRShift32(intStart, OrgApacheLuceneIndexDocumentsWriter_INT_BLOCK_SHIFT));
  ...
  if (termID == -1) {
    ...
    if (textLen1 + ((OrgApacheLuceneIndexCharBlockPool *) nil_chk(charPool_))->charUpto_ > OrgApacheLuceneIndexDocumentsWriter_CHAR_BLOCK_SIZE) {
      if (textLen1 > OrgApacheLuceneIndexDocumentsWriter_CHAR_BLOCK_SIZE) {
        if (((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState_))->maxTermPrefix_ == nil) docState_->maxTermPrefix_ = [NSString java_stringWithCharacters:tokenText offset:0 length:30];
...
- (void)rehashPostingsWithInt:(jint)newSize {
  ...
  IOSIntArray *newHash = [IOSIntArray newArrayWithLength:newSize];
...
void OrgApacheLuceneIndexTermsHashPerField_initWithOrgApacheLuceneIndexDocInverterPerField_withOrgApacheLuceneIndexTermsHashPerThread_withOrgApacheLuceneIndexTermsHashPerThread_withOrgApacheLuceneIndexFieldInfo_(OrgApacheLuceneIndexTermsHashPerField *self, OrgApacheLuceneIndexDocInverterPerField *docInverterPerField, OrgApacheLuceneIndexTermsHashPerThread *perThread, OrgApacheLuceneIndexTermsHashPerThread *nextPerThread, OrgApacheLuceneIndexFieldInfo *fieldInfo) {
  ...
  self->intPool_ = ((OrgApacheLuceneIndexTermsHashPerThread *) nil_chk(perThread))->intPool_;
  self->charPool_ = perThread->charPool_;
  self->bytePool_ = perThread->bytePool_;
  self->docState_ = perThread->docState_;
  self->postingsHash_ = [IOSIntArray newArrayWithLength:self->postingsHashSize_];
  ...
  self->fieldState_ = ((OrgApacheLuceneIndexDocInverterPerField *) nil_chk(docInverterPerField))->fieldState_;
  self->consumer_ = [((OrgApacheLuceneIndexTermsHashConsumerPerThread *) nil_chk(perThread->consumer_)) addFieldWithOrgApacheLuceneIndexTermsHashPerField:self withOrgApacheLuceneIndexFieldInfo:fieldInfo];
  OrgApacheLuceneIndexTermsHashPerField_initPostingsArray(self);
  ...
  if (nextPerThread != nil) self->nextPerField_ = (OrgApacheLuceneIndexTermsHashPerField *) cast_chk([nextPerThread addFieldWithOrgApacheLuceneIndexDocInverterPerField:docInverterPerField withOrgApacheLuceneIndexFieldInfo:fieldInfo], [OrgApacheLuceneIndexTermsHashPerField class]);
  else self->nextPerField_ = nil;
}
...
void OrgApacheLuceneIndexTermsHashPerField_initPostingsArray(OrgApacheLuceneIndexTermsHashPerField *self) {
  self->postingsArray_ = [((OrgApacheLuceneIndexTermsHashConsumerPerField *) nil_chk(self->consumer_)) createPostingsArrayWithInt:2];
...
void OrgApacheLuceneIndexTermsHashPerField_growParallelPostingsArray(OrgApacheLuceneIndexTermsHashPerField *self) {
  ...
  self->postingsArray_ = [self->postingsArray_ grow];
...
- (void)setPivotWithInt:(jint)i {
  ...
  pivotBuf_ = IOSObjectArray_Get(nil_chk(((OrgApacheLuceneIndexCharBlockPool *) nil_chk(this$0_->charPool_))->buffers_), JreRShift32(textStart, OrgApacheLuceneIndexDocumentsWriter_CHAR_BLOCK_SHIFT));
...
void OrgApacheLuceneIndexTermsHashPerField_1_initWithOrgApacheLuceneIndexTermsHashPerField_withIntArray_(OrgApacheLuceneIndexTermsHashPerField_1 *self, OrgApacheLuceneIndexTermsHashPerField *outer$, IOSIntArray *capture$0) {
  self->this$0_ = outer$;
  self->val$postingsHash_ = capture$0;
