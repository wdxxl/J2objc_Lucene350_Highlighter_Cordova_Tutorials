...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/Term.java
//
...
- (OrgApacheLuceneIndexTerm *)createTermWithNSString:(NSString *)text {
  return new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_withBoolean_(field_, text, false);
}
...
- (jint)compareToWithId:(OrgApacheLuceneIndexTerm *)other {
  (void) cast_chk(other, [OrgApacheLuceneIndexTerm class]);
...
void OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(OrgApacheLuceneIndexTerm *self, NSString *fld, NSString *txt) {
  NSObject_init(self);
  self->field_ = OrgApacheLuceneUtilStringHelper_internWithNSString_(fld);
  self->text_ = txt;
}
...
void OrgApacheLuceneIndexTerm_initWithNSString_withNSString_withBoolean_(OrgApacheLuceneIndexTerm *self, NSString *fld, NSString *txt, jboolean intern) {
  NSObject_init(self);
  self->field_ = intern ? OrgApacheLuceneUtilStringHelper_internWithNSString_(fld) : fld;
  self->text_ = txt;
}
