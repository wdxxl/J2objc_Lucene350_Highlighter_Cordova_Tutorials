...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DocFieldProcessorPerField.java
//
...
void OrgApacheLuceneIndexDocFieldProcessorPerField_initWithOrgApacheLuceneIndexDocFieldProcessorPerThread_withOrgApacheLuceneIndexFieldInfo_(OrgApacheLuceneIndexDocFieldProcessorPerField *self, OrgApacheLuceneIndexDocFieldProcessorPerThread *perThread, OrgApacheLuceneIndexFieldInfo *fieldInfo) {
  NSObject_init(self);
  self->lastGen_ = -1;
  self->fields_ = [IOSObjectArray newArrayWithLength:1 type:OrgApacheLuceneDocumentFieldable_class_()];
  self->consumer_ = [((OrgApacheLuceneIndexDocFieldConsumerPerThread *) nil_chk(((OrgApacheLuceneIndexDocFieldProcessorPerThread *) nil_chk(perThread))->consumer_)) addFieldWithOrgApacheLuceneIndexFieldInfo:fieldInfo];
