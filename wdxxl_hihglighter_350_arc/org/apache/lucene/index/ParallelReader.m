...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/ParallelReader.java
//
...
- (NSString *)description {
  JavaLangStringBuilder *buffer = new_JavaLangStringBuilder_initWithNSString_(@"ParallelReader(");
  id<JavaUtilIterator> iter = [((id<JavaUtilList>) nil_chk(readers_)) iterator];
  if ([((id<JavaUtilIterator>) nil_chk(iter)) hasNext]) {
    (void) [buffer appendWithId:[iter next]];
  }
  while ([iter hasNext]) {
    (void) [((JavaLangStringBuilder *) nil_chk([buffer appendWithNSString:@", "])) appendWithId:[iter next]];
  }
...
- (void)addWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  if ([((OrgApacheLuceneIndexIndexReader *) nil_chk(reader)) maxDoc] != maxDoc_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$I", @"All readers must have same maxDoc: ", maxDoc_, @"!=", [reader maxDoc]));
  if ([reader numDocs] != numDocs_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$I", @"All readers must have same numDocs: ", numDocs_, @"!=", [reader numDocs]));
  ...
  (void) [((id<JavaUtilMap>) nil_chk(readerToFields_)) putWithId:reader withId:fields];
  for (NSString * __strong field in nil_chk(fields)) {
    if ([((id<JavaUtilSortedMap>) nil_chk(fieldToReader_)) getWithId:field] == nil) (void) [((id<JavaUtilSortedMap>) nil_chk(fieldToReader_)) putWithId:field withId:reader];
  }
...
- (OrgApacheLuceneIndexIndexReader *)doReopenWithBoolean:(jboolean)doClone {
  ...
  id<JavaUtilList> newReaders = new_JavaUtilArrayList_init();
  ...
  if (reopened) {
    id<JavaUtilList> newDecrefOnClose = new_JavaUtilArrayList_init();
    OrgApacheLuceneIndexParallelReader *pr = new_OrgApacheLuceneIndexParallelReader_init();
    ...
    pr->decrefOnClose_ = newDecrefOnClose;
...
- (OrgApacheLuceneDocumentDocument *)documentWithInt:(jint)n
  ...
  [self ensureOpen];
  OrgApacheLuceneDocumentDocument *result = new_OrgApacheLuceneDocumentDocument_init();
...
- (IOSObjectArray *)getTermFreqVectorsWithInt:(jint)n {
  ...
  return [results toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[results size] type:OrgApacheLuceneIndexTermFreqVector_class_()]];
}
...
- (OrgApacheLuceneIndexTermEnum *)terms {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermEnum_initWithOrgApacheLuceneIndexParallelReader_(self);
}

- (OrgApacheLuceneIndexTermEnum *)termsWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermEnum_initWithOrgApacheLuceneIndexParallelReader_withOrgApacheLuceneIndexTerm_(self, term);
}
...
- (id<OrgApacheLuceneIndexTermDocs>)termDocsWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermDocs_initWithOrgApacheLuceneIndexParallelReader_withOrgApacheLuceneIndexTerm_(self, term);
}

- (id<OrgApacheLuceneIndexTermDocs>)termDocs {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermDocs_initWithOrgApacheLuceneIndexParallelReader_(self);
}

- (id<OrgApacheLuceneIndexTermPositions>)termPositionsWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermPositions_initWithOrgApacheLuceneIndexParallelReader_withOrgApacheLuceneIndexTerm_(self, term);
}

- (id<OrgApacheLuceneIndexTermPositions>)termPositions {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexParallelReader_ParallelTermPositions_initWithOrgApacheLuceneIndexParallelReader_(self);
}
...
- (jlong)getVersion {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"ParallelReader does not support this method.");
}

- (IOSObjectArray *)getSubReaders {
  return [((id<JavaUtilList>) nil_chk(readers_)) toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[readers_ size] type:OrgApacheLuceneIndexIndexReader_class_()]];
}
...
void OrgApacheLuceneIndexParallelReader_initWithBoolean_(OrgApacheLuceneIndexParallelReader *self, jboolean closeSubReaders) {
  ...
  self->decrefOnClose_ = new_JavaUtilArrayList_init();
  self->incRefReaders_ = false;
  self->fieldToReader_ = new_JavaUtilTreeMap_init();
  self->readerToFields_ = new_JavaUtilHashMap_init();
  self->storedFieldReaders_ = new_JavaUtilArrayList_init();
...
- (jboolean)next {
  ...
  if (fieldIterator_ == nil) {
    fieldIterator_ = [((id<JavaUtilSet>) nil_chk([((id<JavaUtilSortedMap>) nil_chk([((id<JavaUtilSortedMap>) nil_chk(this$0_->fieldToReader_)) tailMapWithId:field_])) keySet])) iterator];
    (void) [((id<JavaUtilIterator>) nil_chk(fieldIterator_)) next];
  }
  while ([((id<JavaUtilIterator>) nil_chk(fieldIterator_)) hasNext]) {
    field_ = [((id<JavaUtilIterator>) nil_chk(fieldIterator_)) next];
    termEnum_ = [((OrgApacheLuceneIndexIndexReader *) nil_chk([((id<JavaUtilSortedMap>) nil_chk(this$0_->fieldToReader_)) getWithId:field_])) termsWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_(field_)];
...
void OrgApacheLuceneIndexParallelReader_ParallelTermEnum_initWithOrgApacheLuceneIndexParallelReader_(OrgApacheLuceneIndexParallelReader_ParallelTermEnum *self, OrgApacheLuceneIndexParallelReader *outer$) {
  ...
  @try {
    self->field_ = [((id<JavaUtilSortedMap>) nil_chk(outer$->fieldToReader_)) firstKey];
  }
  @catch (JavaUtilNoSuchElementException *e) {
    return;
  }
  if (self->field_ != nil) self->termEnum_ = [((OrgApacheLuceneIndexIndexReader *) nil_chk([((id<JavaUtilSortedMap>) nil_chk(outer$->fieldToReader_)) getWithId:self->field_])) terms];
}
...
void OrgApacheLuceneIndexParallelReader_ParallelTermEnum_initWithOrgApacheLuceneIndexParallelReader_withOrgApacheLuceneIndexTerm_(OrgApacheLuceneIndexParallelReader_ParallelTermEnum *self, OrgApacheLuceneIndexParallelReader *outer$, OrgApacheLuceneIndexTerm *term) {
  ...
  if (reader != nil) self->termEnum_ = [reader termsWithOrgApacheLuceneIndexTerm:term];
}
...
- (void)seekWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  ...
  termDocs_ = reader != nil ? [reader termDocsWithOrgApacheLuceneIndexTerm:term] : nil;
}
...
void OrgApacheLuceneIndexParallelReader_ParallelTermDocs_initWithOrgApacheLuceneIndexParallelReader_withOrgApacheLuceneIndexTerm_(OrgApacheLuceneIndexParallelReader_ParallelTermDocs *self, OrgApacheLuceneIndexParallelReader *outer$, OrgApacheLuceneIndexTerm *term) {
  self->this$0_ = outer$;
  NSObject_init(self);
  if (term == nil) self->termDocs_ = [((id<JavaUtilList>) nil_chk(outer$->readers_)) isEmpty] ? nil : [((OrgApacheLuceneIndexIndexReader *) nil_chk([((id<JavaUtilList>) nil_chk(outer$->readers_)) getWithInt:0])) termDocsWithOrgApacheLuceneIndexTerm:nil];
...
- (void)seekWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  ...
  termDocs_ = reader != nil ? [reader termPositionsWithOrgApacheLuceneIndexTerm:term] : nil;
}
