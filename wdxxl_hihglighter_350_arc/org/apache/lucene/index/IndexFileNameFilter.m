...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/IndexFileNameFilter.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexIndexFileNameFilter class]) {
    OrgApacheLuceneIndexIndexFileNameFilter_singleton = new_OrgApacheLuceneIndexIndexFileNameFilter_init();
...
void OrgApacheLuceneIndexIndexFileNameFilter_init(OrgApacheLuceneIndexIndexFileNameFilter *self) {
  NSObject_init(self);
  self->extensions_ = new_JavaUtilHashSet_init();
  {
  ...
  self->extensionsInCFS_ = new_JavaUtilHashSet_init();
  {
