...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FieldSortedTermVectorMapper.java
//
...
withOrgApacheLuceneIndexTermVectorOffsetInfoArray:(IOSObjectArray *)offsets
  ...
  OrgApacheLuceneIndexTermVectorEntry *entry_ = new_OrgApacheLuceneIndexTermVectorEntry_initWithNSString_withNSString_withInt_withOrgApacheLuceneIndexTermVectorOffsetInfoArray_withIntArray_(currentField_, term, frequency, offsets, positions);
...
- (void)setExpectationsWithNSString:(NSString *)field
  ...
  currentSet_ = new_JavaUtilTreeSet_initWithJavaUtilComparator_(comparator_);
  currentField_ = field;
  (void) [((id<JavaUtilMap>) nil_chk(fieldToTerms_)) putWithId:field withId:currentSet_];
}
...
void OrgApacheLuceneIndexFieldSortedTermVectorMapper_initWithBoolean_withBoolean_withJavaUtilComparator_(OrgApacheLuceneIndexFieldSortedTermVectorMapper *self, jboolean ignoringPositions, jboolean ignoringOffsets, id<JavaUtilComparator> comparator) {
  ...
  self->fieldToTerms_ = new_JavaUtilHashMap_init();
