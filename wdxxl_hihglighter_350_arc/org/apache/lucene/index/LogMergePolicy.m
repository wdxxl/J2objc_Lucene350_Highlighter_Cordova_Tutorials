...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/LogMergePolicy.java
//
...
- (void)setMergeFactorWithInt:(jint)mergeFactor {
  if (mergeFactor < 2) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"mergeFactor cannot be less than 2");
...
- (OrgApacheLuceneIndexMergePolicy_MergeSpecification *)findForcedDeletesMergesWithOrgApacheLuceneIndexSegmentInfos:(OrgApacheLuceneIndexSegmentInfos *)segmentInfos {
  ...
  for (jint i = 0; i < numSegments; i++) {
    ...
    if (delCount > 0) {
      ...
      if (firstSegmentWithDeletions == -1) firstSegmentWithDeletions = i;
        ...
        [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([segments subListWithInt:firstSegmentWithDeletions withInt:i])];
  ...
  if (firstSegmentWithDeletions != -1) {
    ...
    [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([segments subListWithInt:firstSegmentWithDeletions withInt:numSegments])];
  }
  return spec;
}
...
- (OrgApacheLuceneIndexMergePolicy_MergeSpecification *)findMergesWithOrgApacheLuceneIndexSegmentInfos:(OrgApacheLuceneIndexSegmentInfos *)infos {
  ...
  id<JavaUtilList> levels = new_JavaUtilArrayList_init();
  ...
  for (jint i = 0; i < numSegments; i++) {
    ...
    OrgApacheLuceneIndexLogMergePolicy_SegmentInfoAndLevel *infoLevel = new_OrgApacheLuceneIndexLogMergePolicy_SegmentInfoAndLevel_initWithOrgApacheLuceneIndexSegmentInfo_withFloat_withInt_(info, (jfloat) JavaLangMath_logWithDouble_(size) / norm, i);
  ...
  while (start < numMergeableSegments) {
    ...
    while (end <= 1 + upto) {
      ...
      if (anyMerging) {
        ...
        if (spec == nil) spec = new_OrgApacheLuceneIndexMergePolicy_MergeSpecification_init();
        ...
        [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_(mergeInfos)];
      }
...
- (NSString *)description {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"minMergeSize="])) appendWithLong:minMergeSize_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"mergeFactor="])) appendWithInt:mergeFactor_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergeSize="])) appendWithLong:maxMergeSize_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergeSizeForForcedMerge="])) appendWithLong:maxMergeSizeForForcedMerge_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"calibrateSizeByDeletes="])) appendWithBoolean:calibrateSizeByDeletes_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergeDocs="])) appendWithInt:maxMergeDocs_])) appendWithNSString:@", "];
  ...
  while (start >= 0) {
    ...
    if ([self sizeWithOrgApacheLuceneIndexSegmentInfo:info] > self->maxMergeSizeForForcedMerge_ || [self sizeDocsWithOrgApacheLuceneIndexSegmentInfo:info] > self->maxMergeDocs_) {
      ...
      if (last - start - 1 > 1 || (start != last - 1 && ![self isMergedWithOrgApacheLuceneIndexSegmentInfo:[infos infoWithInt:start + 1]])) {
        [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([((id<JavaUtilList>) nil_chk(segments)) subListWithInt:start + 1 withInt:last])];
      }
      last = start;
    }
    else if (last - start == self->mergeFactor_) {
      [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([((id<JavaUtilList>) nil_chk(segments)) subListWithInt:start withInt:last])];
      last = start;
    }
    --start;
  }
...
OrgApacheLuceneIndexMergePolicy_MergeSpecification *OrgApacheLuceneIndexLogMergePolicy_findForcedMergesMaxNumSegmentsWithOrgApacheLuceneIndexSegmentInfos_withInt_withInt_(OrgApacheLuceneIndexLogMergePolicy *self, OrgApacheLuceneIndexSegmentInfos *infos, jint maxNumSegments, jint last) {
  ...
  while (last - maxNumSegments + 1 >= self->mergeFactor_) {
    [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([((id<JavaUtilList>) nil_chk(segments)) subListWithInt:last - self->mergeFactor_ withInt:last])];
  ...
  if (0 == [((id<JavaUtilList>) nil_chk(spec->merges_)) size]) {
    if (maxNumSegments == 1) {
      if (last > 1 || ![self isMergedWithOrgApacheLuceneIndexSegmentInfo:[infos infoWithInt:0]]) {
        [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([((id<JavaUtilList>) nil_chk(segments)) subListWithInt:0 withInt:last])];
      }
    }
      ...
      [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([((id<JavaUtilList>) nil_chk(segments)) subListWithInt:bestStart withInt:bestStart + finalMergeSize])];
    }
  }
...
- (jint)compareToWithId:(OrgApacheLuceneIndexLogMergePolicy_SegmentInfoAndLevel *)other {
  (void) cast_chk(other, [OrgApacheLuceneIndexLogMergePolicy_SegmentInfoAndLevel class]);
