...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/StoredFieldsWriterPerThread.java
//
...
void OrgApacheLuceneIndexStoredFieldsWriterPerThread_initWithOrgApacheLuceneIndexDocumentsWriter_DocState_withOrgApacheLuceneIndexStoredFieldsWriter_(OrgApacheLuceneIndexStoredFieldsWriterPerThread *self, OrgApacheLuceneIndexDocumentsWriter_DocState *docState, OrgApacheLuceneIndexStoredFieldsWriter *storedFieldsWriter) {
  NSObject_init(self);
  self->storedFieldsWriter_ = storedFieldsWriter;
  self->docState_ = docState;
  self->localFieldsWriter_ = new_OrgApacheLuceneIndexFieldsWriter_initWithOrgApacheLuceneStoreIndexOutput_withOrgApacheLuceneStoreIndexOutput_withOrgApacheLuceneIndexFieldInfos_(nil, nil, ((OrgApacheLuceneIndexStoredFieldsWriter *) nil_chk(storedFieldsWriter))->fieldInfos_);
}
