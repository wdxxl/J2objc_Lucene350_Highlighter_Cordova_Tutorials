...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/SegmentTermPositionVector.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexSegmentTermPositionVector class]) {
    OrgApacheLuceneIndexSegmentTermPositionVector_EMPTY_TERM_POS = [IOSIntArray newArrayWithLength:0];
