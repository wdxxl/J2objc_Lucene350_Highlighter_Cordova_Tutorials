...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FieldsReader.java
//
...
- (id)java_clone {
  ...
  return new_OrgApacheLuceneIndexFieldsReader_initWithOrgApacheLuceneIndexFieldInfos_withInt_withInt_withInt_withInt_withInt_withOrgApacheLuceneStoreIndexInput_withOrgApacheLuceneStoreIndexInput_(fieldInfos_, numTotalDocs_, size_, format_, formatSize_, docStoreOffset_, cloneableFieldsStream_, cloneableIndexStream_);
}
...
void OrgApacheLuceneIndexFieldsReader_initWithOrgApacheLuceneIndexFieldInfos_withInt_withInt_withInt_withInt_withInt_withOrgApacheLuceneStoreIndexInput_withOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneIndexFieldInfos *fieldInfos, jint numTotalDocs, jint size, jint format, jint formatSize, jint docStoreOffset, OrgApacheLuceneStoreIndexInput *cloneableFieldsStream, OrgApacheLuceneStoreIndexInput *cloneableIndexStream) {
  NSObject_init(self);
  self->fieldsStreamTL_ = new_OrgApacheLuceneUtilCloseableThreadLocal_init();
  ...
  self->cloneableFieldsStream_ = cloneableFieldsStream;
  self->cloneableIndexStream_ = cloneableIndexStream;
  self->fieldsStream_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(cloneableFieldsStream)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
  self->indexStream_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(cloneableIndexStream)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
}
...
void OrgApacheLuceneIndexFieldsReader_initWithOrgApacheLuceneStoreDirectory_withNSString_withOrgApacheLuceneIndexFieldInfos_withInt_withInt_withInt_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneStoreDirectory *d, NSString *segment, OrgApacheLuceneIndexFieldInfos *fn, jint readBufferSize, jint docStoreOffset, jint size) {
  ...
  @try {
    self->fieldInfos_ = fn;
    self->cloneableFieldsStream_ = [((OrgApacheLuceneStoreDirectory *) nil_chk(d)) openInputWithNSString:OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_(segment, OrgApacheLuceneIndexIndexFileNames_FIELDS_EXTENSION) withInt:readBufferSize];
    ...
    self->cloneableIndexStream_ = [d openInputWithNSString:indexStreamFN withInt:readBufferSize];
    ...
    if (self->format_ > OrgApacheLuceneIndexFieldsWriter_FORMAT_CURRENT) @throw new_OrgApacheLuceneIndexIndexFormatTooNewException_initWithOrgApacheLuceneStoreDataInput_withInt_withInt_withInt_(self->cloneableIndexStream_, self->format_, 0, OrgApacheLuceneIndexFieldsWriter_FORMAT_CURRENT);
    ...
    self->fieldsStream_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(self->cloneableFieldsStream_)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
    ...
    self->indexStream_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([self->cloneableIndexStream_ java_clone], [OrgApacheLuceneStoreIndexInput class]);
...
void OrgApacheLuceneIndexFieldsReader_ensureOpen(OrgApacheLuceneIndexFieldsReader *self) {
  if (self->closed_) {
    @throw new_OrgApacheLuceneStoreAlreadyClosedException_initWithNSString_(@"this FieldsReader is closed");
  }
}
...
void OrgApacheLuceneIndexFieldsReader_close(OrgApacheLuceneIndexFieldsReader *self) {
  if (!self->closed_) {
    if (self->isOriginal_) {
      OrgApacheLuceneUtilIOUtils_closeWithJavaIoCloseableArray_([IOSObjectArray newArrayWithObjects:(id[]){ self->fieldsStream_, self->indexStream_, self->fieldsStreamTL_, self->cloneableFieldsStream_, self->cloneableIndexStream_ } count:5 type:JavaIoCloseable_class_()]);
    }
    else {
      OrgApacheLuceneUtilIOUtils_closeWithJavaIoCloseableArray_([IOSObjectArray newArrayWithObjects:(id[]){ self->fieldsStream_, self->indexStream_, self->fieldsStreamTL_ } count:3 type:JavaIoCloseable_class_()]);
    }
    self->closed_ = true;
  }
}
...
void OrgApacheLuceneIndexFieldsReader_skipFieldWithBoolean_withBoolean_withInt_(OrgApacheLuceneIndexFieldsReader *self, jboolean binary, jboolean compressed, jint numeric) {
  ...
  switch (numeric) {
    ...
    break;
    default:
    @throw new_OrgApacheLuceneIndexFieldReaderException_initWithNSString_(JreStrcat("$$", @"Invalid numeric type: ", JavaLangInteger_toHexStringWithInt_(numeric)));
  }
...
OrgApacheLuceneDocumentNumericField *OrgApacheLuceneIndexFieldsReader_loadNumericFieldWithOrgApacheLuceneIndexFieldInfo_withInt_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneIndexFieldInfo *fi, jint numeric) {
  ...
  switch (numeric) {
    ...
    case OrgApacheLuceneIndexFieldsWriter_FIELD_IS_NUMERIC_LONG:
    return [new_OrgApacheLuceneDocumentNumericField_initWithNSString_withOrgApacheLuceneDocumentField_Store_withBoolean_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, JreLoadEnum(OrgApacheLuceneDocumentField_Store, YES), fi->isIndexed_) setLongValueWithLong:[((OrgApacheLuceneStoreIndexInput *) nil_chk(self->fieldsStream_)) readLong]];
    case OrgApacheLuceneIndexFieldsWriter_FIELD_IS_NUMERIC_FLOAT:
    return [new_OrgApacheLuceneDocumentNumericField_initWithNSString_withOrgApacheLuceneDocumentField_Store_withBoolean_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, JreLoadEnum(OrgApacheLuceneDocumentField_Store, YES), fi->isIndexed_) setFloatValueWithFloat:JavaLangFloat_intBitsToFloatWithInt_([((OrgApacheLuceneStoreIndexInput *) nil_chk(self->fieldsStream_)) readInt])];
    case OrgApacheLuceneIndexFieldsWriter_FIELD_IS_NUMERIC_DOUBLE:
    return [new_OrgApacheLuceneDocumentNumericField_initWithNSString_withOrgApacheLuceneDocumentField_Store_withBoolean_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, JreLoadEnum(OrgApacheLuceneDocumentField_Store, YES), fi->isIndexed_) setDoubleValueWithDouble:JavaLangDouble_longBitsToDoubleWithLong_([((OrgApacheLuceneStoreIndexInput *) nil_chk(self->fieldsStream_)) readLong])];
    default:
    @throw new_OrgApacheLuceneIndexFieldReaderException_initWithNSString_(JreStrcat("$$", @"Invalid numeric type: ", JavaLangInteger_toHexStringWithInt_(numeric)));
  }
}
...
void OrgApacheLuceneIndexFieldsReader_addFieldLazyWithOrgApacheLuceneDocumentDocument_withOrgApacheLuceneIndexFieldInfo_withBoolean_withBoolean_withBoolean_withBoolean_withInt_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneDocumentDocument *doc, OrgApacheLuceneIndexFieldInfo *fi, jboolean binary, jboolean compressed, jboolean tokenize, jboolean cacheResult, jint numeric) {
  ...
  if (binary) {
    ...
    f = new_OrgApacheLuceneIndexFieldsReader_LazyField_initWithOrgApacheLuceneIndexFieldsReader_withNSString_withOrgApacheLuceneDocumentField_Store_withInt_withLong_withBoolean_withBoolean_withBoolean_(self, ((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, JreLoadEnum(OrgApacheLuceneDocumentField_Store, YES), toRead, pointer, binary, compressed, cacheResult);
    ...
    if (compressed) {
      jint toRead = [((OrgApacheLuceneStoreIndexInput *) nil_chk(self->fieldsStream_)) readVInt];
      jlong pointer = [self->fieldsStream_ getFilePointer];
      f = new_OrgApacheLuceneIndexFieldsReader_LazyField_initWithOrgApacheLuceneIndexFieldsReader_withNSString_withOrgApacheLuceneDocumentField_Store_withInt_withLong_withBoolean_withBoolean_withBoolean_(self, fi->name_, store, toRead, pointer, binary, compressed, cacheResult);
      [self->fieldsStream_ seekWithLong:pointer + toRead];
    }
    else {
      ...
      f = new_OrgApacheLuceneIndexFieldsReader_LazyField_initWithOrgApacheLuceneIndexFieldsReader_withNSString_withOrgApacheLuceneDocumentField_Store_withOrgApacheLuceneDocumentField_Index_withOrgApacheLuceneDocumentField_TermVector_withInt_withLong_withBoolean_withBoolean_withBoolean_(self, fi->name_, store, index, termVector, length, pointer, binary, compressed, cacheResult);
    }
  }
...
void OrgApacheLuceneIndexFieldsReader_addFieldWithOrgApacheLuceneDocumentDocument_withOrgApacheLuceneIndexFieldInfo_withBoolean_withBoolean_withBoolean_withInt_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneDocumentDocument *doc, OrgApacheLuceneIndexFieldInfo *fi, jboolean binary, jboolean compressed, jboolean tokenize, jint numeric) {
  ...
  if (binary) {
    jint toRead = [((OrgApacheLuceneStoreIndexInput *) nil_chk(self->fieldsStream_)) readVInt];
    IOSByteArray *b = [IOSByteArray newArrayWithLength:toRead];
    [self->fieldsStream_ readBytesWithByteArray:b withInt:0 withInt:b->size_];
    if (compressed) {
      f = new_OrgApacheLuceneDocumentField_initWithNSString_withByteArray_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, OrgApacheLuceneIndexFieldsReader_uncompressWithByteArray_(self, b));
    }
    else {
      f = new_OrgApacheLuceneDocumentField_initWithNSString_withByteArray_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, b);
    }
  }
  else if (numeric != 0) {
    f = OrgApacheLuceneIndexFieldsReader_loadNumericFieldWithOrgApacheLuceneIndexFieldInfo_withInt_(self, fi, numeric);
    ...
    if (compressed) {
      ...
      IOSByteArray *b = [IOSByteArray newArrayWithLength:toRead];
      [self->fieldsStream_ readBytesWithByteArray:b withInt:0 withInt:b->size_];
      f = new_OrgApacheLuceneDocumentField_initWithNSString_withBoolean_withNSString_withOrgApacheLuceneDocumentField_Store_withOrgApacheLuceneDocumentField_Index_withOrgApacheLuceneDocumentField_TermVector_(fi->name_, false, [NSString java_stringWithBytes:OrgApacheLuceneIndexFieldsReader_uncompressWithByteArray_(self, b) charsetName:@"UTF-8"], store, index, termVector);
    }
    else {
...
jint OrgApacheLuceneIndexFieldsReader_addFieldSizeWithOrgApacheLuceneDocumentDocument_withOrgApacheLuceneIndexFieldInfo_withBoolean_withBoolean_withInt_(OrgApacheLuceneIndexFieldsReader *self, OrgApacheLuceneDocumentDocument *doc, OrgApacheLuceneIndexFieldInfo *fi, jboolean binary, jboolean compressed, jint numeric) {
  ...
  IOSByteArray *sizebytes = [IOSByteArray newArrayWithLength:4];
  ...
  *IOSByteArray_GetRef(sizebytes, 3) = (jbyte) bytesize;
  [((OrgApacheLuceneDocumentDocument *) nil_chk(doc)) addWithOrgApacheLuceneDocumentFieldable:new_OrgApacheLuceneDocumentField_initWithNSString_withByteArray_(((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->name_, sizebytes)];
  return size;
}
  ...
  if (isBinary_) return nil;
    ...
    if (fieldsData_ == nil) {
      ...
      @try {
        ...
        if (isCompressed_) {
          IOSByteArray *b = [IOSByteArray newArrayWithLength:toRead_];
          ...
          if (this$0_->format_ >= OrgApacheLuceneIndexFieldsWriter_FORMAT_VERSION_UTF8_LENGTH_IN_BYTES) {
            IOSByteArray *bytes = [IOSByteArray newArrayWithLength:toRead_];
            ...
            IOSCharArray *chars = [IOSCharArray newArrayWithLength:toRead_];
...
- (IOSByteArray *)getBinaryValueWithByteArray:(IOSByteArray *)result {
  ...
  if (isBinary_) {
    if (fieldsData_ == nil) {
      IOSByteArray *b;
      IOSByteArray *value;
      if (result == nil || result->size_ < toRead_) b = [IOSByteArray newArrayWithLength:toRead_];
      else b = result;
      OrgApacheLuceneStoreIndexInput *localFieldsStream = OrgApacheLuceneIndexFieldsReader_LazyField_getFieldStream(self);
      @try {
        [((OrgApacheLuceneStoreIndexInput *) nil_chk(localFieldsStream)) seekWithLong:pointer_];
