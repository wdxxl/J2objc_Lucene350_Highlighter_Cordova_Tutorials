...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/IndexWriterConfig.java
//
...
__attribute__((unused)) static OrgApacheLuceneIndexIndexWriterConfig_OpenMode *new_OrgApacheLuceneIndexIndexWriterConfig_OpenMode_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setOpenModeWithOrgApacheLuceneIndexIndexWriterConfig_OpenMode:(OrgApacheLuceneIndexIndexWriterConfig_OpenMode *)openMode {
  (void) JreVolatileStrongAssign(&self->openMode_, openMode);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setIndexDeletionPolicyWithOrgApacheLuceneIndexIndexDeletionPolicy:(id<OrgApacheLuceneIndexIndexDeletionPolicy>)delPolicy {
  (void) JreVolatileStrongAssign(&self->delPolicy_, delPolicy == nil ? new_OrgApacheLuceneIndexKeepOnlyLastCommitDeletionPolicy_init() : delPolicy);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setIndexCommitWithOrgApacheLuceneIndexIndexCommit:(OrgApacheLuceneIndexIndexCommit *)commit {
  (void) JreVolatileStrongAssign(&self->commit_, commit);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setSimilarityWithOrgApacheLuceneSearchSimilarity:(OrgApacheLuceneSearchSimilarity *)similarity {
  (void) JreVolatileStrongAssign(&self->similarity_, similarity == nil ? OrgApacheLuceneSearchSimilarity_getDefault() : similarity);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setMergeSchedulerWithOrgApacheLuceneIndexMergeScheduler:(OrgApacheLuceneIndexMergeScheduler *)mergeScheduler {
  (void) JreVolatileStrongAssign(&self->mergeScheduler_, mergeScheduler == nil ? new_OrgApacheLuceneIndexConcurrentMergeScheduler_init() : mergeScheduler);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setMaxBufferedDeleteTermsWithInt:(jint)maxBufferedDeleteTerms {
  if (maxBufferedDeleteTerms != OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH && maxBufferedDeleteTerms < 1) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"maxBufferedDeleteTerms must at least be 1 when enabled");
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setRAMBufferSizeMBWithDouble:(jdouble)ramBufferSizeMB {
  if (ramBufferSizeMB > 2048.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$D$", @"ramBufferSize ", ramBufferSizeMB, @" is too large; should be comfortably less than 2048"));
  }
  if (ramBufferSizeMB != OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH && ramBufferSizeMB <= 0.0) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"ramBufferSize should be > 0.0 MB when enabled");
  if (ramBufferSizeMB == OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH && JreLoadVolatileInt(&maxBufferedDocs_) == OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"at least one of ramBufferSize and maxBufferedDocs must be enabled");
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setMaxBufferedDocsWithInt:(jint)maxBufferedDocs {
  if (maxBufferedDocs != OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH && maxBufferedDocs < 2) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"maxBufferedDocs must at least be 2 when enabled");
  if (maxBufferedDocs == OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH && JreLoadVolatileDouble(&ramBufferSizeMB_) == OrgApacheLuceneIndexIndexWriterConfig_DISABLE_AUTO_FLUSH) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"at least one of ramBufferSize and maxBufferedDocs must be enabled");
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setMergedSegmentWarmerWithOrgApacheLuceneIndexIndexWriter_IndexReaderWarmer:(OrgApacheLuceneIndexIndexWriter_IndexReaderWarmer *)mergeSegmentWarmer {
  (void) JreVolatileStrongAssign(&self->mergedSegmentWarmer_, mergeSegmentWarmer);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setMergePolicyWithOrgApacheLuceneIndexMergePolicy:(OrgApacheLuceneIndexMergePolicy *)mergePolicy {
  (void) JreVolatileStrongAssign(&self->mergePolicy_, mergePolicy == nil ? new_OrgApacheLuceneIndexLogByteSizeMergePolicy_init() : mergePolicy);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setIndexingChainWithOrgApacheLuceneIndexDocumentsWriter_IndexingChain:(OrgApacheLuceneIndexDocumentsWriter_IndexingChain *)indexingChain {
  (void) JreVolatileStrongAssign(&self->indexingChain_, indexingChain == nil ? JreLoadStatic(OrgApacheLuceneIndexDocumentsWriter, defaultIndexingChain) : indexingChain);
  return self;
}
...
- (OrgApacheLuceneIndexIndexWriterConfig *)setReaderTermsIndexDivisorWithInt:(jint)divisor {
  if (divisor <= 0 && divisor != -1) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"divisor must be >= 1, or -1 (got ", divisor, ')'));
  }
...
- (NSString *)description {
  ...
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"matchVersion="])) appendWithId:matchVersion_])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"analyzer="])) appendWithNSString:analyzer_ == nil ? @"null" : [[analyzer_ java_getClass] getName]])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"delPolicy="])) appendWithNSString:[[((id<OrgApacheLuceneIndexIndexDeletionPolicy>) nil_chk(JreLoadVolatileId(&delPolicy_))) java_getClass] getName]])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"commit="])) appendWithId:JreLoadVolatileId(&commit_) == nil ? @"null" : (id) JreLoadVolatileId(&commit_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"openMode="])) appendWithId:JreLoadVolatileId(&openMode_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"similarity="])) appendWithNSString:[[((OrgApacheLuceneSearchSimilarity *) nil_chk(JreLoadVolatileId(&similarity_))) java_getClass] getName]])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"termIndexInterval="])) appendWithInt:JreLoadVolatileInt(&termIndexInterval_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"mergeScheduler="])) appendWithNSString:[[((OrgApacheLuceneIndexMergeScheduler *) nil_chk(JreLoadVolatileId(&mergeScheduler_))) java_getClass] getName]])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"default WRITE_LOCK_TIMEOUT="])) appendWithLong:OrgApacheLuceneIndexIndexWriterConfig_WRITE_LOCK_TIMEOUT])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"writeLockTimeout="])) appendWithLong:JreLoadVolatileLong(&writeLockTimeout_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxBufferedDeleteTerms="])) appendWithInt:JreLoadVolatileInt(&maxBufferedDeleteTerms_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"ramBufferSizeMB="])) appendWithDouble:JreLoadVolatileDouble(&ramBufferSizeMB_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxBufferedDocs="])) appendWithInt:JreLoadVolatileInt(&maxBufferedDocs_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"mergedSegmentWarmer="])) appendWithId:JreLoadVolatileId(&mergedSegmentWarmer_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"mergePolicy="])) appendWithId:JreLoadVolatileId(&mergePolicy_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxThreadStates="])) appendWithInt:JreLoadVolatileInt(&maxThreadStates_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"readerPooling="])) appendWithBoolean:JreLoadVolatileBoolean(&readerPooling_)])) appendWithNSString:@"\n"];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"readerTermsIndexDivisor="])) appendWithInt:JreLoadVolatileInt(&readerTermsIndexDivisor_)])) appendWithNSString:@"\n"];
...
void OrgApacheLuceneIndexIndexWriterConfig_initWithOrgApacheLuceneUtilVersion_withOrgApacheLuceneAnalysisAnalyzer_(OrgApacheLuceneIndexIndexWriterConfig *self, OrgApacheLuceneUtilVersion *matchVersion, OrgApacheLuceneAnalysisAnalyzer *analyzer) {
  NSObject_init(self);
  self->matchVersion_ = matchVersion;
  self->analyzer_ = analyzer;
  (void) JreVolatileStrongAssign(&self->delPolicy_, new_OrgApacheLuceneIndexKeepOnlyLastCommitDeletionPolicy_init());
  (void) JreVolatileStrongAssign(&self->commit_, nil);
  (void) JreVolatileStrongAssign(&self->openMode_, JreLoadEnum(OrgApacheLuceneIndexIndexWriterConfig_OpenMode, CREATE_OR_APPEND));
  (void) JreVolatileStrongAssign(&self->similarity_, OrgApacheLuceneSearchSimilarity_getDefault());
  JreAssignVolatileInt(&self->termIndexInterval_, OrgApacheLuceneIndexIndexWriterConfig_DEFAULT_TERM_INDEX_INTERVAL);
  (void) JreVolatileStrongAssign(&self->mergeScheduler_, new_OrgApacheLuceneIndexConcurrentMergeScheduler_init());
  ...
  (void) JreVolatileStrongAssign(&self->indexingChain_, JreLoadStatic(OrgApacheLuceneIndexDocumentsWriter, defaultIndexingChain));
  (void) JreVolatileStrongAssign(&self->mergedSegmentWarmer_, nil);
  if ([((OrgApacheLuceneUtilVersion *) nil_chk(matchVersion)) onOrAfterWithOrgApacheLuceneUtilVersion:JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_32)]) {
    (void) JreVolatileStrongAssign(&self->mergePolicy_, new_OrgApacheLuceneIndexTieredMergePolicy_init());
  }
  else {
    (void) JreVolatileStrongAssign(&self->mergePolicy_, new_OrgApacheLuceneIndexLogByteSizeMergePolicy_init());
  }
...
OrgApacheLuceneIndexIndexWriterConfig_OpenMode *new_OrgApacheLuceneIndexIndexWriterConfig_OpenMode_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneIndexIndexWriterConfig_OpenMode, initWithNSString_withInt_, __name, __ordinal)
}
