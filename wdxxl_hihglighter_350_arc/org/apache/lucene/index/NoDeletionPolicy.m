...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/NoDeletionPolicy.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexNoDeletionPolicy class]) {
    OrgApacheLuceneIndexNoDeletionPolicy_INSTANCE = new_OrgApacheLuceneIndexNoDeletionPolicy_init();
