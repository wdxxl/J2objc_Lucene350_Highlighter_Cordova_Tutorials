...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FormatPostingsPositionsWriter.java
//
...
- (void)close {
  OrgApacheLuceneUtilIOUtils_closeWithJavaIoCloseableArray_([IOSObjectArray newArrayWithObjects:(id[]){ out_ } count:1 type:JavaIoCloseable_class_()]);
}
...
void OrgApacheLuceneIndexFormatPostingsPositionsWriter_initWithOrgApacheLuceneIndexSegmentWriteState_withOrgApacheLuceneIndexFormatPostingsDocsWriter_(OrgApacheLuceneIndexFormatPostingsPositionsWriter *self, OrgApacheLuceneIndexSegmentWriteState *state, OrgApacheLuceneIndexFormatPostingsDocsWriter *parent) {
  ...
  if ([((OrgApacheLuceneIndexFieldInfos *) nil_chk(((OrgApacheLuceneIndexFormatPostingsFieldsWriter *) nil_chk(((OrgApacheLuceneIndexFormatPostingsTermsWriter *) nil_chk(parent->parent_))->parent_))->fieldInfos_)) hasProx]) {
    self->out_ = [((OrgApacheLuceneStoreDirectory *) nil_chk(parent->parent_->parent_->dir_)) createOutputWithNSString:OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_(parent->parent_->parent_->segment_, OrgApacheLuceneIndexIndexFileNames_PROX_EXTENSION)];
