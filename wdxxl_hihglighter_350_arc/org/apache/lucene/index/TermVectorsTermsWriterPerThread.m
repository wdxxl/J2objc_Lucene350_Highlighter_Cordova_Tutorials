...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermVectorsTermsWriterPerThread.java
//
...
- (OrgApacheLuceneIndexTermsHashConsumerPerField *)addFieldWithOrgApacheLuceneIndexTermsHashPerField:(OrgApacheLuceneIndexTermsHashPerField *)termsHashPerField
  ...
  return new_OrgApacheLuceneIndexTermVectorsTermsWriterPerField_initWithOrgApacheLuceneIndexTermsHashPerField_withOrgApacheLuceneIndexTermVectorsTermsWriterPerThread_withOrgApacheLuceneIndexFieldInfo_(termsHashPerField, self, fieldInfo);
}
...
void OrgApacheLuceneIndexTermVectorsTermsWriterPerThread_initWithOrgApacheLuceneIndexTermsHashPerThread_withOrgApacheLuceneIndexTermVectorsTermsWriter_(OrgApacheLuceneIndexTermVectorsTermsWriterPerThread *self, OrgApacheLuceneIndexTermsHashPerThread *termsHashPerThread, OrgApacheLuceneIndexTermVectorsTermsWriter *termsWriter) {
  ...
  self->vectorSliceReader_ = new_OrgApacheLuceneIndexByteSliceReader_init();
  ...
  self->termsWriter_ = termsWriter;
  self->termsHashPerThread_ = termsHashPerThread;
  self->docState_ = ((OrgApacheLuceneIndexTermsHashPerThread *) nil_chk(termsHashPerThread))->docState_;
}
