...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FormatPostingsTermsWriter.java
//
...
void OrgApacheLuceneIndexFormatPostingsTermsWriter_initWithOrgApacheLuceneIndexSegmentWriteState_withOrgApacheLuceneIndexFormatPostingsFieldsWriter_(OrgApacheLuceneIndexFormatPostingsTermsWriter *self, OrgApacheLuceneIndexSegmentWriteState *state, OrgApacheLuceneIndexFormatPostingsFieldsWriter *parent) {
  ...
  self->parent_ = parent;
  self->termsOut_ = ((OrgApacheLuceneIndexFormatPostingsFieldsWriter *) nil_chk(parent))->termsOut_;
  self->docsWriter_ = new_OrgApacheLuceneIndexFormatPostingsDocsWriter_initWithOrgApacheLuceneIndexSegmentWriteState_withOrgApacheLuceneIndexFormatPostingsTermsWriter_(state, self);
}
