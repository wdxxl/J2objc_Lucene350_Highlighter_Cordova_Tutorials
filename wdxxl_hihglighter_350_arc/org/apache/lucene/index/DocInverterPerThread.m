...
- (OrgApacheLuceneIndexDocFieldConsumerPerField *)addFieldWithOrgApacheLuceneIndexFieldInfo:(OrgApacheLuceneIndexFieldInfo *)fi {
  return new_OrgApacheLuceneIndexDocInverterPerField_initWithOrgApacheLuceneIndexDocInverterPerThread_withOrgApacheLuceneIndexFieldInfo_(self, fi);
}
...
void OrgApacheLuceneIndexDocInverterPerThread_initWithOrgApacheLuceneIndexDocFieldProcessorPerThread_withOrgApacheLuceneIndexDocInverter_(OrgApacheLuceneIndexDocInverterPerThread *self, OrgApacheLuceneIndexDocFieldProcessorPerThread *docFieldProcessorPerThread, OrgApacheLuceneIndexDocInverter *docInverter) {
  ...
  self->singleToken_ = new_OrgApacheLuceneIndexDocInverterPerThread_SingleTokenAttributeSource_init();
  self->fieldState_ = new_OrgApacheLuceneIndexFieldInvertState_init();
  self->stringReader_ = new_OrgApacheLuceneIndexReusableStringReader_init();
  self->docInverter_ = docInverter;
  self->docState_ = ((OrgApacheLuceneIndexDocFieldProcessorPerThread *) nil_chk(docFieldProcessorPerThread))->docState_;
  self->consumer_ = [((OrgApacheLuceneIndexInvertedDocConsumer *) nil_chk(((OrgApacheLuceneIndexDocInverter *) nil_chk(docInverter))->consumer_)) addThreadWithOrgApacheLuceneIndexDocInverterPerThread:self];
  self->endConsumer_ = [((OrgApacheLuceneIndexInvertedDocEndConsumer *) nil_chk(docInverter->endConsumer_)) addThreadWithOrgApacheLuceneIndexDocInverterPerThread:self];
}
...
- (void)reinitWithNSString:(NSString *)stringValue
  ...
  (void) [((id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute>) nil_chk([((id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute>) nil_chk(termAttribute_)) setEmpty])) appendWithNSString:stringValue];
