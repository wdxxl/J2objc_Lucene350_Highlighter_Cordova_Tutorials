...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/SimpleFSDirectory.java
//
...
- (OrgApacheLuceneStoreIndexInput *)openInputWithNSString:(NSString *)name
  ...
  [self ensureOpen];
  JavaIoFile *path = new_JavaIoFile_initWithJavaIoFile_withNSString_(directory_, name);
  return new_OrgApacheLuceneStoreSimpleFSDirectory_SimpleFSIndexInput_initWithNSString_withJavaIoFile_withInt_withInt_(JreStrcat("$$$", @"SimpleFSIndexInput(path=\"", [path getPath], @"\")"), path, bufferSize, [self getReadChunkSize]);
}
...
void OrgApacheLuceneStoreSimpleFSDirectory_SimpleFSIndexInput_initWithNSString_withJavaIoFile_withInt_withInt_(OrgApacheLuceneStoreSimpleFSDirectory_SimpleFSIndexInput *self, NSString *resourceDesc, JavaIoFile *path, jint bufferSize, jint chunkSize) {
  ...
  self->file_ = new_OrgApacheLuceneStoreSimpleFSDirectory_SimpleFSIndexInput_Descriptor_initWithJavaIoFile_withNSString_(path, @"r");
