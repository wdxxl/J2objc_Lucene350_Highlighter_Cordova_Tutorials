...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/FSLockFactory.java
//
...
- (void)setLockDirWithJavaIoFile:(JavaIoFile *)lockDir {
  if (self->lockDir_ != nil) @throw new_JavaLangIllegalStateException_initWithNSString_(@"You can set the lock directory for this factory only once.");
