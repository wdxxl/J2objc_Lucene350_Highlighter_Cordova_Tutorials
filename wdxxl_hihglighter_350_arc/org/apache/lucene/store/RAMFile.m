...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/RAMFile.java
//
...
- (IOSByteArray *)newBufferWithInt:(jint)size {
  return [IOSByteArray newArrayWithLength:size];
}
...
void OrgApacheLuceneStoreRAMFile_init(OrgApacheLuceneStoreRAMFile *self) {
  NSObject_init(self);
  self->buffers_ = new_JavaUtilArrayList_init();
