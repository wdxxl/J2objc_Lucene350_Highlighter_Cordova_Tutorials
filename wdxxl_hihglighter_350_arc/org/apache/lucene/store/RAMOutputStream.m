...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/RAMOutputStream.java
//
...
void OrgApacheLuceneStoreRAMOutputStream_init(OrgApacheLuceneStoreRAMOutputStream *self) {
  OrgApacheLuceneStoreRAMOutputStream_initWithOrgApacheLuceneStoreRAMFile_(self, new_OrgApacheLuceneStoreRAMFile_init());
}
...
void OrgApacheLuceneStoreRAMOutputStream_switchCurrentBuffer(OrgApacheLuceneStoreRAMOutputStream *self) {
  if (self->currentBufferIndex_ == [((OrgApacheLuceneStoreRAMFile *) nil_chk(self->file_)) numBuffers]) {
    self->currentBuffer_ = [((OrgApacheLuceneStoreRAMFile *) nil_chk(self->file_)) addBufferWithInt:OrgApacheLuceneStoreRAMOutputStream_BUFFER_SIZE];
  }
  else {
    self->currentBuffer_ = [((OrgApacheLuceneStoreRAMFile *) nil_chk(self->file_)) getBufferWithInt:self->currentBufferIndex_];
  }
