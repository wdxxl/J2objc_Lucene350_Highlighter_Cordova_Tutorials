...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/queryParser/QueryParser.java
//
...
__attribute__((unused)) static OrgApacheLuceneQueryParserQueryParser_Operator *new_OrgApacheLuceneQueryParserQueryParser_Operator_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
- (OrgApacheLuceneSearchQuery *)parseWithNSString:(NSString *)query {
  [self ReInitWithOrgApacheLuceneQueryParserCharStream:new_OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(new_JavaIoStringReader_initWithNSString_(query))];
  @try {
  ...
  @catch (OrgApacheLuceneQueryParserParseException *tme) {
    OrgApacheLuceneQueryParserParseException *e = new_OrgApacheLuceneQueryParserParseException_initWithNSString_(JreStrcat("$$$$", @"Cannot parse '", query, @"': ", [tme getMessage]));
    (void) [e initCauseWithNSException:tme];
    @throw e;
  }
  ...
  @catch (OrgApacheLuceneSearchBooleanQuery_TooManyClauses *tmc) {
    OrgApacheLuceneQueryParserParseException *e = new_OrgApacheLuceneQueryParserParseException_initWithNSString_(JreStrcat("$$$", @"Cannot parse '", query, @"': too many boolean clauses"));
    (void) [e initCauseWithNSException:tmc];
    @throw e;
  }
}
...
- (void)setMultiTermRewriteMethodWithOrgApacheLuceneSearchMultiTermQuery_RewriteMethod:(OrgApacheLuceneSearchMultiTermQuery_RewriteMethod *)method {
  multiTermRewriteMethod_ = method;
}
...
- (void)setDateResolutionWithOrgApacheLuceneDocumentDateTools_Resolution:(OrgApacheLuceneDocumentDateTools_Resolution *)dateResolution {
  self->dateResolution_ = dateResolution;
}
...
withOrgApacheLuceneDocumentDateTools_Resolution:(OrgApacheLuceneDocumentDateTools_Resolution *)dateResolution {
  if (fieldName == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Field cannot be null.");
  }
  if (fieldToDateResolution_ == nil) {
    fieldToDateResolution_ = new_JavaUtilHashMap_init();
  }
  (void) [fieldToDateResolution_ putWithId:fieldName withId:dateResolution];
}
...
- (void)addClauseWithJavaUtilList:(id<JavaUtilList>)clauses
  ...
  else @throw new_JavaLangRuntimeException_initWithNSString_(@"Clause cannot be both required and prohibited");
}
...
- (OrgApacheLuceneSearchQuery *)getFieldQueryWithNSString:(NSString *)field
  ...
  @try {
    source = [((OrgApacheLuceneAnalysisAnalyzer *) nil_chk(analyzer_)) reusableTokenStreamWithNSString:field withJavaIoReader:new_JavaIoStringReader_initWithNSString_(queryText)];
    [((OrgApacheLuceneAnalysisTokenStream *) nil_chk(source)) reset];
  }
  @catch (JavaIoIOException *e) {
    source = [((OrgApacheLuceneAnalysisAnalyzer *) nil_chk(analyzer_)) tokenStreamWithNSString:field withJavaIoReader:new_JavaIoStringReader_initWithNSString_(queryText)];
  }
  OrgApacheLuceneAnalysisCachingTokenFilter *buffer = new_OrgApacheLuceneAnalysisCachingTokenFilter_initWithOrgApacheLuceneAnalysisTokenStream_(source);
  ...
  if (numTokens == 0) return nil;
    ...
    return [self newTermQueryWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, term)];
  }
  else {
    if (severalTokensAtSamePosition || (!quoted && !autoGeneratePhraseQueries_)) {
      if (positionCount == 1 || (!quoted && !autoGeneratePhraseQueries_)) {
        ...
        for (jint i = 0; i < numTokens; i++) {
          ...
          OrgApacheLuceneSearchQuery *currentQuery = [self newTermQueryWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, term)];
        ...
        id<JavaUtilList> multiTerms = new_JavaUtilArrayList_init();
        jint position = -1;
        for (jint i = 0; i < numTokens; i++) {
          NSString *term = nil;
          ...
          if (positionIncrement > 0 && [multiTerms size] > 0) {
            if (enablePositionIncrements_) {
              [mpq addWithOrgApacheLuceneIndexTermArray:[multiTerms toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneIndexTerm_class_()]] withInt:position];
            }
            else {
              [mpq addWithOrgApacheLuceneIndexTermArray:[multiTerms toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneIndexTerm_class_()]]];
            }
            [multiTerms clear];
          }
          position += positionIncrement;
          [multiTerms addWithId:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, term)];
        }
        if (enablePositionIncrements_) {
          [mpq addWithOrgApacheLuceneIndexTermArray:[multiTerms toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneIndexTerm_class_()]] withInt:position];
        }
      ...
      for (jint i = 0; i < numTokens; i++) {
        ...
        if (enablePositionIncrements_) {
          position += positionIncrement;
          [pq addWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, term) withInt:position];
        }
        else {
          [pq addWithOrgApacheLuceneIndexTerm:new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, term)];
        }
      }
      return pq;
    }
...
- (OrgApacheLuceneSearchBooleanQuery *)newBooleanQueryWithBoolean:(jboolean)disableCoord {
  return new_OrgApacheLuceneSearchBooleanQuery_initWithBoolean_(disableCoord);
}
...
- (OrgApacheLuceneSearchBooleanClause *)newBooleanClauseWithOrgApacheLuceneSearchQuery:(OrgApacheLuceneSearchQuery *)q
  ...
  return new_OrgApacheLuceneSearchBooleanClause_initWithOrgApacheLuceneSearchQuery_withOrgApacheLuceneSearchBooleanClause_Occur_(q, occur);
}

- (OrgApacheLuceneSearchQuery *)newTermQueryWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  return new_OrgApacheLuceneSearchTermQuery_initWithOrgApacheLuceneIndexTerm_(term);
}

- (OrgApacheLuceneSearchPhraseQuery *)newPhraseQuery {
  return new_OrgApacheLuceneSearchPhraseQuery_init();
}

- (OrgApacheLuceneSearchMultiPhraseQuery *)newMultiPhraseQuery {
  return new_OrgApacheLuceneSearchMultiPhraseQuery_init();
}

- (OrgApacheLuceneSearchQuery *)newPrefixQueryWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)prefix {
  OrgApacheLuceneSearchPrefixQuery *query = new_OrgApacheLuceneSearchPrefixQuery_initWithOrgApacheLuceneIndexTerm_(prefix);
...
- (OrgApacheLuceneSearchQuery *)newFuzzyQueryWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term
  ...
  return new_OrgApacheLuceneSearchFuzzyQuery_initWithOrgApacheLuceneIndexTerm_withFloat_withInt_(term, minimumSimilarity, prefixLength);
}
...
- (OrgApacheLuceneSearchQuery *)newRangeQueryWithNSString:(NSString *)field
                                             ...
                                             withNSString:(NSString *)part2
                                              withBoolean:(jboolean)inclusive {
  OrgApacheLuceneSearchTermRangeQuery *query = new_OrgApacheLuceneSearchTermRangeQuery_initWithNSString_withNSString_withNSString_withBoolean_withBoolean_withJavaTextCollator_(field, part1, part2, inclusive, inclusive, rangeCollator_);
  [query setRewriteMethodWithOrgApacheLuceneSearchMultiTermQuery_RewriteMethod:multiTermRewriteMethod_];
  return query;
}

- (OrgApacheLuceneSearchQuery *)newMatchAllDocsQuery {
  return new_OrgApacheLuceneSearchMatchAllDocsQuery_init();
}

- (OrgApacheLuceneSearchQuery *)newWildcardQueryWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)t {
  OrgApacheLuceneSearchWildcardQuery *query = new_OrgApacheLuceneSearchWildcardQuery_initWithOrgApacheLuceneIndexTerm_(t);
  [query setRewriteMethodWithOrgApacheLuceneSearchMultiTermQuery_RewriteMethod:multiTermRewriteMethod_];
  return query;
}
...
- (OrgApacheLuceneSearchQuery *)getWildcardQueryWithNSString:(NSString *)field
  ...
  if (!allowLeadingWildcard_ && ([((NSString *) nil_chk(termStr)) java_hasPrefix:@"*"] || [termStr java_hasPrefix:@"?"])) @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(@"'*' or '?' not allowed as first character in WildcardQuery");
  if (lowercaseExpandedTerms_) {
    termStr = [((NSString *) nil_chk(termStr)) lowercaseString];
  }
  OrgApacheLuceneIndexTerm *t = new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, termStr);
...
- (OrgApacheLuceneSearchQuery *)getPrefixQueryWithNSString:(NSString *)field
                                              withNSString:(NSString *)termStr {
  if (!allowLeadingWildcard_ && [((NSString *) nil_chk(termStr)) java_hasPrefix:@"*"]) @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(@"'*' not allowed as first character in PrefixQuery");
  if (lowercaseExpandedTerms_) {
    termStr = [((NSString *) nil_chk(termStr)) lowercaseString];
  }
  OrgApacheLuceneIndexTerm *t = new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_(field, termStr);
...
- (void)ReInitWithOrgApacheLuceneQueryParserCharStream:(id<OrgApacheLuceneQueryParserCharStream>)stream {
  ...
  token_ = new_OrgApacheLuceneQueryParserToken_init();
  jj_ntk_ = -1;
  jj_gen_ = 0;
  for (jint i = 0; i < 23; i++) *IOSIntArray_GetRef(nil_chk(jj_la1_), i) = -1;
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(jj_2_rtns_))->size_; i++) (void) IOSObjectArray_SetAndConsume(jj_2_rtns_, i, new_OrgApacheLuceneQueryParserQueryParser_JJCalls_init());
}
...
- (OrgApacheLuceneQueryParserToken *)getNextToken {
  if (((OrgApacheLuceneQueryParserToken *) nil_chk(token_))->next_ != nil) token_ = token_->next_;
  else token_ = token_->next_ = [((OrgApacheLuceneQueryParserQueryParserTokenManager *) nil_chk(token_source_)) getNextToken];
  jj_ntk_ = -1;
  jj_gen_++;
  return token_;
}
...
- (OrgApacheLuceneQueryParserToken *)getTokenWithInt:(jint)index {
  ...
  for (jint i = 0; i < index; i++) {
    ...
    else t = t->next_ = [((OrgApacheLuceneQueryParserQueryParserTokenManager *) nil_chk(token_source_)) getNextToken];
  }
  return t;
}
...
- (OrgApacheLuceneQueryParserParseException *)generateParseException {
  ...
  IOSBooleanArray *la1tokens = [IOSBooleanArray newArrayWithLength:34];
  if (jj_kind_ >= 0) {
  ...
  return new_OrgApacheLuceneQueryParserParseException_initWithOrgApacheLuceneQueryParserToken_withIntArray2_withNSStringArray_(token_, exptokseq, JreLoadStatic(OrgApacheLuceneQueryParserQueryParserConstants, tokenImage));
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneQueryParserQueryParser class]) {
    OrgApacheLuceneQueryParserQueryParser_AND_OPERATOR = JreLoadEnum(OrgApacheLuceneQueryParserQueryParser_Operator, AND);
    OrgApacheLuceneQueryParserQueryParser_OR_OPERATOR = JreLoadEnum(OrgApacheLuceneQueryParserQueryParser_Operator, OR);
    OrgApacheLuceneQueryParserQueryParser_getFieldQueryMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneQueryParserQueryParser_class_(), @"getFieldQuery", [IOSObjectArray newArrayWithObjects:(id[]){ NSString_class_(), NSString_class_() } count:2 type:IOSClass_class_()]);
    OrgApacheLuceneQueryParserQueryParser_getFieldQueryWithQuotedMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneQueryParserQueryParser_class_(), @"getFieldQuery", [IOSObjectArray newArrayWithObjects:(id[]){ NSString_class_(), NSString_class_(), [IOSClass booleanClass] } count:3 type:IOSClass_class_()]);
    {
      OrgApacheLuceneQueryParserQueryParser_jj_la1_init_0();
      OrgApacheLuceneQueryParserQueryParser_jj_la1_init_1();
    }
...
void OrgApacheLuceneQueryParserQueryParser_initWithOrgApacheLuceneUtilVersion_withNSString_withOrgApacheLuceneAnalysisAnalyzer_(OrgApacheLuceneQueryParserQueryParser *self, OrgApacheLuceneUtilVersion *matchVersion, NSString *f, OrgApacheLuceneAnalysisAnalyzer *a) {
  OrgApacheLuceneQueryParserQueryParser_initWithOrgApacheLuceneQueryParserCharStream_(self, new_OrgApacheLuceneQueryParserFastCharStream_initWithJavaIoReader_(new_JavaIoStringReader_initWithNSString_(@"")));
  self->analyzer_ = a;
  self->field_ = f;
...
void OrgApacheLuceneQueryParserQueryParser_setAutoGeneratePhraseQueriesWithBoolean_(OrgApacheLuceneQueryParserQueryParser *self, jboolean value) {
  if (value == false && !self->hasNewAPI_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"You must implement the new API: getFieldQuery(String,String,boolean) to use setAutoGeneratePhraseQueries(false)");
...
NSString *OrgApacheLuceneQueryParserQueryParser_discardEscapeCharWithNSString_(OrgApacheLuceneQueryParserQueryParser *self, NSString *input) {
  IOSCharArray *output = [IOSCharArray newArrayWithLength:[((NSString *) nil_chk(input)) java_length]];
  jint length = 0;
  ...
  if (codePointMultiplier > 0) {
    @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(@"Truncated unicode escape sequence.");
  }
  if (lastCharWasEscapeChar) {
    @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(@"Term can not end with escape character.");
  }
...
jint OrgApacheLuceneQueryParserQueryParser_hexToIntWithChar_(jchar c) {
  ...
  if ('0' <= c && c <= '9') {
    ...
    @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(JreStrcat("$C", @"None-hex character in unicode escape sequence: ", c));
  }
}
...
void OrgApacheLuceneQueryParserQueryParser_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  OrgApacheLuceneQueryParserQueryParser *qp = new_OrgApacheLuceneQueryParserQueryParser_initWithOrgApacheLuceneUtilVersion_withNSString_withOrgApacheLuceneAnalysisAnalyzer_(JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_CURRENT), @"field", new_OrgApacheLuceneAnalysisSimpleAnalyzer_init());
...
jint OrgApacheLuceneQueryParserQueryParser_Conjunction(OrgApacheLuceneQueryParserQueryParser *self) {
  ...
  switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
    ...
    switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      case OrgApacheLuceneQueryParserQueryParserConstants_AND:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_AND);
      ret = OrgApacheLuceneQueryParserQueryParser_CONJ_AND;
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_OR:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_OR);
      ret = OrgApacheLuceneQueryParserQueryParser_CONJ_OR;
      break;
      default:
      *IOSIntArray_GetRef(nil_chk(self->jj_la1_), 0) = self->jj_gen_;
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, -1);
      @throw new_OrgApacheLuceneQueryParserParseException_init();
    }
    break;
    default:
...
jint OrgApacheLuceneQueryParserQueryParser_Modifiers(OrgApacheLuceneQueryParserQueryParser *self) {
  ...
  switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
    ...
    switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      case OrgApacheLuceneQueryParserQueryParserConstants_PLUS:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_PLUS);
      ret = OrgApacheLuceneQueryParserQueryParser_MOD_REQ;
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_MINUS:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_MINUS);
      ret = OrgApacheLuceneQueryParserQueryParser_MOD_NOT;
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_NOT:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_NOT);
      ret = OrgApacheLuceneQueryParserQueryParser_MOD_NOT;
      break;
      default:
...
OrgApacheLuceneSearchQuery *OrgApacheLuceneQueryParserQueryParser_TopLevelQueryWithNSString_(OrgApacheLuceneQueryParserQueryParser *self, NSString *field) {
  ...
  (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, 0);
  {
    return q;
  }
}
...
OrgApacheLuceneSearchQuery *OrgApacheLuceneQueryParserQueryParser_ClauseWithNSString_(OrgApacheLuceneQueryParserQueryParser *self, NSString *field) {
  ...
  if (OrgApacheLuceneQueryParserQueryParser_jj_2_1WithInt_(self, 2)) {
    switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      ...
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_COLON);
      ...
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_STAR:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_STAR);
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_COLON);
      field = @"*";
      break;
      default:
  ...
  switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
    ...
    break;
    case OrgApacheLuceneQueryParserQueryParserConstants_LPAREN:
    (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_LPAREN);
    q = OrgApacheLuceneQueryParserQueryParser_QueryWithNSString_(self, field);
    (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RPAREN);
    switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      case OrgApacheLuceneQueryParserQueryParserConstants_CARAT:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_CARAT);
    ...
    switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      ...
      if (wildcard) {
        ...
        if (fms < 0.0f || fms > 1.0f) {
          {
            @throw new_OrgApacheLuceneQueryParserParseException_initWithNSString_(@"Minimum similarity for a FuzzyQuery has to be between 0.0f and 1.0f !");
          }
        }
      ...
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_START:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_START);
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      ...
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
        ...
        (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_TO);
        break;
        default:
      ...
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_END);
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
        case OrgApacheLuceneQueryParserQueryParserConstants_CARAT:
        (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_CARAT);
        boost = OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_NUMBER);
      ...
      if (((OrgApacheLuceneQueryParserToken *) nil_chk(goop1))->kind_ == OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_QUOTED) {
        goop1->image_ = [((NSString *) nil_chk(goop1->image_)) java_substring:1 endIndex:[goop1->image_ java_length] - 1];
      }
      if (((OrgApacheLuceneQueryParserToken *) nil_chk(goop2))->kind_ == OrgApacheLuceneQueryParserQueryParserConstants_RANGEIN_QUOTED) {
        goop2->image_ = [((NSString *) nil_chk(goop2->image_)) java_substring:1 endIndex:[goop2->image_ java_length] - 1];
      }
      ...
      break;
      case OrgApacheLuceneQueryParserQueryParserConstants_RANGEEX_START:
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEEX_START);
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
      ...
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
        ...
        (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEEX_TO);
        break;
        default:
      ...
      (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_RANGEEX_END);
      switch ((self->jj_ntk_ == -1) ? OrgApacheLuceneQueryParserQueryParser_jj_ntk(self) : self->jj_ntk_) {
        case OrgApacheLuceneQueryParserQueryParserConstants_CARAT:
        (void) OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_CARAT);
        boost = OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(self, OrgApacheLuceneQueryParserQueryParserConstants_NUMBER);
...
void OrgApacheLuceneQueryParserQueryParser_jj_la1_init_0() {
  OrgApacheLuceneQueryParserQueryParser_initialize();
  OrgApacheLuceneQueryParserQueryParser_jj_la1_0 = [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x300, (jint) 0x300, (jint) 0x1c00, (jint) 0x1c00, (jint) 0x3ed3f00, (jint) 0x90000, (jint) 0x20000, (jint) 0x3ed2000, (jint) 0x2690000, (jint) 0x100000, (jint) 0x100000, (jint) 0x20000, (jint) 0x30000000, (jint) 0x4000000, (jint) 0x30000000, (jint) 0x20000, (jint) 0x0, (jint) 0x40000000, (jint) 0x0, (jint) 0x20000, (jint) 0x100000, (jint) 0x20000, (jint) 0x3ed0000 } count:23];
}

void OrgApacheLuceneQueryParserQueryParser_jj_la1_init_1() {
  OrgApacheLuceneQueryParserQueryParser_initialize();
  OrgApacheLuceneQueryParserQueryParser_jj_la1_1 = [IOSIntArray newArrayWithInts:(jint[]){ (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x3, (jint) 0x0, (jint) 0x3, (jint) 0x0, (jint) 0x0, (jint) 0x0, (jint) 0x0 } count:23];
}
...
void OrgApacheLuceneQueryParserQueryParser_initWithOrgApacheLuceneQueryParserCharStream_(OrgApacheLuceneQueryParserQueryParser *self, id<OrgApacheLuceneQueryParserCharStream> stream) {
  NSObject_init(self);
  self->operator__ = OrgApacheLuceneQueryParserQueryParser_OR_OPERATOR;
  self->lowercaseExpandedTerms_ = true;
  self->multiTermRewriteMethod_ = JreLoadStatic(OrgApacheLuceneSearchMultiTermQuery, CONSTANT_SCORE_AUTO_REWRITE_DEFAULT);
  ...
  self->dateResolution_ = nil;
  self->fieldToDateResolution_ = nil;
  self->rangeCollator_ = nil;
  ...
  self->jj_la1_ = [IOSIntArray newArrayWithLength:23];
  self->jj_2_rtns_ = [IOSObjectArray newArrayWithLength:1 type:OrgApacheLuceneQueryParserQueryParser_JJCalls_class_()];
  self->jj_rescan_ = false;
  self->jj_gc_ = 0;
  self->jj_ls_ = new_OrgApacheLuceneQueryParserQueryParser_LookaheadSuccess_init();
  self->jj_expentries_ = new_JavaUtilArrayList_init();
  self->jj_kind_ = -1;
  self->jj_lasttokens_ = [IOSIntArray newArrayWithLength:100];
  self->token_source_ = new_OrgApacheLuceneQueryParserQueryParserTokenManager_initWithOrgApacheLuceneQueryParserCharStream_(stream);
  self->token_ = new_OrgApacheLuceneQueryParserToken_init();
  self->jj_ntk_ = -1;
  self->jj_gen_ = 0;
  for (jint i = 0; i < 23; i++) *IOSIntArray_GetRef(self->jj_la1_, i) = -1;
  for (jint i = 0; i < self->jj_2_rtns_->size_; i++) (void) IOSObjectArray_SetAndConsume(self->jj_2_rtns_, i, new_OrgApacheLuceneQueryParserQueryParser_JJCalls_init());
}
...
OrgApacheLuceneQueryParserToken *OrgApacheLuceneQueryParserQueryParser_jj_consume_tokenWithInt_(OrgApacheLuceneQueryParserQueryParser *self, jint kind) {
  ...
  if ((oldToken = self->token_)->next_ != nil) self->token_ = ((OrgApacheLuceneQueryParserToken *) nil_chk(self->token_))->next_;
  else self->token_ = ((OrgApacheLuceneQueryParserToken *) nil_chk(self->token_))->next_ = [((OrgApacheLuceneQueryParserQueryParserTokenManager *) nil_chk(self->token_source_)) getNextToken];
  self->jj_ntk_ = -1;
...
jboolean OrgApacheLuceneQueryParserQueryParser_jj_scan_tokenWithInt_(OrgApacheLuceneQueryParserQueryParser *self, jint kind) {
  if (self->jj_scanpos_ == self->jj_lastpos_) {
    ...
    if (((OrgApacheLuceneQueryParserToken *) nil_chk(self->jj_scanpos_))->next_ == nil) {
      self->jj_lastpos_ = self->jj_scanpos_ = self->jj_scanpos_->next_ = [((OrgApacheLuceneQueryParserQueryParserTokenManager *) nil_chk(self->token_source_)) getNextToken];
    }
    else {
    ...
    self->jj_scanpos_ = ((OrgApacheLuceneQueryParserToken *) nil_chk(self->jj_scanpos_))->next_;
  }
  if (self->jj_rescan_) {
    jint i = 0;
...
jint OrgApacheLuceneQueryParserQueryParser_jj_ntk(OrgApacheLuceneQueryParserQueryParser *self) {
  if ((self->jj_nt_ = ((OrgApacheLuceneQueryParserToken *) nil_chk(self->token_))->next_) == nil) return (self->jj_ntk_ = (self->token_->next_ = [((OrgApacheLuceneQueryParserQueryParserTokenManager *) nil_chk(self->token_source_)) getNextToken])->kind_);
...
void OrgApacheLuceneQueryParserQueryParser_jj_saveWithInt_withInt_(OrgApacheLuceneQueryParserQueryParser *self, jint index, jint xla) {
  ...
  while (((OrgApacheLuceneQueryParserQueryParser_JJCalls *) nil_chk(p))->gen_ > self->jj_gen_) {
    if (p->next_ == nil) {
      p = p->next_ = new_OrgApacheLuceneQueryParserQueryParser_JJCalls_init();
      break;
    }
    p = p->next_;
  }
...
+ (void)initialize {
  if (self == [OrgApacheLuceneQueryParserQueryParser_Operator class]) {
    JreEnum(OrgApacheLuceneQueryParserQueryParser_Operator, OR) = new_OrgApacheLuceneQueryParserQueryParser_Operator_initWithNSString_withInt_(@"OR", 0);
    JreEnum(OrgApacheLuceneQueryParserQueryParser_Operator, AND) = new_OrgApacheLuceneQueryParserQueryParser_Operator_initWithNSString_withInt_(@"AND", 1);
...
OrgApacheLuceneQueryParserQueryParser_Operator *new_OrgApacheLuceneQueryParserQueryParser_Operator_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneQueryParserQueryParser_Operator, initWithNSString_withInt_, __name, __ordinal)
}
