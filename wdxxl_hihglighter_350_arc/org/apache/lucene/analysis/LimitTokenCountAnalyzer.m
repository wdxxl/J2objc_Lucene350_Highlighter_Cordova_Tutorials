...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/LimitTokenCountAnalyzer.java
//
...
- (OrgApacheLuceneAnalysisTokenStream *)tokenStreamWithNSString:(NSString *)fieldName
  ...
  return new_OrgApacheLuceneAnalysisLimitTokenCountFilter_initWithOrgApacheLuceneAnalysisTokenStream_withInt_([((OrgApacheLuceneAnalysisAnalyzer *) nil_chk(delegate_)) tokenStreamWithNSString:fieldName withJavaIoReader:reader], maxTokenCount_);
}

- (OrgApacheLuceneAnalysisTokenStream *)reusableTokenStreamWithNSString:(NSString *)fieldName
                                                       withJavaIoReader:(JavaIoReader *)reader {
  return new_OrgApacheLuceneAnalysisLimitTokenCountFilter_initWithOrgApacheLuceneAnalysisTokenStream_withInt_([((OrgApacheLuceneAnalysisAnalyzer *) nil_chk(delegate_)) reusableTokenStreamWithNSString:fieldName withJavaIoReader:reader], maxTokenCount_);
}
