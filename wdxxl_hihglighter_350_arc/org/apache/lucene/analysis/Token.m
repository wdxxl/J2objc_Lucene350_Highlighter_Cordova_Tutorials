...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/Token.java
//
...
- (id)java_clone {
  ...
  if (payload_ != nil) {
    ((OrgApacheLuceneAnalysisToken *) nil_chk(t))->payload_ = (OrgApacheLuceneIndexPayload *) cast_chk([payload_ java_clone], [OrgApacheLuceneIndexPayload class]);
  }
  return t;
}
...
- (OrgApacheLuceneAnalysisToken *)cloneWithCharArray:(IOSCharArray *)newTermBuffer
  ...
  OrgApacheLuceneAnalysisToken *t = new_OrgApacheLuceneAnalysisToken_initWithCharArray_withInt_withInt_withInt_withInt_(newTermBuffer, newTermOffset, newTermLength, newStartOffset, newEndOffset);
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisToken class]) {
    OrgApacheLuceneAnalysisToken_TOKEN_ATTRIBUTE_FACTORY = new_OrgApacheLuceneAnalysisToken_TokenAttributeFactory_initWithOrgApacheLuceneUtilAttributeSource_AttributeFactory_(JreLoadStatic(OrgApacheLuceneUtilAttributeSource_AttributeFactory, DEFAULT_ATTRIBUTE_FACTORY));
...
- (OrgApacheLuceneUtilAttributeImpl *)createAttributeInstanceWithIOSClass:(IOSClass *)attClass {
  return [((IOSClass *) nil_chk(attClass)) isAssignableFrom:OrgApacheLuceneAnalysisToken_class_()] ? new_OrgApacheLuceneAnalysisToken_init() : [((OrgApacheLuceneUtilAttributeSource_AttributeFactory *) nil_chk(delegate_)) createAttributeInstanceWithIOSClass:attClass];
}
