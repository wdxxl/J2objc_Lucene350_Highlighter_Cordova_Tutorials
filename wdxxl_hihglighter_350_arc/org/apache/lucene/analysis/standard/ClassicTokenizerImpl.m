...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/standard/ClassicTokenizerImpl.java
//
...
- (void)yyresetWithJavaIoReader:(JavaIoReader *)reader {
  ...
  if (((IOSCharArray *) nil_chk(zzBuffer_))->size_ > OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_BUFFERSIZE) zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_BUFFERSIZE];
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStandardClassicTokenizerImpl class]) {
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_LEXSTATE = [IOSIntArray newArrayWithInts:(jint[]){ 0, 0 } count:2];
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_CMAP = OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackCMapWithNSString_(OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_CMAP_PACKED);
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_ACTION = OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackAction();
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_ROWMAP = OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackRowMap();
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_TRANS = OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackTrans();
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_ERROR_MSG = [IOSObjectArray newArrayWithObjects:(id[]){ @"Unkown internal scanner error", @"Error: could not match input", @"Error: pushback value was too large" } count:3 type:NSString_class_()];
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_ATTRIBUTE = OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackAttribute();
    OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_TOKEN_TYPES = JreLoadStatic(OrgApacheLuceneAnalysisStandardStandardTokenizer, TOKEN_TYPES);
...
IOSIntArray *OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackAction() {
  ...
  IOSIntArray *result = [IOSIntArray newArrayWithLength:51];
  jint offset = 0;
...
IOSIntArray *OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_zzUnpackTrans() {
  OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_initialize();
  IOSIntArray *result = [IOSIntArray newArrayWithLength:658];
  jint offset = 0;
...
void OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_initWithJavaIoReader_(OrgApacheLuceneAnalysisStandardClassicTokenizerImpl *self, JavaIoReader *inArg) {
  ...
  self->zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_ZZ_BUFFERSIZE];
  self->zzAtBOL_ = true;
...
void OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_initWithJavaIoInputStream_(OrgApacheLuceneAnalysisStandardClassicTokenizerImpl *self, JavaIoInputStream *inArg) {
  OrgApacheLuceneAnalysisStandardClassicTokenizerImpl_initWithJavaIoReader_(self, new_JavaIoInputStreamReader_initWithJavaIoInputStream_(inArg));
}
