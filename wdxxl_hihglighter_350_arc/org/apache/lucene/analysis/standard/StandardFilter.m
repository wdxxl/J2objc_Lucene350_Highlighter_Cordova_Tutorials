...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/standard/StandardFilter.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStandardStandardFilter class]) {
    OrgApacheLuceneAnalysisStandardStandardFilter_APOSTROPHE_TYPE = IOSObjectArray_Get(nil_chk(JreLoadStatic(OrgApacheLuceneAnalysisStandardClassicTokenizer, TOKEN_TYPES)), OrgApacheLuceneAnalysisStandardClassicTokenizer_APOSTROPHE);
    OrgApacheLuceneAnalysisStandardStandardFilter_ACRONYM_TYPE = IOSObjectArray_Get(JreLoadStatic(OrgApacheLuceneAnalysisStandardClassicTokenizer, TOKEN_TYPES), OrgApacheLuceneAnalysisStandardClassicTokenizer_ACRONYM);
...
jboolean OrgApacheLuceneAnalysisStandardStandardFilter_incrementTokenClassic(OrgApacheLuceneAnalysisStandardStandardFilter *self) {
  ...
  if (type == OrgApacheLuceneAnalysisStandardStandardFilter_APOSTROPHE_TYPE && bufferLength >= 2 && IOSCharArray_Get(nil_chk(buffer), bufferLength - 2) == '\'' && (IOSCharArray_Get(buffer, bufferLength - 1) == 's' || IOSCharArray_Get(buffer, bufferLength - 1) == 'S')) {
    (void) [self->termAtt_ setLengthWithInt:bufferLength - 2];
  }
    ...
    (void) [self->termAtt_ setLengthWithInt:upto];
  }
  return true;
}
