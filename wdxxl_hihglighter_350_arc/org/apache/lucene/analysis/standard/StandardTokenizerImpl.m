...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/standard/StandardTokenizerImpl.java
//
...
- (void)yyresetWithJavaIoReader:(JavaIoReader *)reader {
  ...
  if (((IOSCharArray *) nil_chk(zzBuffer_))->size_ > OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_BUFFERSIZE) zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_BUFFERSIZE];
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStandardStandardTokenizerImpl class]) {
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_LEXSTATE = [IOSIntArray newArrayWithInts:(jint[]){ 0, 0 } count:2];
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_CMAP = OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackCMapWithNSString_(OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_CMAP_PACKED);
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_ACTION = OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackAction();
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_ROWMAP = OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackRowMap();
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_TRANS = OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackTrans();
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_ERROR_MSG = [IOSObjectArray newArrayWithObjects:(id[]){ @"Unkown internal scanner error", @"Error: could not match input", @"Error: pushback value was too large" } count:3 type:NSString_class_()];
    OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_ATTRIBUTE = OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackAttribute();
...
IOSIntArray *OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackAction() {
  ...
  IOSIntArray *result = [IOSIntArray newArrayWithLength:124];
  jint offset = 0;
...
IOSIntArray *OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_zzUnpackTrans() {
  OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_initialize();
  IOSIntArray *result = [IOSIntArray newArrayWithLength:11845];
  jint offset = 0;
...
void OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_initWithJavaIoReader_(OrgApacheLuceneAnalysisStandardStandardTokenizerImpl *self, JavaIoReader *inArg) {
  ...
  self->zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_ZZ_BUFFERSIZE];
  self->zzAtBOL_ = true;
...
void OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_initWithJavaIoInputStream_(OrgApacheLuceneAnalysisStandardStandardTokenizerImpl *self, JavaIoInputStream *inArg) {
  OrgApacheLuceneAnalysisStandardStandardTokenizerImpl_initWithJavaIoReader_(self, new_JavaIoInputStreamReader_initWithJavaIoInputStream_(inArg));
}
