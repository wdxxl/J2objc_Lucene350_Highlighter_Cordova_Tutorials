...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/Tokenizer.java
//
...
void OrgApacheLuceneAnalysisTokenizer_initWithJavaIoReader_(OrgApacheLuceneAnalysisTokenizer *self, JavaIoReader *input) {
  OrgApacheLuceneAnalysisTokenStream_init(self);
  self->input_ = OrgApacheLuceneAnalysisCharReader_getWithJavaIoReader_(input);
}
