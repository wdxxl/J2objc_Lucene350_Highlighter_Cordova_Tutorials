...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/NumericTokenStream.java
//
...
- (void)reset {
  if (valSize_ == 0) @throw new_JavaLangIllegalStateException_initWithNSString_(@"call set???Value() before usage");
  shift_ = 0;
}
...
- (jboolean)incrementToken {
  ...
  switch (valSize_) {
    ...
    (void) [termAtt_ setLengthWithInt:OrgApacheLuceneUtilNumericUtils_longToPrefixCodedWithLong_withInt_withCharArray_(value_, shift_, buffer)];
    break;
    case 32:
    ...
    (void) [termAtt_ setLengthWithInt:OrgApacheLuceneUtilNumericUtils_intToPrefixCodedWithInt_withInt_withCharArray_((jint) value_, shift_, buffer)];
    break;
    default:
...
- (NSString *)description {
  JavaLangStringBuilder *sb = [new_JavaLangStringBuilder_initWithNSString_(@"(numeric,valSize=") appendWithInt:valSize_];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@",precisionStep="])) appendWithInt:precisionStep_])) appendWithChar:')'];
