...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/LockStressTest.java
//
...
void OrgApacheLuceneStoreLockStressTest_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  @catch (JavaLangIllegalAccessException *e) {
    @throw new_JavaIoIOException_initWithNSString_(JreStrcat("$$", @"IllegalAccessException when instantiating LockClass ", lockFactoryClassName));
  }
  @catch (JavaLangInstantiationException *e) {
    @throw new_JavaIoIOException_initWithNSString_(JreStrcat("$$", @"InstantiationException when instantiating LockClass ", lockFactoryClassName));
  }
  @catch (JavaLangClassCastException *e) {
    @throw new_JavaIoIOException_initWithNSString_(JreStrcat("$$$", @"unable to cast LockClass ", lockFactoryClassName, @" instance to a LockFactory"));
  }
  @catch (JavaLangClassNotFoundException *e) {
    @throw new_JavaIoIOException_initWithNSString_(JreStrcat("$$", @"unable to find LockClass ", lockFactoryClassName));
  }
  JavaIoFile *lockDir = new_JavaIoFile_initWithNSString_(lockDirName);
  ...
  OrgApacheLuceneStoreLockFactory *verifyLF = new_OrgApacheLuceneStoreVerifyingLockFactory_initWithByte_withOrgApacheLuceneStoreLockFactory_withNSString_withInt_((jbyte) myID, lockFactory, verifierHost, verifierPort);
