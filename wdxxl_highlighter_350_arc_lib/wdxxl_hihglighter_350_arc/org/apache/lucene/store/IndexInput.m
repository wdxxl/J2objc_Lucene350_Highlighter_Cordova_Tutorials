...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/store/IndexInput.java
//
...
void OrgApacheLuceneStoreIndexInput_initWithNSString_(OrgApacheLuceneStoreIndexInput *self, NSString *resourceDescription) {
  ...
  if (resourceDescription == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"resourceDescription must not be null");
  }
  self->resourceDescription_ = resourceDescription;
}
