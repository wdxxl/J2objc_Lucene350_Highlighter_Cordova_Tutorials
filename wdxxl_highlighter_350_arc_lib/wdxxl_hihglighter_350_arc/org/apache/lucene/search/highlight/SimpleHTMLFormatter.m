...
withOrgApacheLuceneSearchHighlightTokenGroup:(OrgApacheLuceneSearchHighlightTokenGroup *)tokenGroup {
  ...
  JavaLangStringBuilder *returnBuffer = new_JavaLangStringBuilder_initWithInt_([((NSString *) nil_chk(preTag_)) java_length] + [((NSString *) nil_chk(originalText)) java_length] + [((NSString *) nil_chk(postTag_)) java_length]);
  (void) [returnBuffer appendWithNSString:preTag_];
  (void) [returnBuffer appendWithNSString:originalText];
  (void) [returnBuffer appendWithNSString:postTag_];
