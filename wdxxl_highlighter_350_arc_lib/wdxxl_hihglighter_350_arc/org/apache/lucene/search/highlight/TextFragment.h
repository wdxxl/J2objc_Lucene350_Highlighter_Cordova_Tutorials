...
FOUNDATION_EXPORT void OrgApacheLuceneSearchHighlightTextFragment_initWithJavaLangStringBuffer_withInt_withInt_(OrgApacheLuceneSearchHighlightTextFragment *self, JavaLangStringBuffer *markedUpText, jint textStartPos, jint fragNum);

FOUNDATION_EXPORT OrgApacheLuceneSearchHighlightTextFragment *new_OrgApacheLuceneSearchHighlightTextFragment_initWithJavaLangStringBuffer_withInt_withInt_(JavaLangStringBuffer *markedUpText, jint textStartPos, jint fragNum) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneSearchHighlightTextFragment *create_OrgApacheLuceneSearchHighlightTextFragment_initWithJavaLangStringBuffer_withInt_withInt_(JavaLangStringBuffer *markedUpText, jint textStartPos, jint fragNum);
