...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/PrefixQuery.java
//
...
- (OrgApacheLuceneSearchFilteredTermEnum *)getEnumWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  return new_OrgApacheLuceneSearchPrefixTermEnum_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexTerm_(reader, prefix_);
}
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  if (![((NSString *) nil_chk([((OrgApacheLuceneIndexTerm *) nil_chk(prefix_)) field])) isEqual:field]) {
    (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(prefix_)) field]];
    (void) [buffer appendWithNSString:@":"];
  }
  (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(prefix_)) text]];
