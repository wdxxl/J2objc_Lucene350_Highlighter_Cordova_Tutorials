...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/FieldValueHitQueue.java
//
...
- (OrgApacheLuceneSearchFieldDoc *)fillFieldsWithOrgApacheLuceneSearchFieldValueHitQueue_Entry:(OrgApacheLuceneSearchFieldValueHitQueue_Entry *)entry_ {
  ...
  IOSObjectArray *fields = [IOSObjectArray newArrayWithLength:n type:NSObject_class_()];
  for (jint i = 0; i < n; ++i) {
    (void) IOSObjectArray_Set(fields, i, [((OrgApacheLuceneSearchFieldComparator *) nil_chk(IOSObjectArray_Get(comparators_, i))) valueWithInt:((OrgApacheLuceneSearchFieldValueHitQueue_Entry *) nil_chk(entry_))->slot_]);
  }
  return new_OrgApacheLuceneSearchFieldDoc_initWithInt_withFloat_withNSObjectArray_(((OrgApacheLuceneSearchFieldValueHitQueue_Entry *) nil_chk(entry_))->doc_, entry_->score_, fields);
}
...
void OrgApacheLuceneSearchFieldValueHitQueue_initWithOrgApacheLuceneSearchSortFieldArray_(OrgApacheLuceneSearchFieldValueHitQueue *self, IOSObjectArray *fields) {
  ...
  self->comparators_ = [IOSObjectArray newArrayWithLength:numComparators type:OrgApacheLuceneSearchFieldComparator_class_()];
  self->reverseMul_ = [IOSIntArray newArrayWithLength:numComparators];
}
...
OrgApacheLuceneSearchFieldValueHitQueue *OrgApacheLuceneSearchFieldValueHitQueue_createWithOrgApacheLuceneSearchSortFieldArray_withInt_(IOSObjectArray *fields, jint size) {
  ...
  if (fields->size_ == 1) {
    return new_OrgApacheLuceneSearchFieldValueHitQueue_OneComparatorFieldValueHitQueue_initWithOrgApacheLuceneSearchSortFieldArray_withInt_(fields, size);
  }
  else {
    return new_OrgApacheLuceneSearchFieldValueHitQueue_MultiComparatorsFieldValueHitQueue_initWithOrgApacheLuceneSearchSortFieldArray_withInt_(fields, size);
  }
}
...
void OrgApacheLuceneSearchFieldValueHitQueue_OneComparatorFieldValueHitQueue_initWithOrgApacheLuceneSearchSortFieldArray_withInt_(OrgApacheLuceneSearchFieldValueHitQueue_OneComparatorFieldValueHitQueue *self, IOSObjectArray *fields, jint size) {
  ...
  self->comparator_ = [((OrgApacheLuceneSearchSortField *) nil_chk(field)) getComparatorWithInt:size withInt:0];
  self->oneReverseMul_ = field->reverse_ ? -1 : 1;
  (void) IOSObjectArray_Set(nil_chk(self->comparators_), 0, self->comparator_);
...
void OrgApacheLuceneSearchFieldValueHitQueue_MultiComparatorsFieldValueHitQueue_initWithOrgApacheLuceneSearchSortFieldArray_withInt_(OrgApacheLuceneSearchFieldValueHitQueue_MultiComparatorsFieldValueHitQueue *self, IOSObjectArray *fields, jint size) {
  ...
  for (jint i = 0; i < numComparators; ++i) {
    ...
    *IOSIntArray_GetRef(nil_chk(self->reverseMul_), i) = ((OrgApacheLuceneSearchSortField *) nil_chk(field))->reverse_ ? -1 : 1;
    (void) IOSObjectArray_Set(self->comparators_, i, [field getComparatorWithInt:size withInt:i]);
  }
  [self initialize__WithInt:size];
}
