...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/CachingCollector.java
//
...
- (void)setNextReaderWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  if (lastReader_ != nil) {
    [((id<JavaUtilList>) nil_chk(cachedSegs_)) addWithId:new_OrgApacheLuceneSearchCachingCollector_SegStart_initWithOrgApacheLuceneIndexIndexReader_withInt_withInt_(lastReader_, lastDocBase_, base_ + upto_)];
  }
...
- (void)replayInitWithOrgApacheLuceneSearchCollector:(OrgApacheLuceneSearchCollector *)other {
  if (![self isCached]) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"cannot replay: cache was cleared because too much RAM was required");
  }
  if (![((OrgApacheLuceneSearchCollector *) nil_chk(other)) acceptsDocsOutOfOrder] && [((OrgApacheLuceneSearchCollector *) nil_chk(self->other_)) acceptsDocsOutOfOrder]) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"cannot replay: given collector does not support out-of-order collection, while the wrapped collector does. Therefore cached documents may be out-of-order.");
  }
  if (lastReader_ != nil) {
    [((id<JavaUtilList>) nil_chk(cachedSegs_)) addWithId:new_OrgApacheLuceneSearchCachingCollector_SegStart_initWithOrgApacheLuceneIndexIndexReader_withInt_withInt_(lastReader_, lastDocBase_, base_ + upto_)];
    lastReader_ = nil;
...
+ (void)initialize {
  if (self == [OrgApacheLuceneSearchCachingCollector class]) {
    OrgApacheLuceneSearchCachingCollector_EMPTY_INT_ARRAY = [IOSIntArray newArrayWithLength:0];
...
OrgApacheLuceneSearchCachingCollector *OrgApacheLuceneSearchCachingCollector_createWithBoolean_withBoolean_withDouble_(jboolean acceptDocsOutOfOrder, jboolean cacheScores, jdouble maxRAMMB) {
  ...
  OrgApacheLuceneSearchCollector *other = new_OrgApacheLuceneSearchCachingCollector_1_initWithBoolean_(acceptDocsOutOfOrder);
  return OrgApacheLuceneSearchCachingCollector_createWithOrgApacheLuceneSearchCollector_withBoolean_withDouble_(other, cacheScores, maxRAMMB);
}
...
OrgApacheLuceneSearchCachingCollector *OrgApacheLuceneSearchCachingCollector_createWithOrgApacheLuceneSearchCollector_withBoolean_withDouble_(OrgApacheLuceneSearchCollector *other, jboolean cacheScores, jdouble maxRAMMB) {
  OrgApacheLuceneSearchCachingCollector_initialize();
  return cacheScores ? new_OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withDouble_(other, maxRAMMB) : (id) new_OrgApacheLuceneSearchCachingCollector_NoScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withDouble_(other, maxRAMMB);
}
...
OrgApacheLuceneSearchCachingCollector *OrgApacheLuceneSearchCachingCollector_createWithOrgApacheLuceneSearchCollector_withBoolean_withInt_(OrgApacheLuceneSearchCollector *other, jboolean cacheScores, jint maxDocsToCache) {
  OrgApacheLuceneSearchCachingCollector_initialize();
  return cacheScores ? new_OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withInt_(other, maxDocsToCache) : (id) new_OrgApacheLuceneSearchCachingCollector_NoScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withInt_(other, maxDocsToCache);
}
...
void OrgApacheLuceneSearchCachingCollector_initWithOrgApacheLuceneSearchCollector_withDouble_withBoolean_(OrgApacheLuceneSearchCachingCollector *self, OrgApacheLuceneSearchCollector *other, jdouble maxRAMMB, jboolean cacheScores) {
  ...
  self->cachedSegs_ = new_JavaUtilArrayList_init();
  self->other_ = other;
  self->cachedDocs_ = new_JavaUtilArrayList_init();
  self->curDocs_ = [IOSIntArray newArrayWithLength:OrgApacheLuceneSearchCachingCollector_INITIAL_ARRAY_SIZE];
...
- (void)collectWithInt:(jint)doc {
  ...
  if (upto_ == curDocs_->size_) {
    ...
    curDocs_ = [IOSIntArray newArrayWithLength:nextLength];
    [((id<JavaUtilList>) nil_chk(cachedDocs_)) addWithId:curDocs_];
    curScores_ = [IOSFloatArray newArrayWithLength:nextLength];
...
- (void)replayWithOrgApacheLuceneSearchCollector:(OrgApacheLuceneSearchCollector *)other {
  ...
  jint curBase = 0;
  jint chunkUpto = 0;
  curDocs_ = JreLoadStatic(OrgApacheLuceneSearchCachingCollector, EMPTY_INT_ARRAY);
  for (OrgApacheLuceneSearchCachingCollector_SegStart * __strong seg in nil_chk(cachedSegs_)) {
    ...
    while (curBase + curUpto < seg->end_) {
      if (curUpto == ((IOSIntArray *) nil_chk(curDocs_))->size_) {
        ...
        curDocs_ = [((id<JavaUtilList>) nil_chk(cachedDocs_)) getWithInt:chunkUpto];
        curScores_ = [((id<JavaUtilList>) nil_chk(cachedScores_)) getWithInt:chunkUpto];
        chunkUpto++;
        curUpto = 0;
      }
...
void OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withDouble_(OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector *self, OrgApacheLuceneSearchCollector *other, jdouble maxRAMMB) {
  ...
  self->cachedScorer_ = new_OrgApacheLuceneSearchCachingCollector_CachedScorer_init();
  self->cachedScores_ = new_JavaUtilArrayList_init();
  self->curScores_ = [IOSFloatArray newArrayWithLength:128];
...
void OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector_initWithOrgApacheLuceneSearchCollector_withInt_(OrgApacheLuceneSearchCachingCollector_ScoreCachingCollector *self, OrgApacheLuceneSearchCollector *other, jint maxDocsToCache) {
  ...
  self->cachedScorer_ = new_OrgApacheLuceneSearchCachingCollector_CachedScorer_init();
  self->cachedScores_ = new_JavaUtilArrayList_init();
  self->curScores_ = [IOSFloatArray newArrayWithLength:OrgApacheLuceneSearchCachingCollector_INITIAL_ARRAY_SIZE];
  [self->cachedScores_ addWithId:self->curScores_];
}
