...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/MultiTermQueryWrapperFilter.java
//
...
- (OrgApacheLuceneSearchDocIdSet *)getDocIdSetWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  ...
  @try {
    ...
    OrgApacheLuceneUtilFixedBitSet *bitSet = new_OrgApacheLuceneUtilFixedBitSet_initWithInt_([((OrgApacheLuceneIndexIndexReader *) nil_chk(reader)) maxDoc]);
    IOSIntArray *docs = [IOSIntArray newArrayWithLength:32];
    IOSIntArray *freqs = [IOSIntArray newArrayWithLength:32];
