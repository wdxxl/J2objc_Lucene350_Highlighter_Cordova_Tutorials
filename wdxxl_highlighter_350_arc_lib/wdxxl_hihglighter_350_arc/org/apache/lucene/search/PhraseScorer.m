...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/PhraseScorer.java
//
...
jboolean OrgApacheLuceneSearchPhraseScorer_advanceMinWithInt_(OrgApacheLuceneSearchPhraseScorer *self, jint target) {
  ...
  self->min_ = ((OrgApacheLuceneSearchPhrasePositions *) nil_chk(self->min_))->next_;
  self->max_ = ((OrgApacheLuceneSearchPhrasePositions *) nil_chk(self->max_))->next_;
  return true;
}
