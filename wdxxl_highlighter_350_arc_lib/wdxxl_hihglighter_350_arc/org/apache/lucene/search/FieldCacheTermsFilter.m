...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/FieldCacheTermsFilter.java
//
...
- (OrgApacheLuceneSearchDocIdSet *)getDocIdSetWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  return new_OrgApacheLuceneSearchFieldCacheTermsFilter_FieldCacheTermsFilterDocIdSet_initWithOrgApacheLuceneSearchFieldCacheTermsFilter_withOrgApacheLuceneSearchFieldCache_StringIndex_(self, [((id<OrgApacheLuceneSearchFieldCache>) nil_chk([self getFieldCache])) getStringIndexWithOrgApacheLuceneIndexIndexReader:reader withNSString:field_]);
}
...
- (OrgApacheLuceneSearchDocIdSetIterator *)iterator {
  return new_OrgApacheLuceneSearchFieldCacheTermsFilter_FieldCacheTermsFilterDocIdSet_FieldCacheTermsFilterDocIdSetIterator_initWithOrgApacheLuceneSearchFieldCacheTermsFilter_FieldCacheTermsFilterDocIdSet_(self);
}
...
void OrgApacheLuceneSearchFieldCacheTermsFilter_FieldCacheTermsFilterDocIdSet_initWithOrgApacheLuceneSearchFieldCacheTermsFilter_withOrgApacheLuceneSearchFieldCache_StringIndex_(OrgApacheLuceneSearchFieldCacheTermsFilter_FieldCacheTermsFilterDocIdSet *self, OrgApacheLuceneSearchFieldCacheTermsFilter *outer$, OrgApacheLuceneSearchFieldCache_StringIndex *fcsi) {
  ...
  self->fcsi_ = fcsi;
  self->bits_ = new_OrgApacheLuceneUtilFixedBitSet_initWithInt_(((IOSObjectArray *) nil_chk(((OrgApacheLuceneSearchFieldCache_StringIndex *) nil_chk(self->fcsi_))->lookup_))->size_);
