...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/CachingWrapperFilter.java
//
...
__attribute__((unused)) static OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode *new_OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
void OrgApacheLuceneSearchCachingWrapperFilter_initWithOrgApacheLuceneSearchFilter_withOrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_(OrgApacheLuceneSearchCachingWrapperFilter *self, OrgApacheLuceneSearchFilter *filter, OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode *deletesMode) {
  ...
  self->filter_ = filter;
  self->cache_ = new_OrgApacheLuceneSearchCachingWrapperFilter_1_initWithOrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_(deletesMode);
}
...
OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode *new_OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode, initWithNSString_withInt_, __name, __ordinal)
}
...
- (id)getWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  @synchronized(self) {
    id value;
    if (cache_ == nil) {
      cache_ = new_JavaUtilWeakHashMap_init();
    }
...
- (void)putWithId:(id)coreKey
  ...
  @synchronized(self) {
    if (deletesMode_ == JreLoadEnum(OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode, IGNORE)) {
      (void) [((id<JavaUtilMap>) nil_chk(cache_)) putWithId:coreKey withId:value];
    }
    else if (deletesMode_ == JreLoadEnum(OrgApacheLuceneSearchCachingWrapperFilter_DeletesMode, RECACHE)) {
      (void) [((id<JavaUtilMap>) nil_chk(cache_)) putWithId:delCoreKey withId:value];
    }
    else {
      (void) [((id<JavaUtilMap>) nil_chk(cache_)) putWithId:coreKey withId:value];
      (void) [((id<JavaUtilMap>) nil_chk(cache_)) putWithId:delCoreKey withId:value];
...
- (OrgApacheLuceneSearchDocIdSet *)mergeDeletesWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)r
                                                                            withId:(OrgApacheLuceneSearchDocIdSet *)docIdSet {
  return new_OrgApacheLuceneSearchCachingWrapperFilter_1_1_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneSearchDocIdSet_(r, docIdSet);
}
