...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/TermSpans.java
//
...
- (id<JavaUtilCollection>)getPayload {
  IOSByteArray *bytes = [IOSByteArray newArrayWithLength:[((id<OrgApacheLuceneIndexTermPositions>) nil_chk(positions_)) getPayloadLength]];
