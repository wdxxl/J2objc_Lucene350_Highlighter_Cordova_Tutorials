...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/SpanNotQuery.java
//
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  (void) [buffer appendWithNSString:@"spanNot("];
  (void) [buffer appendWithNSString:[((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(include_)) toStringWithNSString:field]];
  (void) [buffer appendWithNSString:@", "];
  (void) [buffer appendWithNSString:[((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(exclude_)) toStringWithNSString:field]];
  (void) [buffer appendWithNSString:@")"];
...
- (OrgApacheLuceneSearchSpansSpans *)getSpansWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  return new_OrgApacheLuceneSearchSpansSpanNotQuery_1_initWithOrgApacheLuceneSearchSpansSpanNotQuery_withOrgApacheLuceneIndexIndexReader_(self, reader);
}
...
- (OrgApacheLuceneSearchQuery *)rewriteWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  ...
  if (rewrittenInclude != include_) {
    ...
    ((OrgApacheLuceneSearchSpansSpanNotQuery *) nil_chk(clone))->include_ = rewrittenInclude;
  }
  ...
  if (rewrittenExclude != exclude_) {
    ...
    ((OrgApacheLuceneSearchSpansSpanNotQuery *) nil_chk(clone))->exclude_ = rewrittenExclude;
  }
  if (clone != nil) {
    return clone;
  }
...
void OrgApacheLuceneSearchSpansSpanNotQuery_initWithOrgApacheLuceneSearchSpansSpanQuery_withOrgApacheLuceneSearchSpansSpanQuery_(OrgApacheLuceneSearchSpansSpanNotQuery *self, OrgApacheLuceneSearchSpansSpanQuery *include, OrgApacheLuceneSearchSpansSpanQuery *exclude) {
  ...
  if (![((NSString *) nil_chk([((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(include)) getField])) isEqual:[((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(exclude)) getField]]) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Clauses must have same field.");
}
...
- (id<JavaUtilCollection>)getPayload {
  ...
  if ([((OrgApacheLuceneSearchSpansSpans *) nil_chk(includeSpans_)) isPayloadAvailable]) {
    result = new_JavaUtilArrayList_initWithJavaUtilCollection_([((OrgApacheLuceneSearchSpansSpans *) nil_chk(includeSpans_)) getPayload]);
  }
  return result;
}
...
void OrgApacheLuceneSearchSpansSpanNotQuery_1_initWithOrgApacheLuceneSearchSpansSpanNotQuery_withOrgApacheLuceneIndexIndexReader_(OrgApacheLuceneSearchSpansSpanNotQuery_1 *self, OrgApacheLuceneSearchSpansSpanNotQuery *outer$, OrgApacheLuceneIndexIndexReader *capture$0) {
  ...
  self->includeSpans_ = [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(outer$->include_)) getSpansWithOrgApacheLuceneIndexIndexReader:capture$0];
  self->moreInclude_ = true;
  self->excludeSpans_ = [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(outer$->exclude_)) getSpansWithOrgApacheLuceneIndexIndexReader:capture$0];
