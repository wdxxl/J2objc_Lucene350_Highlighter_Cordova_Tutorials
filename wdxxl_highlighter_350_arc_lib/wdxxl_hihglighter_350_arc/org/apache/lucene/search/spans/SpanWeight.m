...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/SpanWeight.java
//
...
- (OrgApacheLuceneSearchExplanation *)explainWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader
  ...
  OrgApacheLuceneSearchExplanation *idfExpl = new_OrgApacheLuceneSearchExplanation_initWithFloat_withNSString_(idf_, JreStrcat("$$$$C", @"idf(", field, @": ", [((OrgApacheLuceneSearchExplanation_IDFExplanation *) nil_chk(idfExp_)) explain], ')'));
  ...
  OrgApacheLuceneSearchExplanation *boostExpl = new_OrgApacheLuceneSearchExplanation_initWithFloat_withNSString_([((OrgApacheLuceneSearchQuery *) nil_chk([self getQuery])) getBoost], @"boost");
...
void OrgApacheLuceneSearchSpansSpanWeight_initWithOrgApacheLuceneSearchSpansSpanQuery_withOrgApacheLuceneSearchSearcher_(OrgApacheLuceneSearchSpansSpanWeight *self, OrgApacheLuceneSearchSpansSpanQuery *query, OrgApacheLuceneSearchSearcher *searcher) {
  ...
  self->similarity_ = [((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(query)) getSimilarityWithOrgApacheLuceneSearchSearcher:searcher];
  self->query_ = query;
  self->terms_ = new_JavaUtilHashSet_init();
  [query extractTermsWithJavaUtilSet:self->terms_];
  self->idfExp_ = [((OrgApacheLuceneSearchSimilarity *) nil_chk(self->similarity_)) idfExplainWithJavaUtilCollection:self->terms_ withOrgApacheLuceneSearchSearcher:searcher];
