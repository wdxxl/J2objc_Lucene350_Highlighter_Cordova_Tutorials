...
- (id)java_clone {
  OrgApacheLuceneSearchSpansSpanNearPayloadCheckQuery *result = new_OrgApacheLuceneSearchSpansSpanNearPayloadCheckQuery_initWithOrgApacheLuceneSearchSpansSpanNearQuery_withJavaUtilCollection_((OrgApacheLuceneSearchSpansSpanNearQuery *) cast_chk([((OrgApacheLuceneSearchSpansSpanQuery *) nil_chk(match_)) java_clone], [OrgApacheLuceneSearchSpansSpanNearQuery class]), payloadToMatch_);
