...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/SpanTermQuery.java
//
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  if ([((NSString *) nil_chk([((OrgApacheLuceneIndexTerm *) nil_chk(term_)) field])) isEqual:field]) (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(term_)) text]];
  else (void) [buffer appendWithNSString:[((OrgApacheLuceneIndexTerm *) nil_chk(term_)) description]];
...
- (OrgApacheLuceneSearchSpansSpans *)getSpansWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  return new_OrgApacheLuceneSearchSpansTermSpans_initWithOrgApacheLuceneIndexTermPositions_withOrgApacheLuceneIndexTerm_([((OrgApacheLuceneIndexIndexReader *) nil_chk(reader)) termPositionsWithOrgApacheLuceneIndexTerm:term_], term_);
}
