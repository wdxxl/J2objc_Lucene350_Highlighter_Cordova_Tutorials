...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/spans/SpanOrQuery.java
//
...
- (id)java_clone {
  ...
  OrgApacheLuceneSearchSpansSpanOrQuery *soq = new_OrgApacheLuceneSearchSpansSpanOrQuery_initWithOrgApacheLuceneSearchSpansSpanQueryArray_(newClauses);
...
- (OrgApacheLuceneSearchQuery *)rewriteWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  ...
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(clauses_)) size]; i++) {
    ...
    if (query != c) {
      ...
      (void) [((id<JavaUtilList>) nil_chk(((OrgApacheLuceneSearchSpansSpanOrQuery *) nil_chk(clone))->clauses_)) setWithInt:i withId:query];
    }
  }
  if (clone != nil) {
    return clone;
...
- (NSString *)toStringWithNSString:(NSString *)field {
  ...
  (void) [buffer appendWithNSString:@"spanOr(["];
...
- (OrgApacheLuceneSearchSpansSpans *)getSpansWithOrgApacheLuceneIndexIndexReader:(OrgApacheLuceneIndexIndexReader *)reader {
  ...
  return new_OrgApacheLuceneSearchSpansSpanOrQuery_1_initWithOrgApacheLuceneSearchSpansSpanOrQuery_withOrgApacheLuceneIndexIndexReader_(self, reader);
}
...
- (jboolean)next {
  ...
  if ([((OrgApacheLuceneSearchSpansSpans *) nil_chk(OrgApacheLuceneSearchSpansSpanOrQuery_1_top(self))) next]) {
    (void) [((OrgApacheLuceneSearchSpansSpanOrQuery_SpanQueue *) nil_chk(queue_)) updateTop];
    return true;
  }
  (void) [((OrgApacheLuceneSearchSpansSpanOrQuery_SpanQueue *) nil_chk(queue_)) pop];
...
- (id<JavaUtilCollection>)getPayload {
  ...
  if (theTop != nil && [theTop isPayloadAvailable]) {
    result = new_JavaUtilArrayList_initWithJavaUtilCollection_([theTop getPayload]);
  }
  return result;
}
...
jboolean OrgApacheLuceneSearchSpansSpanOrQuery_1_initSpanQueueWithInt_(OrgApacheLuceneSearchSpansSpanOrQuery_1 *self, jint target) {
  self->queue_ = new_OrgApacheLuceneSearchSpansSpanOrQuery_SpanQueue_initWithOrgApacheLuceneSearchSpansSpanOrQuery_withInt_(self->this$0_, [((id<JavaUtilList>) nil_chk(self->this$0_->clauses_)) size]);
  ...
  while ([((id<JavaUtilIterator>) nil_chk(i)) hasNext]) {
    ...
    if (((target == -1) && [((OrgApacheLuceneSearchSpansSpans *) nil_chk(spans)) next]) || ((target != -1) && [((OrgApacheLuceneSearchSpansSpans *) nil_chk(spans)) skipToWithInt:target])) {
      (void) [((OrgApacheLuceneSearchSpansSpanOrQuery_SpanQueue *) nil_chk(self->queue_)) addWithId:spans];
    }
  }
