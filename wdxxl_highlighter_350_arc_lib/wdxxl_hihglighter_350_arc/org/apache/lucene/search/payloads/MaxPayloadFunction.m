...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/search/payloads/MaxPayloadFunction.java
//
...
- (OrgApacheLuceneSearchExplanation *)explainWithInt:(jint)doc
                                             withInt:(jint)numPayloadsSeen
                                           withFloat:(jfloat)payloadScore {
  OrgApacheLuceneSearchExplanation *expl = new_OrgApacheLuceneSearchExplanation_init();
