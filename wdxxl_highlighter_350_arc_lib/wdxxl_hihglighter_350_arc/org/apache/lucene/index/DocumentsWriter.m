...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DocumentsWriter.java
//
...
- (OrgApacheLuceneIndexDocumentsWriter_PerDocBuffer *)newPerDocBuffer {
  return new_OrgApacheLuceneIndexDocumentsWriter_PerDocBuffer_initWithOrgApacheLuceneIndexDocumentsWriter_(self);
}
...
- (void)setInfoStreamWithJavaIoPrintStream:(JavaIoPrintStream *)infoStream {
  @synchronized(self) {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(threadStates_))->size_; i++) {
      ((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(((OrgApacheLuceneIndexDocumentsWriterThreadState *) nil_chk(IOSObjectArray_Get(threadStates_, i)))->docState_))->infoStream_ = infoStream;
    }
  }
}
...
- (void)setSimilarityWithOrgApacheLuceneSearchSimilarity:(OrgApacheLuceneSearchSimilarity *)similarity {
  @synchronized(self) {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(threadStates_))->size_; i++) {
      ((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(((OrgApacheLuceneIndexDocumentsWriterThreadState *) nil_chk(IOSObjectArray_Get(threadStates_, i)))->docState_))->similarity_ = similarity;
    }
  }
}
...
- (OrgApacheLuceneIndexSegmentInfo *)flushWithOrgApacheLuceneIndexIndexWriter:(OrgApacheLuceneIndexIndexWriter *)writer
  ...
  @synchronized(self) {
    ...
    @try {
      ...
      newSegment = new_OrgApacheLuceneIndexSegmentInfo_initWithNSString_withInt_withOrgApacheLuceneStoreDirectory_withBoolean_withBoolean_withBoolean_withBoolean_(segment_, numDocs_, directory_, false, true, [((OrgApacheLuceneIndexFieldInfos *) nil_chk(fieldInfos_)) hasProx], false);
      id<JavaUtilCollection> threads = new_JavaUtilHashSet_init();
      {
        IOSObjectArray *a__ = threadStates_;
        OrgApacheLuceneIndexDocumentsWriterThreadState * const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
        OrgApacheLuceneIndexDocumentsWriterThreadState * const *e__ = b__ + a__->size_;
      ...
      if ([((OrgApacheLuceneIndexMergePolicy *) nil_chk(mergePolicy)) useCompoundFileWithOrgApacheLuceneIndexSegmentInfos:segmentInfos withOrgApacheLuceneIndexSegmentInfo:newSegment]) {
        ...
        OrgApacheLuceneIndexCompoundFileWriter *cfsWriter = new_OrgApacheLuceneIndexCompoundFileWriter_initWithOrgApacheLuceneStoreDirectory_withNSString_(directory_, cfsFileName);
  ...
  @synchronized(self) {
    ...
    if (state == nil) {
      ...
      if (minThreadState != nil && (minThreadState->numThreads_ == 0 || threadStates_->size_ >= maxThreadStates_)) {
        ...
        IOSObjectArray *newArray = [IOSObjectArray newArrayWithLength:1 + threadStates_->size_ type:OrgApacheLuceneIndexDocumentsWriterThreadState_class_()];
        ...
        threadStates_ = newArray;
      }
      (void) [threadBindings_ putWithId:currentThread withId:state];
    }
...
- (jboolean)updateDocumentWithOrgApacheLuceneDocumentDocument:(OrgApacheLuceneDocumentDocument *)doc
  ...
  ((OrgApacheLuceneIndexDocumentsWriter_DocState *) nil_chk(docState))->doc_ = doc;
  docState->analyzer_ = analyzer;
  jboolean success = false;
  @try {
...
- (IOSIntArray *)getIntBlock {
  @synchronized(self) {
    ...
    IOSIntArray *b;
    if (0 == size) {
      b = [IOSIntArray newArrayWithLength:OrgApacheLuceneIndexDocumentsWriter_INT_BLOCK_SIZE];
...
- (void)recycleIntBlocksWithIntArray2:(IOSObjectArray *)blocks
  ...
  @synchronized(self) {
    for (jint i = start; i < end; i++) {
      ...
      (void) IOSObjectArray_Set(blocks, i, nil);
    }
  }
}
...
- (IOSCharArray *)getCharBlock {
  @synchronized(self) {
    ...
    if (0 == size) {
      ...
      c = [IOSCharArray newArrayWithLength:OrgApacheLuceneIndexDocumentsWriter_CHAR_BLOCK_SIZE];
    }
    ...
    while ([self bytesUsed] + deletesRAMUsed > freeLevel) {
      @synchronized(self) {
        ...
        if ((0 == iter % 5) && [((JavaUtilArrayList *) nil_chk(((OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator *) nil_chk(byteBlockAllocator_))->freeByteBlocks_)) size] > 0) {
          (void) [((JavaUtilArrayList *) nil_chk(((OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator *) nil_chk(byteBlockAllocator_))->freeByteBlocks_)) removeWithInt:[byteBlockAllocator_->freeByteBlocks_ size] - 1];
        ...
        if ((1 == iter % 5) && [((JavaUtilArrayList *) nil_chk(freeCharBlocks_)) size] > 0) {
          (void) [((JavaUtilArrayList *) nil_chk(freeCharBlocks_)) removeWithInt:[freeCharBlocks_ size] - 1];
          [((JavaUtilConcurrentAtomicAtomicLong *) nil_chk(bytesUsed_)) addAndGetWithLong:-OrgApacheLuceneIndexDocumentsWriter_CHAR_BLOCK_SIZE * OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_CHAR];
        }
        if ((2 == iter % 5) && [((id<JavaUtilList>) nil_chk(freeIntBlocks_)) size] > 0) {
          (void) [((id<JavaUtilList>) nil_chk(freeIntBlocks_)) removeWithInt:[freeIntBlocks_ size] - 1];
          [((JavaUtilConcurrentAtomicAtomicLong *) nil_chk(bytesUsed_)) addAndGetWithLong:-OrgApacheLuceneIndexDocumentsWriter_INT_BLOCK_SIZE * OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_INT];
        }
        if ((3 == iter % 5) && [((JavaUtilArrayList *) nil_chk(perDocAllocator_->freeByteBlocks_)) size] > 0) {
          for (jint i = 0; i < 32; ++i) {
            (void) [((JavaUtilArrayList *) nil_chk(perDocAllocator_->freeByteBlocks_)) removeWithInt:[perDocAllocator_->freeByteBlocks_ size] - 1];
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexDocumentsWriter class]) {
    OrgApacheLuceneIndexDocumentsWriter_defaultIndexingChain = new_OrgApacheLuceneIndexDocumentsWriter_1_init();
...
void OrgApacheLuceneIndexDocumentsWriter_initWithOrgApacheLuceneIndexIndexWriterConfig_withOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexFieldInfos_withOrgApacheLuceneIndexBufferedDeletesStream_(OrgApacheLuceneIndexDocumentsWriter *self, OrgApacheLuceneIndexIndexWriterConfig *config, OrgApacheLuceneStoreDirectory *directory, OrgApacheLuceneIndexIndexWriter *writer, OrgApacheLuceneIndexFieldInfos *fieldInfos, OrgApacheLuceneIndexBufferedDeletesStream *bufferedDeletesStream) {
  NSObject_init(self);
  self->bytesUsed_ = new_JavaUtilConcurrentAtomicAtomicLong_initWithLong_(0);
  self->threadStates_ = [IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneIndexDocumentsWriterThreadState_class_()];
  self->threadBindings_ = new_JavaUtilHashMap_init();
  self->maxFieldLength_ = JreLoadStatic(OrgApacheLuceneIndexIndexWriter, DEFAULT_MAX_FIELD_LENGTH);
  self->pendingDeletes_ = new_OrgApacheLuceneIndexBufferedDeletes_init();
  self->skipDocWriter_ = new_OrgApacheLuceneIndexDocumentsWriter_SkipDocWriter_init();
  self->nf_ = JavaTextNumberFormat_getInstance();
  self->freeIntBlocks_ = new_JavaUtilArrayList_init();
  self->byteBlockAllocator_ = new_OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator_initWithOrgApacheLuceneIndexDocumentsWriter_withInt_(self, OrgApacheLuceneIndexDocumentsWriter_BYTE_BLOCK_SIZE);
  self->perDocAllocator_ = new_OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator_initWithOrgApacheLuceneIndexDocumentsWriter_withInt_(self, OrgApacheLuceneIndexDocumentsWriter_PER_DOC_BLOCK_SIZE);
  self->freeCharBlocks_ = new_JavaUtilArrayList_init();
  self->waitQueue_ = new_OrgApacheLuceneIndexDocumentsWriter_WaitQueue_initWithOrgApacheLuceneIndexDocumentsWriter_(self);
  self->directory_ = directory;
  self->writer_ = writer;
  self->similarity_ = [((OrgApacheLuceneIndexIndexWriterConfig *) nil_chk(config)) getSimilarity];
  self->maxThreadStates_ = [config getMaxThreadStates];
  self->fieldInfos_ = fieldInfos;
  self->bufferedDeletesStream_ = bufferedDeletesStream;
  self->flushControl_ = ((OrgApacheLuceneIndexIndexWriter *) nil_chk(writer))->flushControl_;
  self->consumer_ = [((OrgApacheLuceneIndexDocumentsWriter_IndexingChain *) nil_chk([config getIndexingChain])) getChainWithOrgApacheLuceneIndexDocumentsWriter:self];
  self->config_ = config;
}
...
void OrgApacheLuceneIndexDocumentsWriter_pushDeletesWithOrgApacheLuceneIndexSegmentInfo_withOrgApacheLuceneIndexSegmentInfos_(OrgApacheLuceneIndexDocumentsWriter *self, OrgApacheLuceneIndexSegmentInfo *newSegment, OrgApacheLuceneIndexSegmentInfos *segmentInfos) {
  ...
  if ([((OrgApacheLuceneIndexBufferedDeletes *) nil_chk(self->pendingDeletes_)) any]) {
    if ([((OrgApacheLuceneIndexSegmentInfos *) nil_chk(segmentInfos)) size] > 0 || newSegment != nil) {
      OrgApacheLuceneIndexFrozenBufferedDeletes *packet = new_OrgApacheLuceneIndexFrozenBufferedDeletes_initWithOrgApacheLuceneIndexBufferedDeletes_withLong_(self->pendingDeletes_, delGen);
...
- (OrgApacheLuceneIndexDocConsumer *)getChainWithOrgApacheLuceneIndexDocumentsWriter:(OrgApacheLuceneIndexDocumentsWriter *)documentsWriter {
  OrgApacheLuceneIndexTermsHashConsumer *termVectorsWriter = new_OrgApacheLuceneIndexTermVectorsTermsWriter_initWithOrgApacheLuceneIndexDocumentsWriter_(documentsWriter);
  OrgApacheLuceneIndexTermsHashConsumer *freqProxWriter = new_OrgApacheLuceneIndexFreqProxTermsWriter_init();
  OrgApacheLuceneIndexInvertedDocConsumer *termsHash = new_OrgApacheLuceneIndexTermsHash_initWithOrgApacheLuceneIndexDocumentsWriter_withBoolean_withOrgApacheLuceneIndexTermsHashConsumer_withOrgApacheLuceneIndexTermsHash_(documentsWriter, true, freqProxWriter, new_OrgApacheLuceneIndexTermsHash_initWithOrgApacheLuceneIndexDocumentsWriter_withBoolean_withOrgApacheLuceneIndexTermsHashConsumer_withOrgApacheLuceneIndexTermsHash_(documentsWriter, false, termVectorsWriter, nil));
  OrgApacheLuceneIndexNormsWriter *normsWriter = new_OrgApacheLuceneIndexNormsWriter_init();
  OrgApacheLuceneIndexDocInverter *docInverter = new_OrgApacheLuceneIndexDocInverter_initWithOrgApacheLuceneIndexInvertedDocConsumer_withOrgApacheLuceneIndexInvertedDocEndConsumer_(termsHash, normsWriter);
  return new_OrgApacheLuceneIndexDocFieldProcessor_initWithOrgApacheLuceneIndexDocumentsWriter_withOrgApacheLuceneIndexDocFieldConsumer_(documentsWriter, docInverter);
}
...
- (IOSByteArray *)getByteBlock {
  @synchronized(this$0_) {
    ...
    IOSByteArray *b;
    if (0 == size) {
      b = [IOSByteArray newArrayWithLength:blockSize_];
...
- (void)recycleByteBlocksWithJavaUtilList:(id<JavaUtilList>)blocks {
  @synchronized(this$0_) {
    ...
    for (jint i = 0; i < size; i++) {
      ...
      (void) [blocks setWithInt:i withId:nil];
    }
  }
}
...
void OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator_initWithOrgApacheLuceneIndexDocumentsWriter_withInt_(OrgApacheLuceneIndexDocumentsWriter_ByteBlockAllocator *self, OrgApacheLuceneIndexDocumentsWriter *outer$, jint blockSize) {
  ...
  self->freeByteBlocks_ = new_JavaUtilArrayList_init();
...
- (void)abort {
  @synchronized(self) {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(waiting_))->size_; i++) {
      ...
      if (doc != nil) {
        [doc abort];
        (void) IOSObjectArray_Set(nil_chk(waiting_), i, nil);
        count++;
      }
    }
    waitingBytes_ = 0;
  ...
  @synchronized(self) {
    ...
    if (doc->docID_ == nextWriteDocID_) {
      ...
      while (true) {
        ...
        if (doc != nil) {
          numWaiting_--;
          (void) IOSObjectArray_Set(waiting_, nextWriteLoc_, nil);
...
void OrgApacheLuceneIndexDocumentsWriter_WaitQueue_initWithOrgApacheLuceneIndexDocumentsWriter_(OrgApacheLuceneIndexDocumentsWriter_WaitQueue *self, OrgApacheLuceneIndexDocumentsWriter *outer$) {
  self->this$0_ = outer$;
  NSObject_init(self);
  self->waiting_ = [IOSObjectArray newArrayWithLength:10 type:OrgApacheLuceneIndexDocumentsWriter_DocWriter_class_()];
}
