...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermsHash.java
//
...
- (OrgApacheLuceneIndexInvertedDocConsumerPerThread *)addThreadWithOrgApacheLuceneIndexDocInverterPerThread:(OrgApacheLuceneIndexDocInverterPerThread *)docInverterPerThread {
  return new_OrgApacheLuceneIndexTermsHashPerThread_initWithOrgApacheLuceneIndexDocInverterPerThread_withOrgApacheLuceneIndexTermsHash_withOrgApacheLuceneIndexTermsHash_withOrgApacheLuceneIndexTermsHashPerThread_(docInverterPerThread, self, nextTermsHash_, nil);
}
...
- (OrgApacheLuceneIndexTermsHashPerThread *)addThreadWithOrgApacheLuceneIndexDocInverterPerThread:(OrgApacheLuceneIndexDocInverterPerThread *)docInverterPerThread
  ...
  return new_OrgApacheLuceneIndexTermsHashPerThread_initWithOrgApacheLuceneIndexDocInverterPerThread_withOrgApacheLuceneIndexTermsHash_withOrgApacheLuceneIndexTermsHash_withOrgApacheLuceneIndexTermsHashPerThread_(docInverterPerThread, self, nextTermsHash_, primaryPerThread);
}
...
withOrgApacheLuceneIndexSegmentWriteState:(OrgApacheLuceneIndexSegmentWriteState *)state {
  @synchronized(self) {
    id<JavaUtilMap> childThreadsAndFields = new_JavaUtilHashMap_init();
    id<JavaUtilMap> nextThreadsAndFields;
    if (nextTermsHash_ != nil) nextThreadsAndFields = new_JavaUtilHashMap_init();
    ...
    for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(threadsAndFields)) entrySet])) {
      ...
      id<JavaUtilCollection> childFields = new_JavaUtilHashSet_init();
      id<JavaUtilCollection> nextChildFields;
      if (nextTermsHash_ != nil) nextChildFields = new_JavaUtilHashSet_init();
      ...
      (void) [childThreadsAndFields putWithId:((OrgApacheLuceneIndexTermsHashPerThread *) nil_chk(perThread))->consumer_ withId:childFields];
      if (nextTermsHash_ != nil) (void) [((id<JavaUtilMap>) nil_chk(nextThreadsAndFields)) putWithId:perThread->nextPerThread_ withId:nextChildFields];
    }
...
void OrgApacheLuceneIndexTermsHash_initWithOrgApacheLuceneIndexDocumentsWriter_withBoolean_withOrgApacheLuceneIndexTermsHashConsumer_withOrgApacheLuceneIndexTermsHash_(OrgApacheLuceneIndexTermsHash *self, OrgApacheLuceneIndexDocumentsWriter *docWriter, jboolean trackAllocations, OrgApacheLuceneIndexTermsHashConsumer *consumer, OrgApacheLuceneIndexTermsHash *nextTermsHash) {
  ...
  self->nextTermsHash_ = nextTermsHash;
