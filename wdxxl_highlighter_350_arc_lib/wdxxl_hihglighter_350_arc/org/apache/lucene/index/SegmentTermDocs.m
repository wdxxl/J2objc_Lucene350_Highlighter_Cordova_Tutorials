...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/SegmentTermDocs.java
//
...
- (void)seekWithOrgApacheLuceneIndexTermInfo:(OrgApacheLuceneIndexTermInfo *)ti
  ...
  indexOptions_ = (fi != nil) ? ((OrgApacheLuceneIndexFieldInfo *) nil_chk(fi))->indexOptions_ : JreLoadEnum(OrgApacheLuceneIndexFieldInfo_IndexOptions, DOCS_AND_FREQS_AND_POSITIONS);
...
void OrgApacheLuceneIndexSegmentTermDocs_initWithOrgApacheLuceneIndexSegmentReader_(OrgApacheLuceneIndexSegmentTermDocs *self, OrgApacheLuceneIndexSegmentReader *parent) {
  ...
  self->doc_ = 0;
  self->parent_ = parent;
  self->freqStream_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(((OrgApacheLuceneIndexSegmentCoreReaders *) nil_chk(((OrgApacheLuceneIndexSegmentReader *) nil_chk(parent))->core_))->freqStream_)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
  @synchronized(parent) {
    self->deletedDocs_ = parent->deletedDocs_;
  }
