...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermInfosReader.java
//
...
- (OrgApacheLuceneIndexTermInfo *)getWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  OrgApacheLuceneUtilBytesRef *termBytesRef = new_OrgApacheLuceneUtilBytesRef_initWithJavaLangCharSequence_(((OrgApacheLuceneIndexTerm *) nil_chk(term))->text_);
...
- (OrgApacheLuceneIndexSegmentTermEnum *)termsWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  OrgApacheLuceneUtilBytesRef *termBytesRef = new_OrgApacheLuceneUtilBytesRef_initWithJavaLangCharSequence_(((OrgApacheLuceneIndexTerm *) nil_chk(term))->text_);
  (void) OrgApacheLuceneIndexTermInfosReader_getWithOrgApacheLuceneIndexTerm_withBoolean_withOrgApacheLuceneUtilBytesRef_(self, term, true, termBytesRef);
...
void OrgApacheLuceneIndexTermInfosReader_initWithOrgApacheLuceneStoreDirectory_withNSString_withOrgApacheLuceneIndexFieldInfos_withInt_withInt_(OrgApacheLuceneIndexTermInfosReader *self, OrgApacheLuceneStoreDirectory *dir, NSString *seg, OrgApacheLuceneIndexFieldInfos *fis, jint readBufferSize, jint indexDivisor) {
  NSObject_init(self);
  self->threadResources_ = new_OrgApacheLuceneUtilCloseableThreadLocal_init();
  self->termsCache_ = new_OrgApacheLuceneUtilDoubleBarrelLRUCache_initWithInt_(OrgApacheLuceneIndexTermInfosReader_DEFAULT_CACHE_SIZE);
  jboolean success = false;
  if (indexDivisor < 1 && indexDivisor != -1) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I", @"indexDivisor must be -1 (don't load terms index) or greater than 0: got ", indexDivisor));
  }
  @try {
    self->directory_ = dir;
    self->segment_ = seg;
    self->fieldInfos_ = fis;
    self->origEnum_ = new_OrgApacheLuceneIndexSegmentTermEnum_initWithOrgApacheLuceneStoreIndexInput_withOrgApacheLuceneIndexFieldInfos_withBoolean_([((OrgApacheLuceneStoreDirectory *) nil_chk(self->directory_)) openInputWithNSString:OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_(self->segment_, OrgApacheLuceneIndexIndexFileNames_TERMS_EXTENSION) withInt:readBufferSize], self->fieldInfos_, false);
    ...
    if (indexDivisor != -1) {
      ...
      OrgApacheLuceneIndexSegmentTermEnum *indexEnum = new_OrgApacheLuceneIndexSegmentTermEnum_initWithOrgApacheLuceneStoreIndexInput_withOrgApacheLuceneIndexFieldInfos_withBoolean_([self->directory_ openInputWithNSString:indexFileName withInt:readBufferSize], self->fieldInfos_, true);
      @try {
        self->index_ = new_OrgApacheLuceneIndexTermInfosReaderIndex_initWithOrgApacheLuceneIndexSegmentTermEnum_withInt_withLong_withInt_(indexEnum, indexDivisor, [((OrgApacheLuceneStoreDirectory *) nil_chk(dir)) fileLengthWithNSString:indexFileName], self->totalIndexInterval_);
...
OrgApacheLuceneIndexTermInfosReader_ThreadResources *OrgApacheLuceneIndexTermInfosReader_getThreadResources(OrgApacheLuceneIndexTermInfosReader *self) {
  ...
  if (resources == nil) {
    resources = new_OrgApacheLuceneIndexTermInfosReader_ThreadResources_init();
    resources->termEnum_ = [self terms];
...
OrgApacheLuceneIndexTermInfo *OrgApacheLuceneIndexTermInfosReader_getWithOrgApacheLuceneIndexTerm_withBoolean_withOrgApacheLuceneUtilBytesRef_(OrgApacheLuceneIndexTermInfosReader *self, OrgApacheLuceneIndexTerm *term, jboolean mustSeekEnum, OrgApacheLuceneUtilBytesRef *termBytesRef) {
  ...
  OrgApacheLuceneIndexTermInfosReader_ensureIndexIsRead(self);
  OrgApacheLuceneIndexTermInfosReader_CloneableTerm *cacheKey = new_OrgApacheLuceneIndexTermInfosReader_CloneableTerm_initWithOrgApacheLuceneIndexTerm_(term);
...
void OrgApacheLuceneIndexTermInfosReader_ensureIndexIsRead(OrgApacheLuceneIndexTermInfosReader *self) {
  if (self->index_ == nil) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(@"terms index was not loaded when this reader was created");
  }
}
...
- (id)java_clone {
  return new_OrgApacheLuceneIndexTermInfosReader_CloneableTerm_initWithOrgApacheLuceneIndexTerm_(term_);
}
...
void OrgApacheLuceneIndexTermInfosReader_CloneableTerm_initWithOrgApacheLuceneIndexTerm_(OrgApacheLuceneIndexTermInfosReader_CloneableTerm *self, OrgApacheLuceneIndexTerm *t) {
  ...
  self->term_ = new_OrgApacheLuceneIndexTerm_initWithNSString_withNSString_([((OrgApacheLuceneIndexTerm *) nil_chk(t)) field], [t text]);
}
