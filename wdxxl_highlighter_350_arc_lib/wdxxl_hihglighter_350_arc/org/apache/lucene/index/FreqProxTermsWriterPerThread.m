...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FreqProxTermsWriterPerThread.java
//
...
- (OrgApacheLuceneIndexTermsHashConsumerPerField *)addFieldWithOrgApacheLuceneIndexTermsHashPerField:(OrgApacheLuceneIndexTermsHashPerField *)termsHashPerField
  ...
  return new_OrgApacheLuceneIndexFreqProxTermsWriterPerField_initWithOrgApacheLuceneIndexTermsHashPerField_withOrgApacheLuceneIndexFreqProxTermsWriterPerThread_withOrgApacheLuceneIndexFieldInfo_(termsHashPerField, self, fieldInfo);
}
...
void OrgApacheLuceneIndexFreqProxTermsWriterPerThread_initWithOrgApacheLuceneIndexTermsHashPerThread_(OrgApacheLuceneIndexFreqProxTermsWriterPerThread *self, OrgApacheLuceneIndexTermsHashPerThread *perThread) {
  ...
  self->docState_ = ((OrgApacheLuceneIndexTermsHashPerThread *) nil_chk(perThread))->docState_;
  self->termsHashPerThread_ = perThread;
}
