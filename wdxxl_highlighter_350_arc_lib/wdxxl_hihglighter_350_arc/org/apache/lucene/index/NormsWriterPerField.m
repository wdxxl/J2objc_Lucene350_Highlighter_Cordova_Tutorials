...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/NormsWriterPerField.java
//
...
- (void)reset {
  docIDs_ = OrgApacheLuceneUtilArrayUtil_shrinkWithIntArray_withInt_(docIDs_, upto_);
  norms_ = OrgApacheLuceneUtilArrayUtil_shrinkWithByteArray_withInt_(norms_, upto_);
  upto_ = 0;
}
...
- (jint)compareToWithId:(OrgApacheLuceneIndexNormsWriterPerField *)other {
  (void) cast_chk(other, [OrgApacheLuceneIndexNormsWriterPerField class]);
...
void OrgApacheLuceneIndexNormsWriterPerField_initWithOrgApacheLuceneIndexDocInverterPerField_withOrgApacheLuceneIndexNormsWriterPerThread_withOrgApacheLuceneIndexFieldInfo_(OrgApacheLuceneIndexNormsWriterPerField *self, OrgApacheLuceneIndexDocInverterPerField *docInverterPerField, OrgApacheLuceneIndexNormsWriterPerThread *perThread, OrgApacheLuceneIndexFieldInfo *fieldInfo) {
  ...
  self->docIDs_ = [IOSIntArray newArrayWithLength:1];
  self->norms_ = [IOSByteArray newArrayWithLength:1];
  self->perThread_ = perThread;
  self->fieldInfo_ = fieldInfo;
  self->docState_ = ((OrgApacheLuceneIndexNormsWriterPerThread *) nil_chk(perThread))->docState_;
