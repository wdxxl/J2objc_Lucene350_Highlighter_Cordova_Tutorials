...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DocumentsWriterThreadState.java
//
...
void OrgApacheLuceneIndexDocumentsWriterThreadState_initWithOrgApacheLuceneIndexDocumentsWriter_(OrgApacheLuceneIndexDocumentsWriterThreadState *self, OrgApacheLuceneIndexDocumentsWriter *docWriter) {
  ...
  self->docState_ = new_OrgApacheLuceneIndexDocumentsWriter_DocState_init();
  self->docState_->maxFieldLength_ = ((OrgApacheLuceneIndexDocumentsWriter *) nil_chk(docWriter))->maxFieldLength_;
  self->docState_->infoStream_ = docWriter->infoStream_;
  self->docState_->similarity_ = docWriter->similarity_;
  self->docState_->docWriter_ = docWriter;
  self->consumer_ = [((OrgApacheLuceneIndexDocConsumer *) nil_chk(docWriter->consumer_)) addThreadWithOrgApacheLuceneIndexDocumentsWriterThreadState:self];
}
