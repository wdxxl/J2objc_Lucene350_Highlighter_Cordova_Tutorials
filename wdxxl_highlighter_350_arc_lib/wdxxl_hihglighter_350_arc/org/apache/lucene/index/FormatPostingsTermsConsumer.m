...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/FormatPostingsTermsConsumer.java
//
...
- (OrgApacheLuceneIndexFormatPostingsDocsConsumer *)addTermWithNSString:(NSString *)text {
  ...
  if (termBuffer_ == nil || termBuffer_->size_ < 1 + len) termBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(1 + len, OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_CHAR)];
