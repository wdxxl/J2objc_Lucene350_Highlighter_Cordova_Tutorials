...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DefaultSkipListReader.java
//
...
void OrgApacheLuceneIndexDefaultSkipListReader_initWithOrgApacheLuceneStoreIndexInput_withInt_withInt_(OrgApacheLuceneIndexDefaultSkipListReader *self, OrgApacheLuceneStoreIndexInput *skipStream, jint maxSkipLevels, jint skipInterval) {
  ...
  self->freqPointer_ = [IOSLongArray newArrayWithLength:maxSkipLevels];
  self->proxPointer_ = [IOSLongArray newArrayWithLength:maxSkipLevels];
  self->payloadLength_ = [IOSIntArray newArrayWithLength:maxSkipLevels];
}
