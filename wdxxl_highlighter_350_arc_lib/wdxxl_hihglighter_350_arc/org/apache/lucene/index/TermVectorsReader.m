...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TermVectorsReader.java
//
...
- (void)rawDocsWithIntArray:(IOSIntArray *)tvdLengths
  ...
  if (format_ < OrgApacheLuceneIndexTermVectorsReader_FORMAT_VERSION2) @throw new_JavaLangIllegalStateException_initWithNSString_(@"cannot read raw docs with older term vector formats");
...
- (id<OrgApacheLuceneIndexTermFreqVector>)getWithInt:(jint)docNum
                                        withNSString:(NSString *)field {
  OrgApacheLuceneIndexParallelArrayTermVectorMapper *mapper = new_OrgApacheLuceneIndexParallelArrayTermVectorMapper_init();
...
- (id)java_clone {
  ...
  if (tvx_ != nil && tvd_ != nil && tvf_ != nil) {
    ((OrgApacheLuceneIndexTermVectorsReader *) nil_chk(clone))->tvx_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([tvx_ java_clone], [OrgApacheLuceneStoreIndexInput class]);
    clone->tvd_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(tvd_)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
    clone->tvf_ = (OrgApacheLuceneStoreIndexInput *) cast_chk([((OrgApacheLuceneStoreIndexInput *) nil_chk(tvf_)) java_clone], [OrgApacheLuceneStoreIndexInput class]);
  }
  return clone;
}
...
void OrgApacheLuceneIndexTermVectorsReader_initWithOrgApacheLuceneStoreDirectory_withNSString_withOrgApacheLuceneIndexFieldInfos_withInt_withInt_withInt_(OrgApacheLuceneIndexTermVectorsReader *self, OrgApacheLuceneStoreDirectory *d, NSString *segment, OrgApacheLuceneIndexFieldInfos *fieldInfos, jint readBufferSize, jint docStoreOffset, jint size) {
  ...
  @try {
    ...
    self->tvx_ = [((OrgApacheLuceneStoreDirectory *) nil_chk(d)) openInputWithNSString:idxName withInt:readBufferSize];
    ...
    self->tvd_ = [d openInputWithNSString:fn withInt:readBufferSize];
...
jint OrgApacheLuceneIndexTermVectorsReader_checkValidFormatWithNSString_withOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneIndexTermVectorsReader *self, NSString *fn, OrgApacheLuceneStoreIndexInput *inArg) {
  ...
  if (format > OrgApacheLuceneIndexTermVectorsReader_FORMAT_CURRENT) {
    @throw new_OrgApacheLuceneIndexIndexFormatTooNewException_initWithOrgApacheLuceneStoreDataInput_withInt_withInt_withInt_(inArg, format, 1, OrgApacheLuceneIndexTermVectorsReader_FORMAT_CURRENT);
  }
  return format;
}
...
IOSObjectArray *OrgApacheLuceneIndexTermVectorsReader_readFieldsWithInt_(OrgApacheLuceneIndexTermVectorsReader *self, jint fieldCount) {
  jint number = 0;
  IOSObjectArray *fields = [IOSObjectArray newArrayWithLength:fieldCount type:NSString_class_()];
  for (jint i = 0; i < fieldCount; i++) {
    ...
    (void) IOSObjectArray_Set(fields, i, [((OrgApacheLuceneIndexFieldInfos *) nil_chk(self->fieldInfos_)) fieldNameWithInt:number]);
  }
  return fields;
}
...
IOSLongArray *OrgApacheLuceneIndexTermVectorsReader_readTvfPointersWithInt_(OrgApacheLuceneIndexTermVectorsReader *self, jint fieldCount) {
  ...
  IOSLongArray *tvfPointers = [IOSLongArray newArrayWithLength:fieldCount];
...
IOSObjectArray *OrgApacheLuceneIndexTermVectorsReader_readTermVectorsWithInt_withNSStringArray_withLongArray_(OrgApacheLuceneIndexTermVectorsReader *self, jint docNum, IOSObjectArray *fields, IOSLongArray *tvfPointers) {
  IOSObjectArray *res = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(fields))->size_ type:OrgApacheLuceneIndexSegmentTermVector_class_()];
  for (jint i = 0; i < fields->size_; i++) {
    ...
    (void) IOSObjectArray_Set(res, i, (OrgApacheLuceneIndexSegmentTermVector *) cast_chk([mapper materializeVector], [OrgApacheLuceneIndexSegmentTermVector class]));
  }
  return res;
}
...
void OrgApacheLuceneIndexTermVectorsReader_readTermVectorWithNSString_withLong_withOrgApacheLuceneIndexTermVectorMapper_(OrgApacheLuceneIndexTermVectorsReader *self, NSString *field, jlong tvfPointer, OrgApacheLuceneIndexTermVectorMapper *mapper) {
  ...
  if (preUTF8) {
    charBuffer = [IOSCharArray newArrayWithLength:10];
    byteBuffer = nil;
  }
  else {
    charBuffer = nil;
    byteBuffer = [IOSByteArray newArrayWithLength:20];
  }
  for (jint i = 0; i < numTerms; i++) {
    ...
    if (storePositions) {
      if ([mapper isIgnoringPositions] == false) {
        positions = [IOSIntArray newArrayWithLength:freq];
        jint prevPosition = 0;
    ...
    if (storeOffsets) {
      if ([mapper isIgnoringOffsets] == false) {
        offsets = [IOSObjectArray newArrayWithLength:freq type:OrgApacheLuceneIndexTermVectorOffsetInfo_class_()];
        jint prevOffset = 0;
        for (jint j = 0; j < freq; j++) {
          ...
          (void) IOSObjectArray_SetAndConsume(offsets, j, new_OrgApacheLuceneIndexTermVectorOffsetInfo_initWithInt_withInt_(startOffset, endOffset));
...
- (void)setExpectationsWithNSString:(NSString *)field
  ...
  self->field_ = field;
  terms_ = [IOSObjectArray newArrayWithLength:numTerms type:NSString_class_()];
  termFreqs_ = [IOSIntArray newArrayWithLength:numTerms];
  self->storingOffsets_ = storeOffsets;
  self->storingPositions_ = storePositions;
  if (storePositions) self->positions_ = [IOSObjectArray newArrayWithLength:numTerms type:IOSClass_intArray(1)];
  if (storeOffsets) self->offsets_ = [IOSObjectArray newArrayWithLength:numTerms type:IOSClass_arrayType(OrgApacheLuceneIndexTermVectorOffsetInfo_class_(), 1)];
}
...
withOrgApacheLuceneIndexTermVectorOffsetInfoArray:(IOSObjectArray *)offsets
  ...
  (void) IOSObjectArray_Set(nil_chk(terms_), currentPosition_, term);
  *IOSIntArray_GetRef(nil_chk(termFreqs_), currentPosition_) = frequency;
  if (storingOffsets_) {
    (void) IOSObjectArray_Set(nil_chk(self->offsets_), currentPosition_, offsets);
  }
  if (storingPositions_) {
    (void) IOSObjectArray_Set(nil_chk(self->positions_), currentPosition_, positions);
  }
  currentPosition_++;
}
...
- (id<OrgApacheLuceneIndexTermFreqVector>)materializeVector {
  ...
  if (field_ != nil && terms_ != nil) {
    if (storingPositions_ || storingOffsets_) {
      tv = new_OrgApacheLuceneIndexSegmentTermPositionVector_initWithNSString_withNSStringArray_withIntArray_withIntArray2_withOrgApacheLuceneIndexTermVectorOffsetInfoArray2_(field_, terms_, termFreqs_, positions_, offsets_);
    }
    else {
      tv = new_OrgApacheLuceneIndexSegmentTermVector_initWithNSString_withNSStringArray_withIntArray_(field_, terms_, termFreqs_);
    }
  }
  return tv;
}
