...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/Payload.java
//
...
- (IOSByteArray *)toByteArray {
  IOSByteArray *retArray = [IOSByteArray newArrayWithLength:self->length_];
...
- (id)java_clone {
  @try {
    ...
    if (offset_ == 0 && length_ == ((IOSByteArray *) nil_chk(data_))->size_) {
      ((OrgApacheLuceneIndexPayload *) nil_chk(clone))->data_ = [((IOSByteArray *) nil_chk(data_)) java_clone];
    }
    else {
      ((OrgApacheLuceneIndexPayload *) nil_chk(clone))->data_ = [self toByteArray];
      clone->offset_ = 0;
    }
    return clone;
  }
