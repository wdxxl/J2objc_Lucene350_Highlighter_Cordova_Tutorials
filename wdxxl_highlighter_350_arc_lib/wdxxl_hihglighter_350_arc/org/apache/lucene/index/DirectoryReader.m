...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/DirectoryReader.java
//
...
- (NSString *)description {
  ...
  (void) [buffer appendWithNSString:[[self java_getClass] getSimpleName]];
  ...
  if (segmentsFile != nil) {
    (void) [buffer appendWithNSString:segmentsFile];
  }
  if (writer_ != nil) {
    (void) [buffer appendWithNSString:@":nrt"];
  }
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(subReaders_))->size_; i++) {
    (void) [buffer appendWithChar:' '];
    (void) [buffer appendWithId:IOSObjectArray_Get(nil_chk(subReaders_), i)];
  }
  (void) [buffer appendWithChar:')'];
...
- (IOSByteArray *)normsWithNSString:(NSString *)field {
  @synchronized(self) {
    ...
    bytes = [IOSByteArray newArrayWithLength:[self maxDoc]];
    ...
    (void) [((id<JavaUtilMap>) nil_chk(normsCache_)) putWithId:field withId:bytes];
    return bytes;
  }
}
...
- (void)doSetNormWithInt:(jint)n
  ...
  @synchronized(normsCache_) {
    (void) [((id<JavaUtilMap>) nil_chk(normsCache_)) removeWithId:field];
  }
  jint i = OrgApacheLuceneIndexDirectoryReader_readerIndexWithInt_(self, n);
...
- (OrgApacheLuceneIndexTermEnum *)terms {
  ...
  if (((IOSObjectArray *) nil_chk(subReaders_))->size_ == 1) {
    ...
    return new_OrgApacheLuceneIndexDirectoryReader_MultiTermEnum_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_withOrgApacheLuceneIndexTerm_(self, subReaders_, starts_, nil);
  }
}
...
- (OrgApacheLuceneIndexTermEnum *)termsWithOrgApacheLuceneIndexTerm:(OrgApacheLuceneIndexTerm *)term {
  ...
  if (((IOSObjectArray *) nil_chk(subReaders_))->size_ == 1) {
    ...
    return new_OrgApacheLuceneIndexDirectoryReader_MultiTermEnum_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_withOrgApacheLuceneIndexTerm_(self, subReaders_, starts_, term);
  }
}
...
- (id<OrgApacheLuceneIndexTermDocs>)termDocs {
  ...
  if (((IOSObjectArray *) nil_chk(subReaders_))->size_ == 1) {
    ...
    return new_OrgApacheLuceneIndexDirectoryReader_MultiTermDocs_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_(self, subReaders_, starts_);
  }
}
...
- (id<OrgApacheLuceneIndexTermPositions>)termPositions {
  ...
  if (((IOSObjectArray *) nil_chk(subReaders_))->size_ == 1) {
    ...
    return new_OrgApacheLuceneIndexDirectoryReader_MultiTermPositions_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_(self, subReaders_, starts_);
  }
}
...
- (void)acquireWriteLock {
  ...
  if (segmentInfos_ != nil) {
    [self ensureOpen];
    if (stale_) @throw new_OrgApacheLuceneIndexStaleReaderException_initWithNSString_(@"IndexReader out of date and no longer valid for delete, undelete, or setNorm operations");
    if (writeLock_ == nil) {
      ...
      if (![((OrgApacheLuceneStoreLock *) nil_chk(writeLock)) obtainWithLong:JreLoadStatic(OrgApacheLuceneIndexIndexWriterConfig, WRITE_LOCK_TIMEOUT)]) @throw new_OrgApacheLuceneStoreLockObtainFailedException_initWithNSString_(JreStrcat("$@", @"Index locked for write: ", writeLock));
      ...
      if (OrgApacheLuceneIndexSegmentInfos_readCurrentVersionWithOrgApacheLuceneStoreDirectory_(directory_) > maxIndexVersion_) {
        ...
        self->writeLock_ = nil;
        @throw new_OrgApacheLuceneIndexStaleReaderException_initWithNSString_(@"IndexReader out of date and no longer valid for delete, undelete, or setNorm operations");
      }
    }
  }
}
...
- (void)doCommitWithJavaUtilMap:(id<JavaUtilMap>)commitUserData {
  if (hasChanges_) {
    ...
    OrgApacheLuceneIndexIndexFileDeleter *deleter = new_OrgApacheLuceneIndexIndexFileDeleter_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexDeletionPolicy_withOrgApacheLuceneIndexSegmentInfos_withJavaIoPrintStream_withOrgApacheLuceneIndexIndexWriter_(directory_, deletionPolicy_ == nil ? new_OrgApacheLuceneIndexKeepOnlyLastCommitDeletionPolicy_init() : deletionPolicy_, segmentInfos_, nil, nil);
...
- (OrgApacheLuceneIndexIndexCommit *)getIndexCommit {
  [self ensureOpen];
  return new_OrgApacheLuceneIndexDirectoryReader_ReaderCommit_initWithOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneStoreDirectory_(segmentInfos_, directory_);
}
...
OrgApacheLuceneIndexIndexReader *OrgApacheLuceneIndexDirectoryReader_openWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexIndexDeletionPolicy_withOrgApacheLuceneIndexIndexCommit_withBoolean_withInt_(OrgApacheLuceneStoreDirectory *directory, id<OrgApacheLuceneIndexIndexDeletionPolicy> deletionPolicy, OrgApacheLuceneIndexIndexCommit *commit, jboolean readOnly, jint termInfosIndexDivisor) {
  ...
  return (OrgApacheLuceneIndexIndexReader *) cast_chk([new_OrgApacheLuceneIndexDirectoryReader_1_initWithBoolean_withOrgApacheLuceneIndexIndexDeletionPolicy_withInt_withOrgApacheLuceneStoreDirectory_(readOnly, deletionPolicy, termInfosIndexDivisor, directory) runWithOrgApacheLuceneIndexIndexCommit:commit], [OrgApacheLuceneIndexIndexReader class]);
}
...
void OrgApacheLuceneIndexDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexIndexDeletionPolicy_withBoolean_withInt_withJavaUtilCollection_(OrgApacheLuceneIndexDirectoryReader *self, OrgApacheLuceneStoreDirectory *directory, OrgApacheLuceneIndexSegmentInfos *sis, id<OrgApacheLuceneIndexIndexDeletionPolicy> deletionPolicy, jboolean readOnly, jint termInfosIndexDivisor, id<JavaUtilCollection> readerFinishedListeners) {
  ...
  self->normsCache_ = new_JavaUtilHashMap_init();
  self->maxDoc_ = 0;
  self->numDocs_ = -1;
  self->hasDeletions_ = false;
  self->directory_ = directory;
  self->readOnly_ = readOnly;
  self->segmentInfos_ = sis;
  self->deletionPolicy_ = deletionPolicy;
  ...
  IOSObjectArray *readers = [IOSObjectArray newArrayWithLength:[((OrgApacheLuceneIndexSegmentInfos *) nil_chk(sis)) size] type:OrgApacheLuceneIndexSegmentReader_class_()];
  for (jint i = [sis size] - 1; i >= 0; i--) {
    jboolean success = false;
    @try {
      (void) IOSObjectArray_Set(readers, i, OrgApacheLuceneIndexSegmentReader_getWithBoolean_withOrgApacheLuceneIndexSegmentInfo_withInt_(readOnly, [sis infoWithInt:i], termInfosIndexDivisor));
      (void) JreVolatileStrongAssign(&((OrgApacheLuceneIndexSegmentReader *) nil_chk(IOSObjectArray_Get(readers, i)))->readerFinishedListeners_, JreLoadVolatileId(&self->readerFinishedListeners_));
      success = true;
    }
    @finally {
      if (!success) {
...
void OrgApacheLuceneIndexDirectoryReader_initWithOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexSegmentInfos_withInt_withBoolean_(OrgApacheLuceneIndexDirectoryReader *self, OrgApacheLuceneIndexIndexWriter *writer, OrgApacheLuceneIndexSegmentInfos *infos, jint termInfosIndexDivisor, jboolean applyAllDeletes) {
  ...
  self->numDocs_ = -1;
  self->hasDeletions_ = false;
  self->directory_ = [((OrgApacheLuceneIndexIndexWriter *) nil_chk(writer)) getDirectory];
  self->readOnly_ = true;
  self->applyAllDeletes_ = applyAllDeletes;
  self->termInfosIndexDivisor_ = termInfosIndexDivisor;
  (void) JreVolatileStrongAssign(&self->readerFinishedListeners_, [writer getReaderFinishedListeners]);
  jint numSegments = [((OrgApacheLuceneIndexSegmentInfos *) nil_chk(infos)) size];
  id<JavaUtilList> readers = new_JavaUtilArrayList_init();
  OrgApacheLuceneStoreDirectory *dir = [writer getDirectory];
  self->segmentInfos_ = (OrgApacheLuceneIndexSegmentInfos *) cast_chk([infos java_clone], [OrgApacheLuceneIndexSegmentInfos class]);
  jint infosUpto = 0;
  ...
  self->writer_ = writer;
  OrgApacheLuceneIndexDirectoryReader_initialize__WithOrgApacheLuceneIndexSegmentReaderArray_(self, [readers toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[readers size] type:OrgApacheLuceneIndexSegmentReader_class_()]]);
}
...
void OrgApacheLuceneIndexDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexSegmentReaderArray_withIntArray_withJavaUtilMap_withBoolean_withBoolean_withInt_withJavaUtilCollection_(OrgApacheLuceneIndexDirectoryReader *self, OrgApacheLuceneStoreDirectory *directory, OrgApacheLuceneIndexSegmentInfos *infos, IOSObjectArray *oldReaders, IOSIntArray *oldStarts, id<JavaUtilMap> oldNormsCache, jboolean readOnly, jboolean doClone, jint termInfosIndexDivisor, id<JavaUtilCollection> readerFinishedListeners) {
  ...
  if (oldReaders != nil) {
    for (jint i = 0; i < oldReaders->size_; i++) {
      (void) [segmentReaders putWithId:[((OrgApacheLuceneIndexSegmentReader *) nil_chk(IOSObjectArray_Get(oldReaders, i))) getSegmentName] withId:JavaLangInteger_valueOfWithInt_(i)];
    }
  }
  IOSObjectArray *newReaders = [IOSObjectArray newArrayWithLength:[((OrgApacheLuceneIndexSegmentInfos *) nil_chk(infos)) size] type:OrgApacheLuceneIndexSegmentReader_class_()];
  IOSBooleanArray *readerShared = [IOSBooleanArray newArrayWithLength:[infos size]];
  for (jint i = [infos size] - 1; i >= 0; i--) {
    ...
    if (oldReaderIndex == nil) {
      (void) IOSObjectArray_Set(newReaders, i, nil);
    }
    else {
      (void) IOSObjectArray_Set(newReaders, i, IOSObjectArray_Get(nil_chk(oldReaders), [oldReaderIndex intValue]));
    }
    jboolean success = false;
    @try {
  ...
  if (oldNormsCache != nil) {
    for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([oldNormsCache entrySet])) {
      ...
      IOSByteArray *bytes = [IOSByteArray newArrayWithLength:[self maxDoc]];
      ...
      (void) [((id<JavaUtilMap>) nil_chk(self->normsCache_)) putWithId:field withId:bytes];
    }
  }
}
...
void OrgApacheLuceneIndexDirectoryReader_initialize__WithOrgApacheLuceneIndexSegmentReaderArray_(OrgApacheLuceneIndexDirectoryReader *self, IOSObjectArray *subReaders) {
  self->subReaders_ = subReaders;
  self->starts_ = [IOSIntArray newArrayWithLength:((IOSObjectArray *) nil_chk(subReaders))->size_ + 1];
...
OrgApacheLuceneIndexIndexReader *OrgApacheLuceneIndexDirectoryReader_cloneWithBoolean_(OrgApacheLuceneIndexDirectoryReader *self, jboolean openReadOnly) {
  @synchronized(self) {
    ...
    if (self != newReader) {
      ((OrgApacheLuceneIndexDirectoryReader *) nil_chk(newReader))->deletionPolicy_ = self->deletionPolicy_;
    }
...
OrgApacheLuceneIndexIndexReader *OrgApacheLuceneIndexDirectoryReader_doOpenFromWriterWithBoolean_withOrgApacheLuceneIndexIndexCommit_(OrgApacheLuceneIndexDirectoryReader *self, jboolean openReadOnly, OrgApacheLuceneIndexIndexCommit *commit) {
  ...
  if (commit != nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"a reader obtained from IndexWriter.getReader() cannot currently accept a commit");
  }
  ...
  @synchronized(self) {
    if (commit == nil) {
      ...
      if (self->directory_ != [commit getDirectory]) {
        @throw new_JavaIoIOException_initWithNSString_(@"the specified commit does not match the specified Directory");
      }
    ...
    return (OrgApacheLuceneIndexIndexReader *) cast_chk([new_OrgApacheLuceneIndexDirectoryReader_2_initWithOrgApacheLuceneIndexDirectoryReader_withBoolean_withOrgApacheLuceneStoreDirectory_(self, openReadOnly, self->directory_) runWithOrgApacheLuceneIndexIndexCommit:commit], [OrgApacheLuceneIndexIndexReader class]);
  }
}
...
OrgApacheLuceneIndexDirectoryReader *OrgApacheLuceneIndexDirectoryReader_doOpenIfChangedWithOrgApacheLuceneIndexSegmentInfos_withBoolean_withBoolean_(OrgApacheLuceneIndexDirectoryReader *self, OrgApacheLuceneIndexSegmentInfos *infos, jboolean doClone, jboolean openReadOnly) {
  @synchronized(self) {
    ...
    if (openReadOnly) {
      reader = new_OrgApacheLuceneIndexReadOnlyDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexSegmentReaderArray_withIntArray_withJavaUtilMap_withBoolean_withInt_withJavaUtilCollection_(self->directory_, infos, self->subReaders_, self->starts_, self->normsCache_, doClone, self->termInfosIndexDivisor_, JreLoadVolatileId(&self->readerFinishedListeners_));
    }
    else {
      reader = new_OrgApacheLuceneIndexDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexSegmentReaderArray_withIntArray_withJavaUtilMap_withBoolean_withBoolean_withInt_withJavaUtilCollection_(self->directory_, infos, self->subReaders_, self->starts_, self->normsCache_, false, doClone, self->termInfosIndexDivisor_, JreLoadVolatileId(&self->readerFinishedListeners_));
    }
    return reader;
  }
}
...
id<JavaUtilCollection> OrgApacheLuceneIndexDirectoryReader_getFieldNamesWithOrgApacheLuceneIndexIndexReader_FieldOption_withOrgApacheLuceneIndexIndexReaderArray_(OrgApacheLuceneIndexIndexReader_FieldOption *fieldNames, IOSObjectArray *subReaders) {
  OrgApacheLuceneIndexDirectoryReader_initialize();
  id<JavaUtilSet> fieldSet = new_JavaUtilHashSet_init();
  {
...
id<JavaUtilCollection> OrgApacheLuceneIndexDirectoryReader_listCommitsWithOrgApacheLuceneStoreDirectory_(OrgApacheLuceneStoreDirectory *dir) {
  ...
  id<JavaUtilList> commits = new_JavaUtilArrayList_init();
  OrgApacheLuceneIndexSegmentInfos *latest = new_OrgApacheLuceneIndexSegmentInfos_init();
  [latest readWithOrgApacheLuceneStoreDirectory:dir];
  jlong currentGen = [latest getGeneration];
  [commits addWithId:new_OrgApacheLuceneIndexDirectoryReader_ReaderCommit_initWithOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneStoreDirectory_(latest, dir)];
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(files))->size_; i++) {
    ...
    if ([((NSString *) nil_chk(fileName)) java_hasPrefix:OrgApacheLuceneIndexIndexFileNames_SEGMENTS] && ![fileName isEqual:OrgApacheLuceneIndexIndexFileNames_SEGMENTS_GEN] && OrgApacheLuceneIndexSegmentInfos_generationFromSegmentsFileNameWithNSString_(fileName) < currentGen) {
      ...
      if (sis != nil) [commits addWithId:new_OrgApacheLuceneIndexDirectoryReader_ReaderCommit_initWithOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneStoreDirectory_(sis, dir)];
    }
  }
...
- (id)doBodyWithNSString:(NSString *)segmentFileName {
  OrgApacheLuceneIndexSegmentInfos *infos = new_OrgApacheLuceneIndexSegmentInfos_init();
  [infos readWithOrgApacheLuceneStoreDirectory:directory_ withNSString:segmentFileName];
  if (val$readOnly_) return new_OrgApacheLuceneIndexReadOnlyDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexIndexDeletionPolicy_withInt_withJavaUtilCollection_(directory_, infos, val$deletionPolicy_, val$termInfosIndexDivisor_, nil);
  else return new_OrgApacheLuceneIndexDirectoryReader_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneIndexIndexDeletionPolicy_withBoolean_withInt_withJavaUtilCollection_(directory_, infos, val$deletionPolicy_, false, val$termInfosIndexDivisor_, nil);
}
...
void OrgApacheLuceneIndexDirectoryReader_1_initWithBoolean_withOrgApacheLuceneIndexIndexDeletionPolicy_withInt_withOrgApacheLuceneStoreDirectory_(OrgApacheLuceneIndexDirectoryReader_1 *self, jboolean capture$0, id<OrgApacheLuceneIndexIndexDeletionPolicy> capture$1, jint capture$2, OrgApacheLuceneStoreDirectory *directory) {
  ...
  self->val$deletionPolicy_ = capture$1;
...
- (void)delete__ {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This IndexCommit does not support deletions");
}
...
void OrgApacheLuceneIndexDirectoryReader_ReaderCommit_initWithOrgApacheLuceneIndexSegmentInfos_withOrgApacheLuceneStoreDirectory_(OrgApacheLuceneIndexDirectoryReader_ReaderCommit *self, OrgApacheLuceneIndexSegmentInfos *infos, OrgApacheLuceneStoreDirectory *dir) {
  ...
  self->segmentsFileName_ = [((OrgApacheLuceneIndexSegmentInfos *) nil_chk(infos)) getCurrentSegmentFileName];
  self->dir_ = dir;
  self->userData_ = [infos getUserData];
  self->files_ = JavaUtilCollections_unmodifiableCollectionWithJavaUtilCollection_([infos filesWithOrgApacheLuceneStoreDirectory:dir withBoolean:true]);
...
- (jboolean)next {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(matchingSegments_))->size_; i++) {
    ...
    if (smi == nil) break;
    if ([smi next]) (void) [((OrgApacheLuceneIndexSegmentMergeQueue *) nil_chk(queue_)) addWithId:smi];
    else [smi close];
  }
  jint numMatchingSegments = 0;
  (void) IOSObjectArray_Set(matchingSegments_, 0, nil);
  ...
  while (top != nil && [((OrgApacheLuceneIndexTerm *) nil_chk(term_)) compareToWithId:top->term_] == 0) {
    (void) IOSObjectArray_Set(matchingSegments_, numMatchingSegments++, top);
    (void) [((OrgApacheLuceneIndexSegmentMergeQueue *) nil_chk(queue_)) pop];
  ...
  (void) IOSObjectArray_Set(matchingSegments_, numMatchingSegments, nil);
  return true;
}
...
void OrgApacheLuceneIndexDirectoryReader_MultiTermEnum_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_withOrgApacheLuceneIndexTerm_(OrgApacheLuceneIndexDirectoryReader_MultiTermEnum *self, OrgApacheLuceneIndexIndexReader *topReader, IOSObjectArray *readers, IOSIntArray *starts, OrgApacheLuceneIndexTerm *t) {
  ...
  self->topReader_ = topReader;
  self->queue_ = new_OrgApacheLuceneIndexSegmentMergeQueue_initWithInt_(((IOSObjectArray *) nil_chk(readers))->size_);
  self->matchingSegments_ = [IOSObjectArray newArrayWithLength:readers->size_ + 1 type:OrgApacheLuceneIndexSegmentMergeInfo_class_()];
  for (jint i = 0; i < readers->size_; i++) {
    ...
    OrgApacheLuceneIndexSegmentMergeInfo *smi = new_OrgApacheLuceneIndexSegmentMergeInfo_initWithInt_withOrgApacheLuceneIndexTermEnum_withOrgApacheLuceneIndexIndexReader_(IOSIntArray_Get(nil_chk(starts), i), termEnum, reader);
    smi->ord_ = i;
    if (t == nil ? [smi next] : [((OrgApacheLuceneIndexTermEnum *) nil_chk(termEnum)) term] != nil) (void) [((OrgApacheLuceneIndexSegmentMergeQueue *) nil_chk(self->queue_)) addWithId:smi];
    else [smi close];
  }
...
- (void)seekWithOrgApacheLuceneIndexTermEnum:(OrgApacheLuceneIndexTermEnum *)termEnum {
  ...
  if ([termEnum isKindOfClass:[OrgApacheLuceneIndexDirectoryReader_MultiTermEnum class]]) {
    tenum_ = (OrgApacheLuceneIndexDirectoryReader_MultiTermEnum *) cast_chk(termEnum, [OrgApacheLuceneIndexDirectoryReader_MultiTermEnum class]);
    if (topReader_ != tenum_->topReader_) tenum_ = nil;
  }
}
...
- (jboolean)next {
  for (; ; ) {
    if (current_ != nil && [current_ next]) {
      ...
      if (tenum_ != nil) {
        smi_ = IOSObjectArray_Get(nil_chk(tenum_->matchingSegments_), matchingSegmentPos_++);
        if (smi_ == nil) {
      ...
      current_ = OrgApacheLuceneIndexDirectoryReader_MultiTermDocs_termDocsWithInt_(self, pointer_++);
    }
    else {
      return false;
    }
...
void OrgApacheLuceneIndexDirectoryReader_MultiTermDocs_initWithOrgApacheLuceneIndexIndexReader_withOrgApacheLuceneIndexIndexReaderArray_withIntArray_(OrgApacheLuceneIndexDirectoryReader_MultiTermDocs *self, OrgApacheLuceneIndexIndexReader *topReader, IOSObjectArray *r, IOSIntArray *s) {
  ...
  self->readers_ = r;
  self->starts_ = s;
  self->readerTermDocs_ = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(r))->size_ type:OrgApacheLuceneIndexTermDocs_class_()];
}
