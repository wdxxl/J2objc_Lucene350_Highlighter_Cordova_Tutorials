...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/TieredMergePolicy.java
//
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setMaxMergeAtOnceWithInt:(jint)v {
  if (v < 2) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"maxMergeAtOnce must be > 1 (got ", v, ')'));
  }
  maxMergeAtOnce_ = v;
  return self;
}
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setMaxMergeAtOnceExplicitWithInt:(jint)v {
  if (v < 2) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"maxMergeAtOnceExplicit must be > 1 (got ", v, ')'));
  }
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setReclaimDeletesWeightWithDouble:(jdouble)v {
  if (v < 0.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$DC", @"reclaimDeletesWeight must be >= 0.0 (got ", v, ')'));
  }
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setFloorSegmentMBWithDouble:(jdouble)v {
  if (v <= 0.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$DC", @"floorSegmentMB must be >= 0.0 (got ", v, ')'));
  }
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setForceMergeDeletesPctAllowedWithDouble:(jdouble)v {
  if (v < 0.0 || v > 100.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$DC", @"forceMergeDeletesPctAllowed must be between 0.0 and 100.0 inclusive (got ", v, ')'));
  }
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setSegmentsPerTierWithDouble:(jdouble)v {
  if (v < 2.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$DC", @"segmentsPerTier must be >= 2.0 (got ", v, ')'));
  }
  segsPerTier_ = v;
  return self;
}
...
- (OrgApacheLuceneIndexTieredMergePolicy *)setNoCFSRatioWithDouble:(jdouble)noCFSRatio {
  if (noCFSRatio < 0.0 || noCFSRatio > 1.0) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$D", @"noCFSRatio must be 0.0 to 1.0 inclusive; got ", noCFSRatio));
  }
...
- (OrgApacheLuceneIndexMergePolicy_MergeSpecification *)findMergesWithOrgApacheLuceneIndexSegmentInfos:(OrgApacheLuceneIndexSegmentInfos *)infos {
  ...
  id<JavaUtilCollection> toBeMerged = new_JavaUtilHashSet_init();
  id<JavaUtilList> infosSorted = new_JavaUtilArrayList_initWithJavaUtilCollection_([infos asList]);
  ...
  while (true) {
    ...
    id<JavaUtilList> eligible = new_JavaUtilArrayList_init();
    ...
    if ([eligible size] >= allowedSegCountInt) {
      ...
      for (jint startIdx = 0; startIdx <= [eligible size] - maxMergeAtOnce_; startIdx++) {
        ...
        id<JavaUtilList> candidate = new_JavaUtilArrayList_init();
      ...
      if (best != nil) {
        ...
        OrgApacheLuceneIndexMergePolicy_OneMerge *merge = new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_(best);
        ...
        if (OrgApacheLuceneIndexTieredMergePolicy_verbose(self)) {
          OrgApacheLuceneIndexTieredMergePolicy_messageWithNSString_(self, JreStrcat("$$$$$$C$$", @"  add merge=", [((OrgApacheLuceneIndexIndexWriter *) nil_chk([writer_ get])) segStringWithJavaLangIterable:merge->segments_], @" size=", NSString_java_formatWithNSString_withNSObjectArray_(@"%.3f MB", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(bestMergeBytes / 1024. / 1024.) } count:1 type:NSObject_class_()]), @" score=", NSString_java_formatWithNSString_withNSObjectArray_(@"%.3f", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_([((OrgApacheLuceneIndexTieredMergePolicy_MergeScore *) nil_chk(bestScore)) getScore]) } count:1 type:NSObject_class_()]), ' ', [bestScore getExplanation], (bestTooLarge ? @" [max merge]" : @"")));
        }
      }
      else {
        return spec;
...
- (OrgApacheLuceneIndexTieredMergePolicy_MergeScore *)scoreWithJavaUtilList:(id<JavaUtilList>)candidate
  ...
  return new_OrgApacheLuceneIndexTieredMergePolicy_1_initWithDouble_withDouble_withDouble_(finalMergeScore, skew, nonDelRatio);
}
...
- (OrgApacheLuceneIndexMergePolicy_MergeSpecification *)findForcedMergesWithOrgApacheLuceneIndexSegmentInfos:(OrgApacheLuceneIndexSegmentInfos *)infos
  ...
  while (end >= maxMergeAtOnceExplicit_ + maxSegmentCount - 1) {
    ...
    OrgApacheLuceneIndexMergePolicy_OneMerge *merge = new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([eligible subListWithInt:end - maxMergeAtOnceExplicit_ withInt:end]);
    if (OrgApacheLuceneIndexTieredMergePolicy_verbose(self)) {
  ...
  if (spec == nil && !forceMergeRunning) {
    ...
    OrgApacheLuceneIndexMergePolicy_OneMerge *merge = new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([eligible subListWithInt:end - numToMerge withInt:end]);
    if (OrgApacheLuceneIndexTieredMergePolicy_verbose(self)) {
...
- (OrgApacheLuceneIndexMergePolicy_MergeSpecification *)findForcedDeletesMergesWithOrgApacheLuceneIndexSegmentInfos:(OrgApacheLuceneIndexSegmentInfos *)infos {
  ...
  while (start < [eligible size]) {
    ...
    OrgApacheLuceneIndexMergePolicy_OneMerge *merge = new_OrgApacheLuceneIndexMergePolicy_OneMerge_initWithJavaUtilList_([eligible subListWithInt:start withInt:end]);
    if (OrgApacheLuceneIndexTieredMergePolicy_verbose(self)) {
      OrgApacheLuceneIndexTieredMergePolicy_messageWithNSString_(self, JreStrcat("$$", @"add merge=", [((OrgApacheLuceneIndexIndexWriter *) nil_chk([writer_ get])) segStringWithJavaLangIterable:merge->segments_]));
    }
    [spec addWithOrgApacheLuceneIndexMergePolicy_OneMerge:merge];
...
- (NSString *)description {
  JavaLangStringBuilder *sb = new_JavaLangStringBuilder_initWithNSString_(JreStrcat("C$$", '[', [[self java_getClass] getSimpleName], @": "));
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergeAtOnce="])) appendWithInt:maxMergeAtOnce_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergeAtOnceExplicit="])) appendWithInt:maxMergeAtOnceExplicit_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"maxMergedSegmentMB="])) appendWithDouble:maxMergedSegmentBytes_ / 1024 / 1024.])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"floorSegmentMB="])) appendWithDouble:floorSegmentBytes_ / 1024 / 1024.])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"forceMergeDeletesPctAllowed="])) appendWithDouble:forceMergeDeletesPctAllowed_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"segmentsPerTier="])) appendWithDouble:segsPerTier_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"useCompoundFile="])) appendWithBoolean:useCompoundFile_])) appendWithNSString:@", "];
  (void) [((JavaLangStringBuilder *) nil_chk([sb appendWithNSString:@"noCFSRatio="])) appendWithDouble:noCFSRatio_];
...
void OrgApacheLuceneIndexTieredMergePolicy_init(OrgApacheLuceneIndexTieredMergePolicy *self) {
  ...
  self->segmentByteSizeDescending_ = new_OrgApacheLuceneIndexTieredMergePolicy_SegmentByteSizeDescending_initWithOrgApacheLuceneIndexTieredMergePolicy_(self);
}
...
- (NSString *)getExplanation {
  return JreStrcat("$$$$", @"skew=", NSString_java_formatWithNSString_withNSObjectArray_(@"%.3f", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(val$skew_) } count:1 type:NSObject_class_()]), @" nonDelRatio=", NSString_java_formatWithNSString_withNSObjectArray_(@"%.3f", [IOSObjectArray newArrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(val$nonDelRatio_) } count:1 type:NSObject_class_()]));
}
