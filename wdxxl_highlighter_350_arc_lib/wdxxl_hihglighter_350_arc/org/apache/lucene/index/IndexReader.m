...
__attribute__((unused)) static OrgApacheLuceneIndexIndexReader_FieldOption *new_OrgApacheLuceneIndexIndexReader_FieldOption_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
- (NSString *)description {
  ...
  if ((subReaders != nil) && (((IOSObjectArray *) nil_chk(subReaders))->size_ > 0)) {
    (void) [buffer appendWithId:IOSObjectArray_Get(nil_chk(subReaders), 0)];
    for (jint i = 1; i < subReaders->size_; ++i) {
      (void) [((JavaLangStringBuilder *) nil_chk([buffer appendWithNSString:@" "])) appendWithId:IOSObjectArray_Get(subReaders, i)];
    }
  }
  (void) [buffer appendWithChar:')'];
...
- (void)decRef {
  ...
  if (rc == 1) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$I$", @"too many decRef calls: refCount was ", rc, @" before decrement"));
  }
}
...
- (OrgApacheLuceneIndexIndexReader *)doOpenIfChanged {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This reader does not support reopen().");
}
...
- (OrgApacheLuceneIndexIndexReader *)doOpenIfChangedWithOrgApacheLuceneIndexIndexCommit:(OrgApacheLuceneIndexIndexCommit *)commit {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This reader does not support reopen(IndexCommit).");
}
...
- (id)java_clone {
  @synchronized(self) {
    @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This reader does not implement clone()");
  }
}
...
- (OrgApacheLuceneStoreDirectory *)directory {
  OrgApacheLuceneIndexIndexReader_ensureOpen(self);
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This reader does not support this method.");
}
...
- (OrgApacheLuceneDocumentDocument *)documentWithInt:(jint)n {
  ...
  if (n < 0 || n >= [self maxDoc]) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$IC", @"docID must be >= 0 and < maxDoc=", [self maxDoc], @" (got docID=", n, ')'));
  }
...
- (jlong)getUniqueTermCount {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"this reader does not implement getUniqueTermCount()");
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexIndexReader class]) {
    OrgApacheLuceneIndexIndexReader_reopenMethod1 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"reopen", [IOSObjectArray newArrayWithLength:0 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_doOpenIfChangedMethod1 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"doOpenIfChanged", [IOSObjectArray newArrayWithLength:0 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_reopenMethod2 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"reopen", [IOSObjectArray newArrayWithObjects:(id[]){ [IOSClass booleanClass] } count:1 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_doOpenIfChangedMethod2 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"doOpenIfChanged", [IOSObjectArray newArrayWithObjects:(id[]){ [IOSClass booleanClass] } count:1 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_reopenMethod3 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"reopen", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexIndexCommit_class_() } count:1 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_doOpenIfChangedMethod3 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"doOpenIfChanged", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexIndexCommit_class_() } count:1 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_reopenMethod4 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"reopen", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexIndexWriter_class_(), [IOSClass booleanClass] } count:2 type:IOSClass_class_()]);
    OrgApacheLuceneIndexIndexReader_doOpenIfChangedMethod4 = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneIndexIndexReader_class_(), @"doOpenIfChanged", [IOSObjectArray newArrayWithObjects:(id[]){ OrgApacheLuceneIndexIndexWriter_class_(), [IOSClass booleanClass] } count:2 type:IOSClass_class_()]);
...
void OrgApacheLuceneIndexIndexReader_init(OrgApacheLuceneIndexIndexReader *self) {
  NSObject_init(self);
  self->refCount_ = new_JavaUtilConcurrentAtomicAtomicInteger_init();
...
void OrgApacheLuceneIndexIndexReader_ensureOpen(OrgApacheLuceneIndexIndexReader *self) {
  if ([((JavaUtilConcurrentAtomicAtomicInteger *) nil_chk(self->refCount_)) get] <= 0) {
    @throw new_OrgApacheLuceneStoreAlreadyClosedException_initWithNSString_(@"this IndexReader is closed");
  }
}
...
jlong OrgApacheLuceneIndexIndexReader_lastModifiedWithOrgApacheLuceneStoreDirectory_(OrgApacheLuceneStoreDirectory *directory2) {
  OrgApacheLuceneIndexIndexReader_initialize();
  return [((JavaLangLong *) nil_chk(((JavaLangLong *) cast_chk([new_OrgApacheLuceneIndexIndexReader_1_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneStoreDirectory_(directory2, directory2) run], [JavaLangLong class])))) longLongValue];
}
...
jboolean OrgApacheLuceneIndexIndexReader_indexExistsWithOrgApacheLuceneStoreDirectory_(OrgApacheLuceneStoreDirectory *directory) {
  OrgApacheLuceneIndexIndexReader_initialize();
  @try {
    [new_OrgApacheLuceneIndexSegmentInfos_init() readWithOrgApacheLuceneStoreDirectory:directory];
    return true;
  }
...
void OrgApacheLuceneIndexIndexReader_mainWithNSStringArray_(IOSObjectArray *args) {
  ...
  @try {
    ...
    dir = OrgApacheLuceneStoreFSDirectory_openWithJavaIoFile_(new_JavaIoFile_initWithNSString_(dirname));
    cfr = new_OrgApacheLuceneIndexCompoundFileReader_initWithOrgApacheLuceneStoreDirectory_withNSString_(dir, filename);
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(files))->size_; ++i) {
      ...
      if (extract) {
        ...
        JavaIoFileOutputStream *f = new_JavaIoFileOutputStream_initWithNSString_(IOSObjectArray_Get(files, i));
...
OrgApacheLuceneIndexIndexReader_FieldOption *new_OrgApacheLuceneIndexIndexReader_FieldOption_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneIndexIndexReader_FieldOption, initWithNSString_withInt_, __name, __ordinal)
}
...
void OrgApacheLuceneIndexIndexReader_1_initWithOrgApacheLuceneStoreDirectory_withOrgApacheLuceneStoreDirectory_(OrgApacheLuceneIndexIndexReader_1 *self, OrgApacheLuceneStoreDirectory *capture$0, OrgApacheLuceneStoreDirectory *directory) {
  self->val$directory2_ = capture$0;
