...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/ReadOnlySegmentReader.java
//
...
void OrgApacheLuceneIndexReadOnlySegmentReader_noWrite() {
  ...
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"This IndexReader cannot make any changes to the index (it was opened with readOnly = true)");
}
