...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/index/ConcurrentMergeScheduler.java
//
...
- (void)setMaxThreadCountWithInt:(jint)count {
  if (count < 1) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"count should be at least 1");
  }
  if (count > maxMergeCount_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"count should be <= maxMergeCount (= ", maxMergeCount_, ')'));
  }
...
- (void)setMaxMergeCountWithInt:(jint)count {
  ...
  if (count < maxThreadCount_) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$IC", @"count should be >= maxThreadCount (= ", maxThreadCount_, ')'));
  }
...
- (void)setMergeThreadPriorityWithInt:(jint)pri {
  @synchronized(self) {
    if (pri > JavaLangThread_MAX_PRIORITY || pri < JavaLangThread_MIN_PRIORITY) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$I$", @"priority must be in range ", JavaLangThread_MIN_PRIORITY, @" .. ", JavaLangThread_MAX_PRIORITY, @" inclusive"));
...
- (void)updateMergeThreads {
  @synchronized(self) {
    id<JavaUtilList> activeMerges = new_JavaUtilArrayList_init();
    jint threadIdx = 0;
    while (threadIdx < [((id<JavaUtilList>) nil_chk(mergeThreads_)) size]) {
      ...
      if (![((OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread *) nil_chk(mergeThread)) isAlive]) {
        (void) [((id<JavaUtilList>) nil_chk(mergeThreads_)) removeWithInt:threadIdx];
        continue;
      }
...
- (OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread *)getMergeThreadWithOrgApacheLuceneIndexIndexWriter:(OrgApacheLuceneIndexIndexWriter *)writer
  ...
  @synchronized(self) {
    OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread *thread = new_OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread_initWithOrgApacheLuceneIndexConcurrentMergeScheduler_withOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexMergePolicy_OneMerge_(self, writer, merge);
...
+ (void)initialize {
  if (self == [OrgApacheLuceneIndexConcurrentMergeScheduler class]) {
    OrgApacheLuceneIndexConcurrentMergeScheduler_compareByMergeDocCount = new_OrgApacheLuceneIndexConcurrentMergeScheduler_1_init();
...
void OrgApacheLuceneIndexConcurrentMergeScheduler_init(OrgApacheLuceneIndexConcurrentMergeScheduler *self) {
  ...
  self->mergeThreads_ = new_JavaUtilArrayList_init();
...
jboolean OrgApacheLuceneIndexConcurrentMergeScheduler_anyUnhandledExceptions() {
  ...
  if (OrgApacheLuceneIndexConcurrentMergeScheduler_allInstances == nil) {
    @throw new_JavaLangRuntimeException_initWithNSString_(@"setTestMode() was not called; often this is because your test case's setUp method fails to call super.setUp in LuceneTestCase");
  }
...
void OrgApacheLuceneIndexConcurrentMergeScheduler_addMyself(OrgApacheLuceneIndexConcurrentMergeScheduler *self) {
  @synchronized(OrgApacheLuceneIndexConcurrentMergeScheduler_allInstances) {
    ...
    for (jint i = 0; i < size; i++) {
      ...
      if (!(JreLoadVolatileBoolean(&((OrgApacheLuceneIndexConcurrentMergeScheduler *) nil_chk(other))->closed_) && 0 == [other mergeThreadCount])) (void) [((id<JavaUtilList>) nil_chk(OrgApacheLuceneIndexConcurrentMergeScheduler_allInstances)) setWithInt:upto++ withId:other];
    }
...
void OrgApacheLuceneIndexConcurrentMergeScheduler_setTestMode() {
  OrgApacheLuceneIndexConcurrentMergeScheduler_initialize();
  OrgApacheLuceneIndexConcurrentMergeScheduler_allInstances = new_JavaUtilArrayList_init();
}
...
void OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread_initWithOrgApacheLuceneIndexConcurrentMergeScheduler_withOrgApacheLuceneIndexIndexWriter_withOrgApacheLuceneIndexMergePolicy_OneMerge_(OrgApacheLuceneIndexConcurrentMergeScheduler_MergeThread *self, OrgApacheLuceneIndexConcurrentMergeScheduler *outer$, OrgApacheLuceneIndexIndexWriter *writer, OrgApacheLuceneIndexMergePolicy_OneMerge *startMerge) {
  ...
  self->tWriter_ = writer;
  self->startMerge_ = startMerge;
}
