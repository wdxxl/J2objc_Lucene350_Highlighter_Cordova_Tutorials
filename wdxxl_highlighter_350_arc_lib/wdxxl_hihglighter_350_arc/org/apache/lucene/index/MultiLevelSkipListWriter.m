...
- (void)init__ {
  skipBuffer_ = [IOSObjectArray newArrayWithLength:numberOfSkipLevels_ type:OrgApacheLuceneStoreRAMOutputStream_class_()];
  for (jint i = 0; i < numberOfSkipLevels_; i++) {
    (void) IOSObjectArray_SetAndConsume(nil_chk(skipBuffer_), i, new_OrgApacheLuceneStoreRAMOutputStream_init());
  }
}
