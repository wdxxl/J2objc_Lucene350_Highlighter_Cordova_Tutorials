...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/document/DateTools.java
//
...
__attribute__((unused)) static OrgApacheLuceneDocumentDateTools_Resolution *new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(jint formatLen, NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
+ (void)initialize {
  if (self == [OrgApacheLuceneDocumentDateTools class]) {
    OrgApacheLuceneDocumentDateTools_GMT = JavaUtilTimeZone_getTimeZoneWithNSString_(@"GMT");
    OrgApacheLuceneDocumentDateTools_TL_CAL = new_OrgApacheLuceneDocumentDateTools_1_init();
    OrgApacheLuceneDocumentDateTools_TL_FORMATS = new_OrgApacheLuceneDocumentDateTools_2_init();
...
NSString *OrgApacheLuceneDocumentDateTools_timeToStringWithLong_withOrgApacheLuceneDocumentDateTools_Resolution_(jlong time, OrgApacheLuceneDocumentDateTools_Resolution *resolution) {
  OrgApacheLuceneDocumentDateTools_initialize();
  JavaUtilDate *date = new_JavaUtilDate_initWithLong_(OrgApacheLuceneDocumentDateTools_roundWithLong_withOrgApacheLuceneDocumentDateTools_Resolution_(time, resolution));
...
JavaUtilDate *OrgApacheLuceneDocumentDateTools_stringToDateWithNSString_(NSString *dateString) {
  ...
  @catch (JavaLangException *e) {
    @throw new_JavaTextParseException_initWithNSString_withInt_(JreStrcat("$$", @"Input is not a valid date string: ", dateString), 0);
  }
}
...
JavaUtilDate *OrgApacheLuceneDocumentDateTools_roundWithJavaUtilDate_withOrgApacheLuceneDocumentDateTools_Resolution_(JavaUtilDate *date, OrgApacheLuceneDocumentDateTools_Resolution *resolution) {
  OrgApacheLuceneDocumentDateTools_initialize();
  return new_JavaUtilDate_initWithLong_(OrgApacheLuceneDocumentDateTools_roundWithLong_withOrgApacheLuceneDocumentDateTools_Resolution_([((JavaUtilDate *) nil_chk(date)) getTime], resolution));
}
...
jlong OrgApacheLuceneDocumentDateTools_roundWithLong_withOrgApacheLuceneDocumentDateTools_Resolution_(jlong time, OrgApacheLuceneDocumentDateTools_Resolution *resolution) {
  ...
  switch ([resolution ordinal]) {
    ...
    break;
    default:
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"unknown resolution ", resolution));
  }
...
- (IOSObjectArray *)initialValue {
  IOSObjectArray *arr = [IOSObjectArray newArrayWithLength:((OrgApacheLuceneDocumentDateTools_Resolution *) nil_chk(JreLoadEnum(OrgApacheLuceneDocumentDateTools_Resolution, MILLISECOND)))->formatLen_ + 1 type:JavaTextSimpleDateFormat_class_()];
  {
    ...
    while (b__ < e__) {
      ...
      (void) IOSObjectArray_Set(arr, ((OrgApacheLuceneDocumentDateTools_Resolution *) nil_chk(resolution))->formatLen_, (JavaTextSimpleDateFormat *) cast_chk([((JavaTextSimpleDateFormat *) nil_chk(resolution->format_)) java_clone], [JavaTextSimpleDateFormat class]));
    }
  }
  return arr;
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneDocumentDateTools_Resolution class]) {
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, YEAR) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(4, @"YEAR", 0);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, MONTH) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(6, @"MONTH", 1);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, DAY) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(8, @"DAY", 2);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, HOUR) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(10, @"HOUR", 3);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, MINUTE) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(12, @"MINUTE", 4);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, SECOND) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(14, @"SECOND", 5);
    JreEnum(OrgApacheLuceneDocumentDateTools_Resolution, MILLISECOND) = new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(17, @"MILLISECOND", 6);
...
void OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(OrgApacheLuceneDocumentDateTools_Resolution *self, jint formatLen, NSString *__name, jint __ordinal) {
  ...
  self->format_ = new_JavaTextSimpleDateFormat_initWithNSString_withJavaUtilLocale_([@"yyyyMMddHHmmssSSS" java_substring:0 endIndex:formatLen], JreLoadStatic(JavaUtilLocale, US));
  [self->format_ setTimeZoneWithJavaUtilTimeZone:JreLoadStatic(OrgApacheLuceneDocumentDateTools, GMT)];
}

OrgApacheLuceneDocumentDateTools_Resolution *new_OrgApacheLuceneDocumentDateTools_Resolution_initWithInt_withNSString_withInt_(jint formatLen, NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(OrgApacheLuceneDocumentDateTools_Resolution, initWithInt_withNSString_withInt_, formatLen, __name, __ordinal)
}
