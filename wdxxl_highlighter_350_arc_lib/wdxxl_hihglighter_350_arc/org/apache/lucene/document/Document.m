...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/document/Document.java
//
...
- (IOSObjectArray *)getFieldsWithNSString:(NSString *)name {
  ...
  return [result toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[result size] type:OrgApacheLuceneDocumentField_class_()]];
}
...
- (IOSObjectArray *)getFieldablesWithNSString:(NSString *)name {
  ...
  return [result toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[result size] type:OrgApacheLuceneDocumentFieldable_class_()]];
}
...
- (IOSObjectArray *)getBinaryValuesWithNSString:(NSString *)name {
  ...
  return [result toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[result size] type:IOSClass_byteArray(1)]];
}
...
- (NSString *)description {
  ...
  (void) [buffer appendWithNSString:@"Document<"];
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(fields_)) size]; i++) {
    ...
    (void) [buffer appendWithNSString:[((id<OrgApacheLuceneDocumentFieldable>) nil_chk(field)) description]];
    if (i != [((id<JavaUtilList>) nil_chk(fields_)) size] - 1) (void) [buffer appendWithNSString:@" "];
  }
...
+ (void)initialize {
  if (self == [OrgApacheLuceneDocumentDocument class]) {
    OrgApacheLuceneDocumentDocument_NO_FIELDS = [IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneDocumentField_class_()];
    OrgApacheLuceneDocumentDocument_NO_FIELDABLES = [IOSObjectArray newArrayWithLength:0 type:OrgApacheLuceneDocumentFieldable_class_()];
    OrgApacheLuceneDocumentDocument_NO_STRINGS = [IOSObjectArray newArrayWithLength:0 type:NSString_class_()];
    OrgApacheLuceneDocumentDocument_NO_BYTES = [IOSObjectArray newArrayWithLength:0 type:IOSClass_byteArray(1)];
