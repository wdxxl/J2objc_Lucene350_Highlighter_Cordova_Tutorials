...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/queryParser/Token.java
//
...
OrgApacheLuceneQueryParserToken *OrgApacheLuceneQueryParserToken_newTokenWithInt_withNSString_(jint ofKind, NSString *image) {
  ...
  switch (ofKind) {
    default:
    return new_OrgApacheLuceneQueryParserToken_initWithInt_withNSString_(ofKind, image);
  }
}
