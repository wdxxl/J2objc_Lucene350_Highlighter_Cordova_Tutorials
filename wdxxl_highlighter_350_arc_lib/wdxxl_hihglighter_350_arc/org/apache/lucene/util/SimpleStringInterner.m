...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/SimpleStringInterner.java
//
...
- (NSString *)internWithNSString:(NSString *)s {
  ...
  s = [s java_intern];
  (void) IOSObjectArray_SetAndConsume(self->cache_, slot, new_OrgApacheLuceneUtilSimpleStringInterner_Entry_initWithNSString_withInt_withOrgApacheLuceneUtilSimpleStringInterner_Entry_(s, h, first));
  if (chainLength >= maxChainLength_) {
    ((OrgApacheLuceneUtilSimpleStringInterner_Entry *) nil_chk(nextToLast))->next_ = nil;
  }
  return s;
}
...
void OrgApacheLuceneUtilSimpleStringInterner_initWithInt_withInt_(OrgApacheLuceneUtilSimpleStringInterner *self, jint tableSize, jint maxChainLength) {
  ...
  self->cache_ = [IOSObjectArray newArrayWithLength:JavaLangMath_maxWithInt_withInt_(1, OrgApacheLuceneUtilBitUtil_nextHighestPowerOfTwoWithInt_(tableSize)) type:OrgApacheLuceneUtilSimpleStringInterner_Entry_class_()];
