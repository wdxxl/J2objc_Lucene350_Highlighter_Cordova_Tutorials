...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/English.java
//
...
void OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(jlong i, JavaLangStringBuilder *result) {
  OrgApacheLuceneUtilEnglish_initialize();
  if (i == 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"zero"];
    return;
  }
  if (i < 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"minus "];
    i = -i;
  }
  if (i >= 1000000000000000000l) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"quintillion, "];
  ...
  if (i >= 1000000000000000l) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"quadrillion, "];
    i = i % 1000000000000000l;
  }
  if (i >= 1000000000000l) {
    OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(i / 1000000000000l, result);
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"trillion, "];
    i = i % 1000000000000l;
  }
  if (i >= 1000000000) {
    OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(i / 1000000000, result);
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"billion, "];
    i = i % 1000000000;
  }
  if (i >= 1000000) {
    OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(i / 1000000, result);
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"million, "];
    i = i % 1000000;
  }
  if (i >= 1000) {
    OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(i / 1000, result);
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"thousand, "];
    i = i % 1000;
  }
  if (i >= 100) {
    OrgApacheLuceneUtilEnglish_longToEnglishWithLong_withJavaLangStringBuilder_(i / 100, result);
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"hundred "];
    i = i % 100;
  }
  if (i >= 20) {
    switch (((jint) i) / 10) {
      case 9:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"ninety"];
      break;
      case 8:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"eighty"];
      break;
      case 7:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"seventy"];
      break;
      case 6:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"sixty"];
      break;
      case 5:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"fifty"];
      break;
      case 4:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"forty"];
      break;
      case 3:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"thirty"];
      break;
      case 2:
      (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"twenty"];
      break;
    }
    i = i % 10;
    if (i == 0) (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@" "];
    else (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"-"];
  }
  switch ((jint) i) {
    case 19:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"nineteen "];
    break;
    case 18:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"eighteen "];
    break;
    case 17:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"seventeen "];
    break;
    case 16:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"sixteen "];
    break;
    case 15:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"fifteen "];
    break;
    case 14:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"fourteen "];
    break;
    case 13:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"thirteen "];
    break;
    case 12:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"twelve "];
    break;
    case 11:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"eleven "];
    break;
    case 10:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"ten "];
    break;
    case 9:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"nine "];
    break;
    case 8:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"eight "];
    break;
    case 7:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"seven "];
    break;
    case 6:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"six "];
    break;
    case 5:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"five "];
    break;
    case 4:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"four "];
    break;
    case 3:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"three "];
    break;
    case 2:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"two "];
    break;
    case 1:
    (void) [((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@"one "];
    break;
    case 0:
