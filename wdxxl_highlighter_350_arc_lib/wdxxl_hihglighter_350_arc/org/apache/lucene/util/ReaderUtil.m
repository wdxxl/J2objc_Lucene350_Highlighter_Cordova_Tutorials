...
OrgApacheLuceneIndexIndexReader *OrgApacheLuceneUtilReaderUtil_subReaderWithInt_withOrgApacheLuceneIndexIndexReader_(jint doc, OrgApacheLuceneIndexIndexReader *reader) {
  ...
  IOSObjectArray *subReaders = [subReadersList toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[subReadersList size] type:OrgApacheLuceneIndexIndexReader_class_()]];
  IOSIntArray *docStarts = [IOSIntArray newArrayWithLength:((IOSObjectArray *) nil_chk(subReaders))->size_];
  jint maxDoc = 0;
  for (jint i = 0; i < subReaders->size_; i++) {
