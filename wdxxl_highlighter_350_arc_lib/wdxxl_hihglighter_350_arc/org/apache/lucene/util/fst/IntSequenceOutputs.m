...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/IntSequenceOutputs.java
//
...
- (OrgApacheLuceneUtilIntsRef *)commonWithId:(OrgApacheLuceneUtilIntsRef *)output1
  ...
  if (pos1 == output1->offset_) {
    ...
    return new_OrgApacheLuceneUtilIntsRef_initWithIntArray_withInt_withInt_(output1->ints_, output1->offset_, pos1 - output1->offset_);
  }
}
...
- (OrgApacheLuceneUtilIntsRef *)readWithOrgApacheLuceneStoreDataInput:(OrgApacheLuceneStoreDataInput *)inArg {
  ...
  if (len == 0) {
    ...
    OrgApacheLuceneUtilIntsRef *output = new_OrgApacheLuceneUtilIntsRef_initWithInt_(len);
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstIntSequenceOutputs class]) {
    OrgApacheLuceneUtilFstIntSequenceOutputs_NO_OUTPUT = new_OrgApacheLuceneUtilIntsRef_init();
...
OrgApacheLuceneUtilFstIntSequenceOutputs *OrgApacheLuceneUtilFstIntSequenceOutputs_getSingleton() {
  ...
  return new_OrgApacheLuceneUtilFstIntSequenceOutputs_init();
}
