...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/FSTEnum.java
//
...
- (void)doNext {
  if (upto_ == 0) {
    upto_ = 1;
    (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(fst_)) readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, 0) withOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, 1)];
  }
  else {
    ...
    (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(fst_)) readNextArcWithOrgApacheLuceneUtilFstFST_Arc:IOSObjectArray_Get(nil_chk(arcs_), upto_)];
  }
  ...
  while (true) {
    if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->bytesPerArc_ != 0 && arc->label_ != -1) {
      ...
      if (found) {
        ...
        while (true) {
          ...
          if (![((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(prevArc)) isLast]) {
            (void) [fst_ readNextArcWithOrgApacheLuceneUtilFstFST_Arc:prevArc];
            OrgApacheLuceneUtilFstFSTEnum_pushFirst(self);
            return;
          }
          upto_--;
      ...
      if (arc->label_ == targetLabel) {
        (void) IOSObjectArray_Set(nil_chk(output_), upto_, [((OrgApacheLuceneUtilFstOutputs *) nil_chk(((OrgApacheLuceneUtilFstFST *) nil_chk(fst_))->outputs_)) addWithId:IOSObjectArray_Get(output_, upto_ - 1) withId:arc->output_]);
        if (targetLabel == OrgApacheLuceneUtilFstFST_END_LABEL) {
          return;
        }
        [self setCurrentLabelWithInt:arc->label_];
        ...
        while (true) {
          ...
          OrgApacheLuceneUtilFstFST_Arc *prevArc = OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, upto_);
          if (![((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(prevArc)) isLast]) {
            (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(fst_)) readNextArcWithOrgApacheLuceneUtilFstFST_Arc:prevArc];
            OrgApacheLuceneUtilFstFSTEnum_pushFirst(self);
            return;
          }
          upto_--;
        ...
        (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(fst_)) readNextArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
      }
    }
  }
}
  ...
  while (true) {
    if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->bytesPerArc_ != 0 && arc->label_ != OrgApacheLuceneUtilFstFST_END_LABEL) {
      ...
      if (found) {
        ...
        while (true) {
          (void) [fst_ readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, upto_ - 1) withOrgApacheLuceneUtilFstFST_Arc:arc];
          if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->label_ < targetLabel) {
            while (![arc isLast] && [fst_ readNextArcLabelWithOrgApacheLuceneUtilFstFST_Arc:arc] < targetLabel) {
              (void) [fst_ readNextArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
            }
      ...
      if (arc->label_ == targetLabel) {
        ...
        while (true) {
          (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(fst_)) readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, upto_ - 1) withOrgApacheLuceneUtilFstFST_Arc:arc];
          if (((OrgApacheLuceneUtilFstFST_Arc *) nil_chk(arc))->label_ < targetLabel) {
            while (![arc isLast] && [fst_ readNextArcLabelWithOrgApacheLuceneUtilFstFST_Arc:arc] < targetLabel) {
              (void) [fst_ readNextArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
            }
...
void OrgApacheLuceneUtilFstFSTEnum_initWithOrgApacheLuceneUtilFstFST_(OrgApacheLuceneUtilFstFSTEnum *self, OrgApacheLuceneUtilFstFST *fst) {
  NSObject_init(self);
  self->arcs_ = [IOSObjectArray newArrayWithLength:10 type:OrgApacheLuceneUtilFstFST_Arc_class_()];
  self->output_ = [IOSObjectArray newArrayWithLength:10 type:NSObject_class_()];
  self->scratchArc_ = new_OrgApacheLuceneUtilFstFST_Arc_init();
  self->fst_ = fst;
  self->NO_OUTPUT_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(((OrgApacheLuceneUtilFstFST *) nil_chk(fst))->outputs_)) getNoOutput];
  (void) [fst getFirstArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, 0)];
  (void) IOSObjectArray_Set(nil_chk(self->output_), 0, self->NO_OUTPUT_);
}

void OrgApacheLuceneUtilFstFSTEnum_rewindPrefix(OrgApacheLuceneUtilFstFSTEnum *self) {
  if (self->upto_ == 0) {
    self->upto_ = 1;
    (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(self->fst_)) readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, 0) withOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, 1)];
    return;
  }
  ...
  while (self->upto_ < currentLimit && self->upto_ <= self->targetLength_ + 1) {
    ...
    if (cmp < 0) {
      ...
      (void) [((OrgApacheLuceneUtilFstFST *) nil_chk(self->fst_)) readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(self, self->upto_ - 1) withOrgApacheLuceneUtilFstFST_Arc:arc];
      break;
    }
    self->upto_++;
  }
...
void OrgApacheLuceneUtilFstFSTEnum_incr(OrgApacheLuceneUtilFstFSTEnum *self) {
  ...
  if (((IOSObjectArray *) nil_chk(self->arcs_))->size_ <= self->upto_) {
    IOSObjectArray *newArcs = [IOSObjectArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(1 + self->upto_, JreLoadStatic(OrgApacheLuceneUtilRamUsageEstimator, NUM_BYTES_OBJECT_REF)) type:OrgApacheLuceneUtilFstFST_Arc_class_()];
  ...
  if (((IOSObjectArray *) nil_chk(self->output_))->size_ <= self->upto_) {
    IOSObjectArray *newOutput = [IOSObjectArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(1 + self->upto_, JreLoadStatic(OrgApacheLuceneUtilRamUsageEstimator, NUM_BYTES_OBJECT_REF)) type:NSObject_class_()];
...
void OrgApacheLuceneUtilFstFSTEnum_pushFirst(OrgApacheLuceneUtilFstFSTEnum *self) {
  ...
  while (true) {
    ...
    (void) [self->fst_ readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:arc withOrgApacheLuceneUtilFstFST_Arc:nextArc];
    arc = nextArc;
  }
}
...
OrgApacheLuceneUtilFstFST_Arc *OrgApacheLuceneUtilFstFSTEnum_getArcWithInt_(OrgApacheLuceneUtilFstFSTEnum *self, jint idx) {
  if (IOSObjectArray_Get(nil_chk(self->arcs_), idx) == nil) {
    (void) IOSObjectArray_SetAndConsume(self->arcs_, idx, new_OrgApacheLuceneUtilFstFST_Arc_init());
  }
