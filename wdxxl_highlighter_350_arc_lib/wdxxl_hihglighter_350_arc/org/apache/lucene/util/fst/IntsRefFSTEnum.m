...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/IntsRefFSTEnum.java
//
...
void OrgApacheLuceneUtilFstIntsRefFSTEnum_initWithOrgApacheLuceneUtilFstFST_(OrgApacheLuceneUtilFstIntsRefFSTEnum *self, OrgApacheLuceneUtilFstFST *fst) {
  ...
  self->current_ = new_OrgApacheLuceneUtilIntsRef_initWithInt_(10);
  self->result_ = new_OrgApacheLuceneUtilFstIntsRefFSTEnum_InputOutput_init();
...
OrgApacheLuceneUtilFstIntsRefFSTEnum_InputOutput *OrgApacheLuceneUtilFstIntsRefFSTEnum_setResult(OrgApacheLuceneUtilFstIntsRefFSTEnum *self) {
  if (self->upto_ == 0) {
    ...
    ((OrgApacheLuceneUtilFstIntsRefFSTEnum_InputOutput *) nil_chk(self->result_))->output_ = IOSObjectArray_Get(nil_chk(self->output_), self->upto_);
    return self->result_;
  }
}
