...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/ByteSequenceOutputs.java
//
...
- (OrgApacheLuceneUtilBytesRef *)commonWithId:(OrgApacheLuceneUtilBytesRef *)output1
  ...
  if (pos1 == output1->offset_) {
    ...
    return new_OrgApacheLuceneUtilBytesRef_initWithByteArray_withInt_withInt_(output1->bytes_, output1->offset_, pos1 - output1->offset_);
  }
}
...
- (OrgApacheLuceneUtilBytesRef *)readWithOrgApacheLuceneStoreDataInput:(OrgApacheLuceneStoreDataInput *)inArg {
  ...
  if (len == 0) {
    ...
    OrgApacheLuceneUtilBytesRef *output = new_OrgApacheLuceneUtilBytesRef_initWithInt_(len);
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilFstByteSequenceOutputs class]) {
    OrgApacheLuceneUtilFstByteSequenceOutputs_NO_OUTPUT = new_OrgApacheLuceneUtilBytesRef_init();
...
OrgApacheLuceneUtilFstByteSequenceOutputs *OrgApacheLuceneUtilFstByteSequenceOutputs_getSingleton() {
  ...
  return new_OrgApacheLuceneUtilFstByteSequenceOutputs_init();
}
