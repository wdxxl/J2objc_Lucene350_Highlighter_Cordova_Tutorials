...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/Builder.java
//
...
- (void)addWithOrgApacheLuceneUtilIntsRef:(OrgApacheLuceneUtilIntsRef *)input
  ...
  if (((IOSObjectArray *) nil_chk(frontier_))->size_ < input->length_ + 1) {
    IOSObjectArray *next = [IOSObjectArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(input->length_ + 1, JreLoadStatic(OrgApacheLuceneUtilRamUsageEstimator, NUM_BYTES_OBJECT_REF)) type:OrgApacheLuceneUtilFstBuilder_UnCompiledNode_class_()];
    ...
    for (jint idx = ((IOSObjectArray *) nil_chk(frontier_))->size_; idx < next->size_; idx++) {
      (void) IOSObjectArray_SetAndConsume(next, idx, new_OrgApacheLuceneUtilFstBuilder_UnCompiledNode_initWithOrgApacheLuceneUtilFstBuilder_withInt_(self, idx));
    }
    frontier_ = next;
  }
  OrgApacheLuceneUtilFstBuilder_compilePrevTailWithInt_(self, prefixLenPlus1);
  ...
  if (lastInput_->length_ == input->length_ && prefixLenPlus1 == 1 + input->length_) {
    lastNode->output_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(((OrgApacheLuceneUtilFstFST *) nil_chk(fst_))->outputs_)) mergeWithId:lastNode->output_ withId:output];
  }
  else {
...
void OrgApacheLuceneUtilFstBuilder_initWithOrgApacheLuceneUtilFstFST_INPUT_TYPE_withInt_withInt_withBoolean_withBoolean_withInt_withOrgApacheLuceneUtilFstOutputs_(OrgApacheLuceneUtilFstBuilder *self, OrgApacheLuceneUtilFstFST_INPUT_TYPE *inputType, jint minSuffixCount1, jint minSuffixCount2, jboolean doShareSuffix, jboolean doShareNonSingletonNodes, jint shareMaxTailLength, OrgApacheLuceneUtilFstOutputs *outputs) {
  NSObject_init(self);
  self->lastInput_ = new_OrgApacheLuceneUtilIntsRef_init();
  self->scratchIntsRef_ = new_OrgApacheLuceneUtilIntsRef_initWithInt_(10);
  ...
  self->fst_ = new_OrgApacheLuceneUtilFstFST_initWithOrgApacheLuceneUtilFstFST_INPUT_TYPE_withOrgApacheLuceneUtilFstOutputs_(inputType, outputs);
  if (doShareSuffix) {
    self->dedupHash_ = new_OrgApacheLuceneUtilFstNodeHash_initWithOrgApacheLuceneUtilFstFST_(self->fst_);
  }
  else {
    self->dedupHash_ = nil;
  }
  self->NO_OUTPUT_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(outputs)) getNoOutput];
  IOSObjectArray *f = [IOSObjectArray newArrayWithLength:10 type:OrgApacheLuceneUtilFstBuilder_UnCompiledNode_class_()];
  self->frontier_ = f;
  for (jint idx = 0; idx < ((IOSObjectArray *) nil_chk(self->frontier_))->size_; idx++) {
    (void) IOSObjectArray_SetAndConsume(self->frontier_, idx, new_OrgApacheLuceneUtilFstBuilder_UnCompiledNode_initWithOrgApacheLuceneUtilFstBuilder_withInt_(self, idx));
  }
}
...
OrgApacheLuceneUtilFstBuilder_CompiledNode *OrgApacheLuceneUtilFstBuilder_compileNodeWithOrgApacheLuceneUtilFstBuilder_UnCompiledNode_withInt_(OrgApacheLuceneUtilFstBuilder *self, OrgApacheLuceneUtilFstBuilder_UnCompiledNode *n, jint tailLength) {
  ...
  OrgApacheLuceneUtilFstBuilder_CompiledNode *fn = new_OrgApacheLuceneUtilFstBuilder_CompiledNode_init();
  fn->address_ = address;
  return fn;
}
  ...
  for (jint idx = ((OrgApacheLuceneUtilIntsRef *) nil_chk(self->lastInput_))->length_; idx >= prefixLenPlus1; idx--) {
    ...
    if (doPrune) {
      ...
      if (doCompile) {
        ...
        (void) IOSObjectArray_SetAndConsume(nil_chk(self->frontier_), idx, new_OrgApacheLuceneUtilFstBuilder_UnCompiledNode_initWithOrgApacheLuceneUtilFstBuilder_withInt_(self, idx));
      }
    }
  }
}
...
- (void)clear {
  numArcs_ = 0;
  isFinal_ = false;
  output_ = ((OrgApacheLuceneUtilFstBuilder *) nil_chk(owner_))->NO_OUTPUT_;
  inputCount_ = 0;
}
...
withOrgApacheLuceneUtilFstBuilder_Node:(id<OrgApacheLuceneUtilFstBuilder_Node>)target {
  ...
  if (numArcs_ == arcs_->size_) {
    IOSObjectArray *newArcs = [IOSObjectArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(numArcs_ + 1, JreLoadStatic(OrgApacheLuceneUtilRamUsageEstimator, NUM_BYTES_OBJECT_REF)) type:OrgApacheLuceneUtilFstBuilder_Arc_class_()];
    ...
    for (jint arcIdx = numArcs_; arcIdx < newArcs->size_; arcIdx++) {
      (void) IOSObjectArray_SetAndConsume(newArcs, arcIdx, new_OrgApacheLuceneUtilFstBuilder_Arc_init());
    }
    arcs_ = newArcs;
  }
  ...
  arc->target_ = target;
  arc->output_ = arc->nextFinalOutput_ = ((OrgApacheLuceneUtilFstBuilder *) nil_chk(owner_))->NO_OUTPUT_;
  arc->isFinal_ = false;
}
...
withOrgApacheLuceneUtilFstBuilder_Node:(id<OrgApacheLuceneUtilFstBuilder_Node>)target
  ...
  arc->target_ = target;
  arc->nextFinalOutput_ = nextFinalOutput;
...
- (void)prependOutputWithId:(id)outputPrefix {
  ...
  for (jint arcIdx = 0; arcIdx < numArcs_; arcIdx++) {
    ((OrgApacheLuceneUtilFstBuilder_Arc *) nil_chk(IOSObjectArray_Get(nil_chk(arcs_), arcIdx)))->output_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(((OrgApacheLuceneUtilFstFST *) nil_chk(owner_->fst_))->outputs_)) addWithId:outputPrefix withId:((OrgApacheLuceneUtilFstBuilder_Arc *) nil_chk(IOSObjectArray_Get(arcs_, arcIdx)))->output_];
  ...
  if (isFinal_) {
    output_ = [((OrgApacheLuceneUtilFstOutputs *) nil_chk(((OrgApacheLuceneUtilFstFST *) nil_chk(owner_->fst_))->outputs_)) addWithId:outputPrefix withId:output_];
...
void OrgApacheLuceneUtilFstBuilder_UnCompiledNode_initWithOrgApacheLuceneUtilFstBuilder_withInt_(OrgApacheLuceneUtilFstBuilder_UnCompiledNode *self, OrgApacheLuceneUtilFstBuilder *owner, jint depth) {
  NSObject_init(self);
  self->owner_ = owner;
  self->arcs_ = [IOSObjectArray newArrayWithLength:1 type:OrgApacheLuceneUtilFstBuilder_Arc_class_()];
  (void) IOSObjectArray_SetAndConsume(self->arcs_, 0, new_OrgApacheLuceneUtilFstBuilder_Arc_init());
  self->output_ = ((OrgApacheLuceneUtilFstBuilder *) nil_chk(owner))->NO_OUTPUT_;
  self->depth_ = depth;
}
