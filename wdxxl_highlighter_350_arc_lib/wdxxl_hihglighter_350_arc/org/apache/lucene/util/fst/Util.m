...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/fst/Util.java
//
...
void OrgApacheLuceneUtilFstUtil_toDotWithOrgApacheLuceneUtilFstFST_withJavaIoWriter_withBoolean_withBoolean_(OrgApacheLuceneUtilFstFST *fst, JavaIoWriter *outArg, jboolean sameRank, jboolean labelStates) {
  ...
  OrgApacheLuceneUtilFstFST_Arc *startArc = [((OrgApacheLuceneUtilFstFST *) nil_chk(fst)) getFirstArcWithOrgApacheLuceneUtilFstFST_Arc:new_OrgApacheLuceneUtilFstFST_Arc_init()];
  id<JavaUtilList> thisLevelQueue = new_JavaUtilArrayList_init();
  id<JavaUtilList> nextLevelQueue = new_JavaUtilArrayList_init();
  [nextLevelQueue addWithId:startArc];
  id<JavaUtilList> sameLevelStates = new_JavaUtilArrayList_init();
  JavaUtilBitSet *seen = new_JavaUtilBitSet_init();
  ...
  while (![nextLevelQueue isEmpty]) {
    ...
    while (![thisLevelQueue isEmpty]) {
      ...
      if ([fst targetHasArcsWithOrgApacheLuceneUtilFstFST_Arc:arc]) {
        ...
        (void) [fst readFirstTargetArcWithOrgApacheLuceneUtilFstFST_Arc:arc withOrgApacheLuceneUtilFstFST_Arc:arc];
        while (true) {
          if (arc->target_ >= 0 && ![seen getWithInt:arc->target_]) {
            ...
            [nextLevelQueue addWithId:[new_OrgApacheLuceneUtilFstFST_Arc_init() copyFromWithOrgApacheLuceneUtilFstFST_Arc:arc]];
          ...
          (void) [fst readNextArcWithOrgApacheLuceneUtilFstFST_Arc:arc];
        }
      }
    }
