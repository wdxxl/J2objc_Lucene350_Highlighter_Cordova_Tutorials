...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/packed/GrowableWriter.java
//
...
- (OrgApacheLuceneUtilPackedGrowableWriter *)resizeWithInt:(jint)newSize {
  OrgApacheLuceneUtilPackedGrowableWriter *next = new_OrgApacheLuceneUtilPackedGrowableWriter_initWithInt_withInt_withBoolean_([self getBitsPerValue], newSize, roundFixedSize_);
...
void OrgApacheLuceneUtilPackedGrowableWriter_initWithInt_withInt_withBoolean_(OrgApacheLuceneUtilPackedGrowableWriter *self, jint startBitsPerValue, jint valueCount, jboolean roundFixedSize) {
  ...
  self->current_ = OrgApacheLuceneUtilPackedPackedInts_getMutableWithInt_withInt_(valueCount, OrgApacheLuceneUtilPackedGrowableWriter_getSizeWithInt_(self, startBitsPerValue));
