...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/packed/Packed64.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilPackedPacked64 class]) {
    OrgApacheLuceneUtilPackedPacked64_SHIFTS = [IOSIntArray newArrayWithDimensions:2 lengths:(jint[]){ OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE, OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE * OrgApacheLuceneUtilPackedPacked64_FAC_BITPOS }];
    OrgApacheLuceneUtilPackedPacked64_MASKS = [IOSLongArray newArrayWithDimensions:2 lengths:(jint[]){ OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE, OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE }];
    {
    ...
    OrgApacheLuceneUtilPackedPacked64_WRITE_MASKS = [IOSLongArray newArrayWithDimensions:2 lengths:(jint[]){ OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE, OrgApacheLuceneUtilPackedPacked64_ENTRY_SIZE * OrgApacheLuceneUtilPackedPacked64_FAC_BITPOS }];
    {
      for (jint elementBits = 1; elementBits <= OrgApacheLuceneUtilPackedPacked64_BLOCK_SIZE; elementBits++) {
...
void OrgApacheLuceneUtilPackedPacked64_initWithInt_withInt_(OrgApacheLuceneUtilPackedPacked64 *self, jint valueCount, jint bitsPerValue) {
  OrgApacheLuceneUtilPackedPacked64_initWithLongArray_withInt_withInt_(self, [IOSLongArray newArrayWithLength:(jint) ((jlong) valueCount * bitsPerValue / OrgApacheLuceneUtilPackedPacked64_BLOCK_SIZE + 2)], valueCount, bitsPerValue);
}
...
void OrgApacheLuceneUtilPackedPacked64_initWithOrgApacheLuceneStoreDataInput_withInt_withInt_(OrgApacheLuceneUtilPackedPacked64 *self, OrgApacheLuceneStoreDataInput *inArg, jint valueCount, jint bitsPerValue) {
  ...
  self->blocks_ = [IOSLongArray newArrayWithLength:size + 1];
...
void OrgApacheLuceneUtilPackedPacked64_updateCached(OrgApacheLuceneUtilPackedPacked64 *self) {
  self->readMasks_ = IOSObjectArray_Get(nil_chk(OrgApacheLuceneUtilPackedPacked64_MASKS), self->bitsPerValue_);
  self->shifts_ = IOSObjectArray_Get(nil_chk(OrgApacheLuceneUtilPackedPacked64_SHIFTS), self->bitsPerValue_);
  self->writeMasks_ = IOSObjectArray_Get(nil_chk(OrgApacheLuceneUtilPackedPacked64_WRITE_MASKS), self->bitsPerValue_);
