...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/StringHelper.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneUtilStringHelper class]) {
    OrgApacheLuceneUtilStringHelper_interner = new_OrgApacheLuceneUtilSimpleStringInterner_initWithInt_withInt_(1024, 8);
    OrgApacheLuceneUtilStringHelper_versionComparator = new_OrgApacheLuceneUtilStringHelper_1_init();
...
- (jint)compareWithId:(NSString *)a
               withId:(NSString *)b {
  JavaUtilStringTokenizer *aTokens = new_JavaUtilStringTokenizer_initWithNSString_withNSString_(a, @".");
  JavaUtilStringTokenizer *bTokens = new_JavaUtilStringTokenizer_initWithNSString_withNSString_(b, @".");
