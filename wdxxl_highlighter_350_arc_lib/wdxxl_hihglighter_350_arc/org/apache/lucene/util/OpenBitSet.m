...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/util/OpenBitSet.java
//
...
- (OrgApacheLuceneSearchDocIdSetIterator *)iterator {
  return new_OrgApacheLuceneUtilOpenBitSetIterator_initWithLongArray_withInt_(bits_, wlen_);
}
...
- (id)java_clone {
  @try {
    ...
    ((OrgApacheLuceneUtilOpenBitSet *) nil_chk(obs))->bits_ = [((IOSLongArray *) nil_chk(obs->bits_)) java_clone];
    return obs;
  }
...
- (void)ensureCapacityWordsWithInt:(jint)numWords {
  if (((IOSLongArray *) nil_chk(bits_))->size_ < numWords) {
    bits_ = OrgApacheLuceneUtilArrayUtil_growWithLongArray_withInt_(bits_, numWords);
  }
}
...
void OrgApacheLuceneUtilOpenBitSet_initWithLong_(OrgApacheLuceneUtilOpenBitSet *self, jlong numBits) {
  ...
  self->bits_ = [IOSLongArray newArrayWithLength:OrgApacheLuceneUtilOpenBitSet_bits2wordsWithLong_(numBits)];
