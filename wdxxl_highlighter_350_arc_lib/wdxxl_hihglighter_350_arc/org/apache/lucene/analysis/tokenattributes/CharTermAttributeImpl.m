...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/tokenattributes/CharTermAttributeImpl.java
//
...
- (void)setTermLengthWithInt:(jint)length {
  (void) OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_setLengthWithInt_(self, length);
}
...
- (jchar)charAtWithInt:(jint)index {
  if (index >= termLength_) @throw new_JavaLangIndexOutOfBoundsException_init();
  return IOSCharArray_Get(nil_chk(termBuffer_), index);
}

- (id<JavaLangCharSequence>)subSequenceFrom:(jint)start
                                         to:(jint)end {
  if (start > termLength_ || end > termLength_) @throw new_JavaLangIndexOutOfBoundsException_init();
...
- (id)java_clone {
  ...
  ((OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *) nil_chk(t))->termBuffer_ = [IOSCharArray newArrayWithLength:self->termLength_];
...
void OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_init(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self) {
  ...
  self->termBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_MIN_BUFFER_SIZE, OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_CHAR)];
  self->termLength_ = 0;
}
...
IOSCharArray *OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_resizeBufferWithInt_(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self, jint newSize) {
  if (((IOSCharArray *) nil_chk(self->termBuffer_))->size_ < newSize) {
    IOSCharArray *newCharBuffer = [IOSCharArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(newSize, OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_CHAR)];
    ...
    self->termBuffer_ = newCharBuffer;
  }
...
void OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_growTermBufferWithInt_(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self, jint newSize) {
  if (((IOSCharArray *) nil_chk(self->termBuffer_))->size_ < newSize) {
    self->termBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneUtilArrayUtil_oversizeWithInt_withInt_(newSize, OrgApacheLuceneUtilRamUsageEstimator_NUM_BYTES_CHAR)];
  }
}
...
id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute> OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_setLengthWithInt_(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self, jint length) {
  if (length > ((IOSCharArray *) nil_chk(self->termBuffer_))->size_) @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$IC", @"length ", length, @" exceeds the size of the termBuffer (", self->termBuffer_->size_, ')'));
  self->termLength_ = length;
  return self;
}
...
id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute> OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_appendWithJavaLangCharSequence_withInt_withInt_(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self, id<JavaLangCharSequence> csq, jint start, jint end) {
  ...
  if (len < 0 || start > csqlen || end > csqlen) @throw new_JavaLangIndexOutOfBoundsException_init();
  if (len == 0) return self;
  (void) OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_resizeBufferWithInt_(self, self->termLength_ + len);
  if (len > 4) {
...
id<OrgApacheLuceneAnalysisTokenattributesCharTermAttribute> OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_appendNull(OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl *self) {
  (void) OrgApacheLuceneAnalysisTokenattributesCharTermAttributeImpl_resizeBufferWithInt_(self, self->termLength_ + 4);
