...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/tokenattributes/PayloadAttributeImpl.java
//
...
- (id)java_clone {
  ...
  if (payload_ != nil) {
    ((OrgApacheLuceneAnalysisTokenattributesPayloadAttributeImpl *) nil_chk(clone))->payload_ = (OrgApacheLuceneIndexPayload *) cast_chk([payload_ java_clone], [OrgApacheLuceneIndexPayload class]);
  }
  return clone;
}
