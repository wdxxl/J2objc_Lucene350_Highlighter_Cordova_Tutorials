...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/StopAnalyzer.java
//
...
- (OrgApacheLuceneAnalysisReusableAnalyzerBase_TokenStreamComponents *)createComponentsWithNSString:(NSString *)fieldName
  ...
  OrgApacheLuceneAnalysisTokenizer *source = new_OrgApacheLuceneAnalysisLowerCaseTokenizer_initWithOrgApacheLuceneUtilVersion_withJavaIoReader_(matchVersion_, reader);
  return new_OrgApacheLuceneAnalysisReusableAnalyzerBase_TokenStreamComponents_initWithOrgApacheLuceneAnalysisTokenizer_withOrgApacheLuceneAnalysisTokenStream_(source, new_OrgApacheLuceneAnalysisStopFilter_initWithOrgApacheLuceneUtilVersion_withOrgApacheLuceneAnalysisTokenStream_withJavaUtilSet_(matchVersion_, source, stopwords_));
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStopAnalyzer class]) {
    {
      id<JavaUtilList> stopWords = JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray newArrayWithObjects:(id[]){ @"a", @"an", @"and", @"are", @"as", @"at", @"be", @"but", @"by", @"for", @"if", @"in", @"into", @"is", @"it", @"no", @"not", @"of", @"on", @"or", @"such", @"that", @"the", @"their", @"then", @"there", @"these", @"they", @"this", @"to", @"was", @"will", @"with" } count:33 type:NSString_class_()]);
      OrgApacheLuceneAnalysisCharArraySet *stopSet = new_OrgApacheLuceneAnalysisCharArraySet_initWithOrgApacheLuceneUtilVersion_withInt_withBoolean_(JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_CURRENT), [((id<JavaUtilList>) nil_chk(stopWords)) size], false);
      [stopSet addAllWithJavaUtilCollection:stopWords];
      OrgApacheLuceneAnalysisStopAnalyzer_ENGLISH_STOP_WORDS_SET = OrgApacheLuceneAnalysisCharArraySet_unmodifiableSetWithOrgApacheLuceneAnalysisCharArraySet_(stopSet);
    }
