...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/CharArrayMap.java
//
...
- (id)putWithCharArray:(IOSCharArray *)text
  ...
  if (IOSObjectArray_Get(nil_chk(keys_), slot) != nil) {
    ...
    (void) IOSObjectArray_Set(values_CharArrayMap_, slot, value);
    return oldValue;
  }
  (void) IOSObjectArray_Set(keys_, slot, text);
  (void) IOSObjectArray_Set(nil_chk(values_CharArrayMap_), slot, value);
  count_++;
...
- (NSString *)description {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk(OrgApacheLuceneAnalysisCharArrayMap_entrySet(self))) {
    if ([sb java_length] > 1) (void) [sb appendWithNSString:@", "];
...
- (OrgApacheLuceneAnalysisCharArrayMap_EntrySet *)createEntrySet {
  return new_OrgApacheLuceneAnalysisCharArrayMap_EntrySet_initWithOrgApacheLuceneAnalysisCharArrayMap_withBoolean_(self, true);
}
...
- (OrgApacheLuceneAnalysisCharArraySet *)keySet {
  if (keySet_CharArrayMap_ == nil) {
    keySet_CharArrayMap_ = new_OrgApacheLuceneAnalysisCharArrayMap_1_initWithOrgApacheLuceneAnalysisCharArrayMap_(self);
  }
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisCharArrayMap class]) {
    OrgApacheLuceneAnalysisCharArrayMap_EMPTY_MAP = new_OrgApacheLuceneAnalysisCharArrayMap_EmptyCharArrayMap_init();
...
void OrgApacheLuceneAnalysisCharArrayMap_initWithOrgApacheLuceneUtilVersion_withInt_withBoolean_(OrgApacheLuceneAnalysisCharArrayMap *self, OrgApacheLuceneUtilVersion *matchVersion, jint startSize, jboolean ignoreCase) {
  ...
  self->keys_ = [IOSObjectArray newArrayWithLength:size type:IOSClass_charArray(1)];
  self->values_CharArrayMap_ = [IOSObjectArray newArrayWithLength:size type:NSObject_class_()];
  self->charUtils_ = OrgApacheLuceneUtilCharacterUtils_getInstanceWithOrgApacheLuceneUtilVersion_(matchVersion);
...
void OrgApacheLuceneAnalysisCharArrayMap_initWithOrgApacheLuceneAnalysisCharArrayMap_(OrgApacheLuceneAnalysisCharArrayMap *self, OrgApacheLuceneAnalysisCharArrayMap *toCopy) {
  ...
  self->entrySet_ = nil;
  self->keySet_CharArrayMap_ = nil;
  self->keys_ = ((OrgApacheLuceneAnalysisCharArrayMap *) nil_chk(toCopy))->keys_;
  self->values_CharArrayMap_ = toCopy->values_CharArrayMap_;
  self->ignoreCase_ = toCopy->ignoreCase_;
  self->count_ = toCopy->count_;
  self->charUtils_ = toCopy->charUtils_;
  self->matchVersion_ = toCopy->matchVersion_;
}
...
void OrgApacheLuceneAnalysisCharArrayMap_rehash(OrgApacheLuceneAnalysisCharArrayMap *self) {
  ...
  self->keys_ = [IOSObjectArray newArrayWithLength:newSize type:IOSClass_charArray(1)];
  self->values_CharArrayMap_ = [IOSObjectArray newArrayWithLength:newSize type:NSObject_class_()];
  for (jint i = 0; i < oldkeys->size_; i++) {
    ...
    if (text != nil) {
      ...
      (void) IOSObjectArray_Set(nil_chk(self->keys_), slot, text);
      (void) IOSObjectArray_Set(nil_chk(self->values_CharArrayMap_), slot, IOSObjectArray_Get(oldvalues, i));
    }
  }
}
...
jint OrgApacheLuceneAnalysisCharArrayMap_getHashCodeWithCharArray_withInt_withInt_(OrgApacheLuceneAnalysisCharArrayMap *self, IOSCharArray *text, jint offset, jint len) {
  if (text == nil) @throw new_JavaLangNullPointerException_init();
  jint code = 0;
...
OrgApacheLuceneAnalysisCharArrayMap_EntrySet *OrgApacheLuceneAnalysisCharArrayMap_entrySet(OrgApacheLuceneAnalysisCharArrayMap *self) {
  if (self->entrySet_ == nil) {
    self->entrySet_ = [self createEntrySet];
  }
...
OrgApacheLuceneAnalysisCharArrayMap *OrgApacheLuceneAnalysisCharArrayMap_unmodifiableMapWithOrgApacheLuceneAnalysisCharArrayMap_(OrgApacheLuceneAnalysisCharArrayMap *map) {
  ...
  if (map == nil) @throw new_JavaLangNullPointerException_initWithNSString_(@"Given map is null");
  ...
  return new_OrgApacheLuceneAnalysisCharArrayMap_UnmodifiableCharArrayMap_initWithOrgApacheLuceneAnalysisCharArrayMap_(map);
}
...
OrgApacheLuceneAnalysisCharArrayMap *OrgApacheLuceneAnalysisCharArrayMap_copy__WithOrgApacheLuceneUtilVersion_withJavaUtilMap_(OrgApacheLuceneUtilVersion *matchVersion, id<JavaUtilMap> map) {
  ...
  if ([map isKindOfClass:[OrgApacheLuceneAnalysisCharArrayMap class]]) {
    ...
    IOSObjectArray *keys = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(((OrgApacheLuceneAnalysisCharArrayMap *) nil_chk(m))->keys_))->size_ type:IOSClass_charArray(1)];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(m->keys_, 0, keys, 0, keys->size_);
    IOSObjectArray *values = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(m->values_CharArrayMap_))->size_ type:NSObject_class_()];
    JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(m->values_CharArrayMap_, 0, values, 0, values->size_);
    m = new_OrgApacheLuceneAnalysisCharArrayMap_initWithOrgApacheLuceneAnalysisCharArrayMap_(m);
    m->keys_ = keys;
    m->values_CharArrayMap_ = values;
    return m;
  }
  return new_OrgApacheLuceneAnalysisCharArrayMap_initWithOrgApacheLuceneUtilVersion_withJavaUtilMap_withBoolean_(matchVersion, map, false);
}
...
- (id)setValueWithId:(id)value {
  if (!allowModify_) @throw new_JavaLangUnsupportedOperationException_init();
  id old = IOSObjectArray_Get(nil_chk(this$0_->values_CharArrayMap_), lastPos_);
  (void) IOSObjectArray_Set(this$0_->values_CharArrayMap_, lastPos_, value);
  return old;
}

- (id<JavaUtilMap_Entry>)next {
  OrgApacheLuceneAnalysisCharArrayMap_EntryIterator_goNext(self);
  return new_OrgApacheLuceneAnalysisCharArrayMap_MapEntry_initWithOrgApacheLuceneAnalysisCharArrayMap_withInt_withBoolean_(this$0_, lastPos_, allowModify_);
}
...
- (OrgApacheLuceneAnalysisCharArrayMap_EntryIterator *)iterator {
  return new_OrgApacheLuceneAnalysisCharArrayMap_EntryIterator_initWithOrgApacheLuceneAnalysisCharArrayMap_withBoolean_(this$0_, allowModify_);
}
...
- (OrgApacheLuceneAnalysisCharArrayMap_EntrySet *)createEntrySet {
  return new_OrgApacheLuceneAnalysisCharArrayMap_EntrySet_initWithOrgApacheLuceneAnalysisCharArrayMap_withBoolean_(self, false);
}
...
- (jboolean)containsKeyWithJavaLangCharSequence:(id<JavaLangCharSequence>)cs {
  if (cs == nil) @throw new_JavaLangNullPointerException_init();
  return false;
}

- (jboolean)containsKeyWithId:(id)o {
  if (o == nil) @throw new_JavaLangNullPointerException_init();
  return false;
}
...
void OrgApacheLuceneAnalysisCharArrayMap_EmptyCharArrayMap_init(OrgApacheLuceneAnalysisCharArrayMap_EmptyCharArrayMap *self) {
  OrgApacheLuceneAnalysisCharArrayMap_UnmodifiableCharArrayMap_initWithOrgApacheLuceneAnalysisCharArrayMap_(self, new_OrgApacheLuceneAnalysisCharArrayMap_initWithOrgApacheLuceneUtilVersion_withInt_withBoolean_(JreLoadEnum(OrgApacheLuceneUtilVersion, LUCENE_CURRENT), 0, false));
}
