...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/standard/ClassicTokenizer.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStandardClassicTokenizer class]) {
    OrgApacheLuceneAnalysisStandardClassicTokenizer_TOKEN_TYPES = [IOSObjectArray newArrayWithObjects:(id[]){ @"<ALPHANUM>", @"<APOSTROPHE>", @"<ACRONYM>", @"<COMPANY>", @"<EMAIL>", @"<HOST>", @"<NUM>", @"<CJ>", @"<ACRONYM_DEP>" } count:9 type:NSString_class_()];
