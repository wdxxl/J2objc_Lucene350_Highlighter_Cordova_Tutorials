...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/standard/std31/StandardTokenizerImpl31.java
//
...
- (void)yyresetWithJavaIoReader:(JavaIoReader *)reader {
  ...
  if (((IOSCharArray *) nil_chk(zzBuffer_))->size_ > OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_BUFFERSIZE) zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_BUFFERSIZE];
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31 class]) {
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_LEXSTATE = [IOSIntArray newArrayWithInts:(jint[]){ 0, 0 } count:2];
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_CMAP = OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackCMapWithNSString_(OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_CMAP_PACKED);
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_ACTION = OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackAction();
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_ROWMAP = OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackRowMap();
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_TRANS = OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackTrans();
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_ERROR_MSG = [IOSObjectArray newArrayWithObjects:(id[]){ @"Unkown internal scanner error", @"Error: could not match input", @"Error: pushback value was too large" } count:3 type:NSString_class_()];
    OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_ATTRIBUTE = OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackAttribute();
...
IOSIntArray *OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackAction() {
  ...
  IOSIntArray *result = [IOSIntArray newArrayWithLength:114];
  jint offset = 0;
...
IOSIntArray *OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_zzUnpackTrans() {
  OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_initialize();
  IOSIntArray *result = [IOSIntArray newArrayWithLength:10609];
  jint offset = 0;
...
void OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_initWithJavaIoReader_(OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31 *self, JavaIoReader *inArg) {
  ...
  self->zzBuffer_ = [IOSCharArray newArrayWithLength:OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_ZZ_BUFFERSIZE];
  self->zzAtBOL_ = true;
...
void OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_initWithJavaIoInputStream_(OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31 *self, JavaIoInputStream *inArg) {
  OrgApacheLuceneAnalysisStandardStd31StandardTokenizerImpl31_initWithJavaIoReader_(self, new_JavaIoInputStreamReader_initWithJavaIoInputStream_(inArg));
}
