...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/CharReader.java
//
...
OrgApacheLuceneAnalysisCharStream *OrgApacheLuceneAnalysisCharReader_getWithJavaIoReader_(JavaIoReader *input) {
  ...
  return [input isKindOfClass:[OrgApacheLuceneAnalysisCharStream class]] ? (OrgApacheLuceneAnalysisCharStream *) cast_chk(input, [OrgApacheLuceneAnalysisCharStream class]) : new_OrgApacheLuceneAnalysisCharReader_initWithJavaIoReader_(input);
}
