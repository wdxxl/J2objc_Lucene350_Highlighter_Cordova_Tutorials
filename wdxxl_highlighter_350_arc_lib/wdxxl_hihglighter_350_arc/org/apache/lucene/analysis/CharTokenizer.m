...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/analysis/CharTokenizer.java
//
...
- (jboolean)isTokenCharWithInt:(jint)c {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"since LUCENE_31 subclasses of CharTokenizer must implement isTokenChar(int)");
}
...
+ (void)initialize {
  if (self == [OrgApacheLuceneAnalysisCharTokenizer class]) {
    OrgApacheLuceneAnalysisCharTokenizer_isTokenCharMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneAnalysisCharTokenizer_class_(), @"isTokenChar", [IOSObjectArray newArrayWithObjects:(id[]){ [IOSClass charClass] } count:1 type:IOSClass_class_()]);
    OrgApacheLuceneAnalysisCharTokenizer_normalizeMethod = new_OrgApacheLuceneUtilVirtualMethod_initWithIOSClass_withNSString_withIOSClassArray_(OrgApacheLuceneAnalysisCharTokenizer_class_(), @"normalize", [IOSObjectArray newArrayWithObjects:(id[]){ [IOSClass charClass] } count:1 type:IOSClass_class_()]);
...
void OrgApacheLuceneAnalysisCharTokenizer_initWithOrgApacheLuceneUtilVersion_withJavaIoReader_(OrgApacheLuceneAnalysisCharTokenizer *self, OrgApacheLuceneUtilVersion *matchVersion, JavaIoReader *input) {
  ...
  self->ioBuffer_ = OrgApacheLuceneUtilCharacterUtils_newCharacterBufferWithInt_(OrgApacheLuceneAnalysisCharTokenizer_IO_BUFFER_SIZE);
