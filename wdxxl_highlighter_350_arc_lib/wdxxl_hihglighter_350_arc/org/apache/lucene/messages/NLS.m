...
//  source: jar:file:wdxxl_lucene_350_highlighter.jar!org/apache/lucene/messages/NLS.java
//
...
+ (void)initialize {
  if (self == [OrgApacheLuceneMessagesNLS class]) {
    OrgApacheLuceneMessagesNLS_bundles = new_JavaUtilHashMap_initWithInt_(0);
...
void OrgApacheLuceneMessagesNLS_makeAccessibleWithJavaLangReflectField_(JavaLangReflectField *field) {
  ...
  if (JavaLangSystem_getSecurityManager() == nil) {
    ...
    (void) JavaSecurityAccessController_doPrivilegedWithJavaSecurityPrivilegedAction_(new_OrgApacheLuceneMessagesNLS_1_initWithJavaLangReflectField_(field));
  }
}
